---
title: Build PPT PPTX Slides Viewer & Converter via PHP REST SDK 
description: Fetch PowerPoint & OpenOffice presentations from cloud storage to view, merge, split, & convert slides in the cloud
weight: 100
url: /php
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="PHP Cloud SDK to Process Presentation Slides" h2="Fetch PowerPoint & OpenOffice presentations from cloud storage to view, merge, split, & convert slides in the cloud." logoImageSrc="/headers/aspose_slides-for-php.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK for PHP" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Cloud SDK for PHP" >}}

{{< blocks/products/pf/sub-menu logoImageSrc="/sdk/aspose_slides-for-php.svg" liveDemosLink="" PricingLink="https://purchase.aspose.cloud/pricing" buyLink="https://dashboard.aspose.cloud" docsLink="https://docs.aspose.cloud/slides" directDownloadLink="https://github.com/aspose-slides-cloud/aspose-slides-cloud-php" liveDemosLink="https://products.aspose.app/slides/family">}}

{{< blocks/products/pf/tab-content >}}
<p>Aspose.Slides Cloud SDK for PHP helps you create cloud-based PHP applications that can create PPT slides and PowerPoint presentations without installing any software. Aspose.Slides Cloud SDK for PHP also supports OpenOffice presentation formats, ODP & OTP. Aspose.Slides Cloud SDK for PHP is based on Aspose.Slides REST API and is offered under an MIT license.</p>
<p>Using Aspose.Slides Cloud SDK for PHP your cloud PHP programs would be able to create new presentations or access existing presentations located at the cloud storage. Via our PHP REST SDK, you can work with the whole presentation, modify individual slides, clone master slide, update interactive sequence of PowerPoint presentation, and specify custom fonts to be used in the presentation.</p>
<p>Aspose.Slides Cloud SDK for PHP assists your PHP code to extract shapes, images and notes from presentation slides. You can also convert PPTX, PPT, ODP & OTP to SWF, HTML, BMP, PNG, TIFF, JPEG, SVG formats.</p>
{{< /blocks/products/pf/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.svg" alt="PHP PowerPoint Cloud SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>for </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.svg" alt="PHP Cloud SDK for Presentations"><header>Aspose.Slides</header><footer>Cloud <small> <em>for </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     It is easy to get started with Aspose.Slides Cloud SDK for PHP as you need nothing to install. Simply create an account at
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose for Cloud
     </a>
     and get your application information. Once you have the App SID &amp; key, you are ready to give the Aspose.Slides Cloud SDK for PHP a try on any platform.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides Cloud SDK for PHP allows the developers to perform basic to advanced presentation slide processing operations. You can read presentation slides information. Create new slides. Copy, modify or delete existing slides. Convert presentation slides from PowerPoint formats to other supported formats via Cloud SDK. You can also manipulate slide background by apply new background, read and remove existing background for any slide. Aspose.Slides Cloud SDK for PHP enables you to reorder slide position within the presentation. You can also copy a slide from current or another presentation. Presentation slide comments can also be retrieved.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides Cloud SDK for PHP allows developers to create new shapes for presentation slides. You can read and update properties information for existing slide shapes. Our presentation slides processing Cloud SDK enables you to render slides shapes to supported image formats. Aspose.Slides Cloud SDK for PHP also helps you work with presentation slide notes.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Source Code" href="https://github.com/aspose-slides-cloud/aspose-slides-cloud-php" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Why Aspose.Slides Cloud SDK for PHP?" tabId="success-stories" >}}
