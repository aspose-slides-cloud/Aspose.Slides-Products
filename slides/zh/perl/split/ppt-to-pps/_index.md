---
title: 通过 Perl 将 Slides PPT 拆分为多个 PPS
description: 使用 REST API 和开源 Perl SDK 将 Slides PPT 文件拆分成 PPS 幻灯片
family: slides
platformtag: perl
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Perl 将 PPT 拆分为多个 PPS" h2="使用适用于 Perl 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Perl 将 PPT 转换为 PPS 拆分" %}}
