---
title: 通过 Perl 将 Slides POTM 拆分为多个 PPSM
description: 使用 REST API 和开源 Perl SDK 将 Slides POTM 文件拆分成 PPSM 幻灯片
family: slides
platformtag: perl
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Perl 将 POTM 拆分为多个 PPSM" h2="使用适用于 Perl 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Perl 将 POTM 转换为 PPSM 拆分" %}}
