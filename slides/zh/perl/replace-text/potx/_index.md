---
title: 通过 Perl 替换 POTX 文件中的文本
description: 使用 REST API 和开源 Perl SDK 替换 Slides POTX 文件中的文本
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Perl 替换 POTX 文件中的文本" h2="使用适用于 Perl 的开源 Cloud SDK 查找并替换 Slides 数据中出现的文本">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Perl 替换 POTX 文件中的文本" %}}
