---
title: 通过 .NET 将 Slides OTP 拆分为多个 PPSX
description: 使用 REST API 和开源 .NET SDK 将 Slides OTP 文件拆分成 PPSX 幻灯片
family: slides
platformtag: net
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 .NET 将 OTP 拆分为多个 PPSX" h2="使用适用于 .NET 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 .NET 将 OTP 转换为 PPSX 拆分" %}}
