---
title: 通过 .NET 将 Slides POTX 拆分为多个 PPTM
description: 使用 REST API 和开源 .NET SDK 将 Slides POTX 文件拆分成 PPTM 幻灯片
family: slides
platformtag: net
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 .NET 将 POTX 拆分为多个 PPTM" h2="使用适用于 .NET 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 .NET 将 POTX 转换为 PPTM 拆分" %}}
