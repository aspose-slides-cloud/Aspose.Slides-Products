---
title: 使用 C# REST SDK 构建演示文稿创建器和查看器
description: C# Cloud SDK 帮助您在云端创建和处理 PowerPoint 和 OpenOffice 演示文稿，无需安装任何软件
weight: 70
family: slides
platform: .NET
---
...
{{< blocks/products/pf/i18n/upper-banner h1="用于在云中查看、处理和转换幻灯片的 C# SDK" h2="C# Cloud SDK 可帮助您在云端创建和处理 PowerPoint 和 OpenOffice 演示文稿，而无需安装任何软件。" logoImageSrc="/headers/aspose_slides-for-net.svg" pfName="Aspose.Slides" subTitlepfName="适用于 .NET 的 Cloud SDK" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="适用于 .NET 的 Cloud SDK" >}}
...
<p>适用于 .NET 的 Aspose.Slides Cloud SDK 用于将 PPT、PPTX、ODP、OTP 处理功能无缝集成到使用 C#、ASP.NET 或其他 .NET 支持的语言构建的基于云的应用程序中。 适用于 .NET 的 Aspose.Slides Cloud SDK 是 Aspose.Slides REST API 的包装器，在 MIT 许可下提供。</p>
<p>适用于 .NET 的 Aspose.Slides Cloud SDK 增强了您的 C# 代码以创建 PowerPoint 演示文稿、合并选定的幻灯片、拆分演示文稿，以及将 PowerPoint 和 OpenOffice 演示文稿文档转换为 PDF、XPS、JPEG、PNG、BMP、TIFF、SVG、HTML 和 SWF。</p>
<p>适用于 .NET 的 Aspose.Slides Cloud SDK 还允许基于云的 .NET 应用程序处理演示幻灯片动画、读取和克隆主幻灯片信息、提取和下载幻灯片注释、将演示图像提取为特定格式、从幻灯片中提取形状 ，以及通过我们的 适用于 .NET 的 Aspose.Slides Cloud SDK 使用您的 C# 程序执行各种其他操作。</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt=".NET 演示 SDK"><header>Aspose.Slides</header><footer>用于 .NET <small><em>的</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt="用于演示文稿的 .NET SDK"><header>Aspose.Slides</header><footer>用于 .NET <small><em>的</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides Cloud .NET SDK 很容易上手，因为您不需要安装任何东西。 只需在
     <a href="https://dashboard.aspose.cloud/#/apps">
      Cloud 的 Aspose
     </a>
     创建一个帐户并获取您的应用程序信息。 获得应用程序 SID 和密钥后，您就可以在任何平台上试用 Aspose.Slides Cloud .NET SDK。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     适用于 .NET 的 Aspose.Slides Cloud SDK 允许开发人员执行基本到高级的演示幻灯片处理操作。 您可以阅读演示幻灯片信息。 创建新幻灯片。 复制、修改或删除现有幻灯片。 通过 Cloud SDK 将演示幻灯片从 PowerPoint 格式转换为其他支持的格式。 您还可以通过应用新背景、读取和删除任何幻灯片的现有背景来操作幻灯片背景。 适用于 .NET 的 Aspose.Slides Cloud SDK 使您能够重新排列幻灯片在演示文稿中的位置。 您还可以从当前或其他演示文稿中复制幻灯片。 还可以检索演示幻灯片评论。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     适用于 .NET 的 Aspose.Slides Cloud SDK 允许开发人员为演示幻灯片创建新的形状。 您可以读取和更新现有幻灯片形状的属性信息。 我们的演示幻灯片处理 Cloud SDK 使您能够将幻灯片形状渲染为支持的图像格式。 适用于 .NET 的 Aspose.Slides Cloud SDK 还可以帮助您处理演示文稿幻灯片注释。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="源代码" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么选择 .NET 的 Aspose.Slides Cloud SDK?" tabId="success-stories" >}}
