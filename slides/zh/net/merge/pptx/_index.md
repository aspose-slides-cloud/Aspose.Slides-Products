---
title: 通过 .NET 合并多个 PPTX 文件
description: 使用 REST API 和开源 .NET SDK 合并多个 Slides PPTX 文件
family: slides
platformtag: net
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="用 .NET 合并多个 PPTX 文件" h2="使用适用于 .NET 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 .NET 合并 PPTX 文件" %}}
