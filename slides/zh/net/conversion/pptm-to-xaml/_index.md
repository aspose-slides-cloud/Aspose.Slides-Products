---
title: 通过 .NET 从 Slides PPTM 转换为 XAML
description: 使用 REST API 和开源 .NET SDK 创建、编辑或转换 Slides PPTM 文件或将其转换为 XAML
family: slides
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 .NET 将 PPTM 转换为 XAML" h2="使用适用于 .NET 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 .NET 将 PPTM 转换为 XAML" %}}
