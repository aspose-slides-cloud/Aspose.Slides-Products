...
{{< blocks/products/pf/agp/upper-banner-autogen h1="用 C++ 合并多个 PPTX 文件" h2="使用适用于 C++ 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 C++ 合并 PPTX 文件" %}}
