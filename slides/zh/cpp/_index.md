---
title: 用于构建 PowerPoint PPT/PPTX 演示文稿创建者应用程序的 C++ REST API
description: 使用 C++ REST API 创建基于云的应用程序，以便在云中处理 PowerPoint 和 OpenOffice 演示文稿
weight: 30
family: slides
platform: C++
---
...
{{< blocks/products/pf/i18n/upper-banner h1="用于演示幻灯片的 C++ Cloud SDK" h2="使用 C++ REST API 创建基于云的应用程序，以便在云中处理 PowerPoint 和 OpenOffice 演示文稿。 它允许编辑、操作、合并、拆分和转换 PPT/PPTX 幻灯片。" logoImageSrc="/headers/aspose_slides-for-cpp.svg" pfName="Aspose.Slides" subTitlepfName="适用于 C++ 的 Cloud SDK" downloadUrl="" >}}
...
<p>适用于 C++ 的 Aspose.Slides Cloud SDK 包括对许多高级和基本功能的支持，例如生成和修改演示文稿、合并和拆分演示文稿文件、导出 PowerPoint 和 OpenOffice 演示文稿、添加新幻灯片、从数据库生成演示文稿、向演示文稿添加布局幻灯片、 将图像添加到演示文稿等等。</p>
<p>只需在自己的 C++ 应用程序中使用几个命令，就可以将演示文稿转换为多种流行的文件格式。 SDK支持平滑转换为多种文件格式，如PPT、POT、PPS、PPTX、POTX、PPSX、PPTM、PPSM、POTM、ODP、OTP、TIFF、PDF、XPS、JPEG、PNG、GIF、BMP、SVG、SWF、 HTML 等等。</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-cpp.png" alt="C++ 演示 SDK"><header>Aspose.Slides</header><footer>用于 C++ <small><em>的</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-cpp.png" alt="用于演示文稿的 C++ SDK"><header>Aspose.Slides</header><footer>用于 C++ <small><em>的</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides Cloud C++ SDK 很容易上手，因为您不需要安装任何东西。 只需在
     <a href="https://dashboard.aspose.cloud/#/apps">
      Cloud 的 Aspose
     </a>
     创建一个帐户并获取您的应用程序信息。 获得应用程序 SID 和密钥后，您就可以在任何平台上试用 Aspose.Slides Cloud C++ SDK。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     通过 C++ 将 PPT、PPTX 演示文稿导出为其他格式
    </h2>
    <p>
     适用于 C++ 的 Aspose.Slides Cloud SDK 允许开发人员通过几个 C++ 命令以编程方式将 PowerPoint 演示文稿导出为其他支持的文件格式。 该库允许在 20 多种文件格式之间进行转换，包括 PDF、HTML、SWF、XPS、BMP、PNG、SVG、TIFF、ODP、JPEG 等流行格式。 它还支持添加新幻灯片、修改和更新等重要功能。 复制幻灯片、删除幻灯片、添加幻灯片评论等等。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     您需要将 PowerPoint 文件拆分成多个小文件，还是需要将多个 PowerPoint 演示文稿文件合并为一个演示文稿？ 适用于 C++ 的 Aspose.Slides Cloud SDK 提供了使用几行 C++ 代码拆分和合并 PPT 或 PPTX 演示文稿文件的功能。 SDK 还有助于在 PowerPoint 文件中添加、删除或拆分和合并幻灯片。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     管理 PowerPoint 演示文稿中的幻灯片
    </h2>
    <p>
     适用于 C++ 的 Aspose.Slides Cloud SDK 支持通过 C++ REST API 在 PowerPoint 演示文稿中使用幻灯片。 它支持多种功能，例如向演示文稿添加新幻灯片、复制幻灯片、将幻灯片移动到新位置、添加新背景、获取幻灯片评论、获取 PowerPoint 幻灯片计数、获取占位符信息等等。
    </p>
    <h2 class="h2title">
     在 PowerPoint 幻灯片中使用动画
    </h2>
    <p>
     适用于 C++ 的 Aspose.Slides Cloud SDK 提供了在 PowerPoint 幻灯片中处理动画的功能。 它包括几个重要的功能，例如读取和修改动画、更新演示文稿中的信息、添加或更新 PowerPoint 幻灯片中的动画主序列等等。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="为什么选择 C++ 的 Aspose.Slides Cloud SDK?" tabId="success-stories" >}}
