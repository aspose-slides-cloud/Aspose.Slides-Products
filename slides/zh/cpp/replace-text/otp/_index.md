---
title: 通过 C++ 替换 OTP 文件中的文本
description: 使用 REST API 和开源 C++ SDK 替换 Slides OTP 文件中的文本
family: slides
platformtag: cpp
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 C++ 替换 OTP 文件中的文本" h2="使用适用于 C++ 的开源 Cloud SDK 查找并替换 Slides 数据中出现的文本">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 C++ 替换 OTP 文件中的文本" %}}
