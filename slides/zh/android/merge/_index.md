---
title: 通过 Android 合并多个演示文稿
description: 使用 REST API 和开源 Android SDK 合并多个演示文稿
family: slides
platformtag: android
feature: merge
platform: Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Android 合并多个演示文稿" h2="使用适用于 Android 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Android 合并演示文稿" %}}
1. 在<a href="https://dashboard.aspose.cloud/">仪表板</a>创建一个帐户以获取免费的 API 配额和授权详细信息
1. 使用客户端 ID 和客户端密码初始化 ```SlidesApi```
1. 调用其中一种合并方法，具体取决于输入文件的位置、合并文件的存储位置以及是否需要合并部分文件
