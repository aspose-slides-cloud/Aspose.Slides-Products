---
title: 通过 Android 将 Slides PPSX 拆分为多个 HTML5
description: 使用 REST API 和开源 Android SDK 将 Slides PPSX 文件拆分成 HTML5 幻灯片
family: slides
platformtag: android
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Android 将 PPSX 拆分为多个 HTML5" h2="使用适用于 Android 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Android 将 PPSX 转换为 HTML5 拆分" %}}
