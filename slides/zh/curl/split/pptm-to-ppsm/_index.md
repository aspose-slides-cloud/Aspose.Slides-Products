---
title: 通过 cURL 将 Slides PPTM 拆分为多个 PPSM
description: 使用 REST API 和开源 cURL SDK 将 Slides PPTM 文件拆分成 PPSM 幻灯片
family: slides
platformtag: curl
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 cURL 将 PPTM 拆分为多个 PPSM" h2="使用适用于 cURL 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 cURL 将 PPTM 转换为 PPSM 拆分" %}}
