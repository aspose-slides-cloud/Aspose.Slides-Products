---
title: 通过 cURL 创建、合并、拆分和转换 PowerPoint 幻灯片
description: 通过 REST API 通过简单的 cURL 命令执行 PowerPoint 和 OpenOffice 演示幻灯片创建、处理、合并和转换
weight: 40
family: slides
platform: cURL
---
...
{{< blocks/products/pf/i18n/upper-banner h1="通过 cURL 构建 PPT 演示文稿制作器和转换器应用程序" h2="通过 REST API 通过简单的 cURL 命令执行 PowerPoint 和 OpenOffice 演示幻灯片创建、处理、合并和转换。" logoImageSrc="/headers/aspose_slides-for-curl.svg" pfName="Aspose.Slides" subTitlepfName="适用于 cURL 的 Cloud" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="适用于 cURL 的 Cloud" >}}
...
<p>适用于 cURL 的 Aspose.Slides Cloud 允许您将 PowerPoint 和 OpenOffice 演示文稿和幻灯片转换为其他支持的格式。 例如，您可以将 PPT 转换为 PDF、BMP、PNG、SVG、TIFF、JPEG、SWF 和 HTML。 您可以对演示幻灯片、演示主题、幻灯片注释、幻灯片图像、母版幻灯片、自定义字体以及 Microsoft PowerPoint 和 OpenOffice 演示文档的各种其他属性执行各种操作。</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="cURL Slides Cloud"><header>Aspose.Slides</header><footer>用于 cURL <small><em>的</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="用于演示文稿的 cURL Cloud"><header>Aspose.Slides</header><footer>用于 cURL <small><em>的</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     适用于 cURL 的 Aspose.Slides Cloud 很容易上手，因为您不需要安装任何东西。 只需在
     <a href="https://dashboard.aspose.cloud/#/apps">
      Cloud 的 Aspose
     </a>
     创建一个帐户并获取您的应用程序信息。 获得应用程序 SID 和密钥后，您就可以在任何平台上试用 适用于 cURL 的 Aspose.Slides Cloud。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     适用于 cURL 的 Aspose.Slides Cloud 允许开发人员执行基本到高级的演示幻灯片处理操作。 您可以阅读演示幻灯片信息。 创建新幻灯片。 复制、修改或删除现有幻灯片。 通过 Cloud SDK 将演示幻灯片从 PowerPoint 格式转换为其他支持的格式。 您还可以通过应用新背景、读取和删除任何幻灯片的现有背景来操作幻灯片背景。 适用于 cURL 的 Aspose.Slides Cloud 使您能够重新排列幻灯片在演示文稿中的位置。 您还可以从当前或其他演示文稿中复制幻灯片。 还可以检索演示幻灯片评论。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     适用于 cURL 的 Aspose.Slides Cloud 允许开发人员为演示幻灯片创建新的形状。 您可以读取和更新现有幻灯片形状的属性信息。 它还使您能够将幻灯片形状呈现为支持的图像格式。 适用于 cURL 的 Aspose.Slides Cloud 还可以帮助您处理演示文稿幻灯片注释。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="为什么选择 cURL 的 Aspose.Slides Cloud?" tabId="success-stories" >}}
