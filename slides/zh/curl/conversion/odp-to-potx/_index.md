---
title: 通过 cURL 从 Slides ODP 转换为 POTX
description: 使用 REST API 和开源 cURL SDK 创建、编辑或转换 Slides ODP 文件或将其转换为 POTX
family: slides
platformtag: curl
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 cURL 将 ODP 转换为 POTX" h2="使用适用于 cURL 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 cURL 将 ODP 转换为 POTX" %}}
