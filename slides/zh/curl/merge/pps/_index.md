---
title: 通过 cURL 合并多个 PPS 文件
description: 使用 REST API 和开源 cURL SDK 合并多个 Slides PPS 文件
family: slides
platformtag: curl
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="用 cURL 合并多个 PPS 文件" h2="使用适用于 cURL 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 cURL 合并 PPS 文件" %}}
