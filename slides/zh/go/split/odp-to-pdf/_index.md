---
title: 通过 Go 将 Slides ODP 拆分为多个 PDF
description: 使用 REST API 和开源 Go SDK 将 Slides ODP 文件拆分成 PDF 幻灯片
family: slides
platformtag: go
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Go 将 ODP 拆分为多个 PDF" h2="使用适用于 Go 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Go 将 ODP 转换为 PDF 拆分" %}}
