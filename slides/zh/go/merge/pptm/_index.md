---
title: 通过 Go 合并多个 PPTM 文件
description: 使用 REST API 和开源 Go SDK 合并多个 Slides PPTM 文件
family: slides
platformtag: go
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="用 Go 合并多个 PPTM 文件" h2="使用适用于 Go 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Go 合并 PPTM 文件" %}}
