---
title: 通过 Swift 将 Slides OTP 拆分为多个 POTM
description: 使用 REST API 和开源 Swift SDK 将 Slides OTP 文件拆分成 POTM 幻灯片
family: slides
platformtag: swift
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 Swift 将 OTP 拆分为多个 POTM" h2="使用适用于 Swift 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 Swift 将 OTP 转换为 POTM 拆分" %}}
