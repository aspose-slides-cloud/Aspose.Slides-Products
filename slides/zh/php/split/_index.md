...
{{< blocks/products/pf/agp/upper-banner-autogen h1="使用 PHP 将演示文稿拆分为幻灯片" h2="使用适用于 PHP 的开源 Cloud SDK 读取、编辑 Slides 数据并将其导出为其他格式">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 PHP 进行演示拆分" %}}
