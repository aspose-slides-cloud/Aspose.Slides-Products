---
title: cURL के माध्यम से Slides PPS से HTML5 में कनवर्ट करें
description: REST API और ओपन सोर्स cURL SDK के साथ Slides PPS फ़ाइलें बनाएं, संपादित करें या HTML5में कनवर्ट करें
family: slides
platformtag: curl
feature: conversion
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL के साथ PPS को HTML5 में बदलें" h2="cURL के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL के साथ PPS से HTML5 रूपांतरण" %}}
...
{{< blocks/products/pf/cloud-app app="convert" language="curl" format="html5" inputFormat="pps" >}}
