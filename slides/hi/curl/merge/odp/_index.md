---
title: cURL के माध्यम से एकाधिक ODP फ़ाइलें मर्ज करें
description: REST API और ओपन सोर्स cURL SDK के साथ एकाधिक Slides ODP फ़ाइलों को मर्ज करें
family: slides
platformtag: curl
feature: merge
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="अनेक ODP फ़ाइलों को cURL के साथ मर्ज करें" h2="cURL के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODP फ़ाइलों को cURL के साथ मर्ज करना" %}}
...
{{< blocks/products/pf/cloud-app app="merge" language="curl" inputFormat="odp" >}}
