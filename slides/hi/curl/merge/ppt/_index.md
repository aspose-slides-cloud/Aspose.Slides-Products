---
title: cURL के माध्यम से एकाधिक PPT फ़ाइलें मर्ज करें
description: REST API और ओपन सोर्स cURL SDK के साथ एकाधिक Slides PPT फ़ाइलों को मर्ज करें
family: slides
platformtag: curl
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="अनेक PPT फ़ाइलों को cURL के साथ मर्ज करें" h2="cURL के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPT फ़ाइलों को cURL के साथ मर्ज करना" %}}
...
1. मर्ज विधियों में से किसी एक को कॉल करें, यह इस पर निर्भर करता है कि आपकी इनपुट PPT फ़ाइलें कहां हैं, आप मर्ज की गई फ़ाइल को कहां संग्रहीत करना चाहते हैं, और क्या आपको फ़ाइलों के कुछ हिस्सों को मर्ज करने की आवश्यकता है
...
{{< blocks/products/pf/cloud-app app="merge" language="curl" inputFormat="ppt" >}}
