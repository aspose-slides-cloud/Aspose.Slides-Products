---
title: Java के माध्यम से Slides HTML से OTP में कनवर्ट करें
description: REST API और ओपन सोर्स Java SDK के साथ Slides HTML फ़ाइलें बनाएं, संपादित करें या OTPमें कनवर्ट करें
family: slides
platformtag: java
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java के साथ HTML को OTP में बदलें" h2="Java के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java के साथ HTML से OTP रूपांतरण" %}}
