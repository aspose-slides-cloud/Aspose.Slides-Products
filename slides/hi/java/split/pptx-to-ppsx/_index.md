---
title: Slides PPTX को Java के माध्यम से एकाधिक PPSXमें विभाजित करें
description: REST API और ओपन सोर्स Java SDK के साथ Slides PPTX फ़ाइलों को PPSX स्लाइडों में विभाजित करें
family: slides
platformtag: java
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTX को Java के साथ अनेक PPSX में विभाजित करें" h2="Java के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTX को PPSX में विभाजित करें Java के साथ विभाजित करें" %}}
