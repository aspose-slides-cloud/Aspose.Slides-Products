---
title: प्रस्तुतियों में टेक्स्ट को Java के माध्यम से बदलें
description: Slides फ़ाइलों में टेक्स्ट को REST API और ओपन सोर्स Java SDK से बदलें
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="प्रस्तुतियों में टेक्स्ट को Java से बदलें" h2="Java के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा में टेक्स्ट की घटनाओं को ढूंढें और बदलें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="प्रेजेंटेशन फ़ाइलों में टेक्स्ट को Java से बदलना" %}}
