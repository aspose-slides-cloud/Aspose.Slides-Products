---
title: Android के माध्यम से एकाधिक PPT फ़ाइलें मर्ज करें
description: REST API और ओपन सोर्स Android SDK के साथ एकाधिक Slides PPT फ़ाइलों को मर्ज करें
family: slides
platformtag: android
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="अनेक PPT फ़ाइलों को Android के साथ मर्ज करें" h2="Android के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPT फ़ाइलों को Android के साथ मर्ज करना" %}}
...
{{< blocks/products/pf/cloud-app app="merge" language="java" inputFormat="ppt" >}}
