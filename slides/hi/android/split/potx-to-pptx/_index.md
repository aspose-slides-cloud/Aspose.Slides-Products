---
title: Slides POTX को Android के माध्यम से एकाधिक PPTXमें विभाजित करें
description: REST API और ओपन सोर्स Android SDK के साथ Slides POTX फ़ाइलों को PPTX स्लाइडों में विभाजित करें
family: slides
platformtag: android
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTX को Android के साथ अनेक PPTX में विभाजित करें" h2="Android के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX को PPTX में विभाजित करें Android के साथ विभाजित करें" %}}
