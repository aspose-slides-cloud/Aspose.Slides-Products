---
title: Slides PPSM को Android के माध्यम से एकाधिक PNGमें विभाजित करें
description: REST API और ओपन सोर्स Android SDK के साथ Slides PPSM फ़ाइलों को PNG स्लाइडों में विभाजित करें
family: slides
platformtag: android
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM को Android के साथ अनेक PNG में विभाजित करें" h2="Android के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSM को PNG में विभाजित करें Android के साथ विभाजित करें" %}}
