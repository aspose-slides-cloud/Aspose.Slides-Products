---
title: Node.js के माध्यम से Slides POTX से XPS में कनवर्ट करें
description: REST API और ओपन सोर्स Node.js SDK के साथ Slides POTX फ़ाइलें बनाएं, संपादित करें या XPSमें कनवर्ट करें
family: slides
platformtag: nodejs
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Node.js के साथ POTX को XPS में बदलें" h2="Node.js के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Node.js के साथ POTX से XPS रूपांतरण" %}}
