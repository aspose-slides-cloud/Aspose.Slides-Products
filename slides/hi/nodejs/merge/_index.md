---
title: Node.js के माध्यम से एकाधिक प्रस्तुतियों को मर्ज करें
description: REST API और ओपन सोर्स Node.js SDK के साथ एकाधिक प्रस्तुतियों को मर्ज करें
family: slides
platformtag: nodejs
feature: merge
platform: Node.js
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="अनेक प्रस्तुतियों को Node.js के साथ मर्ज करें" h2="Node.js के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="प्रस्तुतियों को Node.js के साथ मर्ज करना" %}}
