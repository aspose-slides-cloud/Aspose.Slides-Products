---
title: .NET के माध्यम से Slides POTM से PNG में कनवर्ट करें
description: REST API और ओपन सोर्स .NET SDK के साथ Slides POTM फ़ाइलें बनाएं, संपादित करें या PNGमें कनवर्ट करें
family: slides
platformtag: net
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1=".NET के साथ POTM को PNG में बदलें" h2=".NET के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET के साथ POTM से PNG रूपांतरण" %}}
