---
title: C++ के माध्यम से एकाधिक HTML फ़ाइलें मर्ज करें
description: REST API और ओपन सोर्स C++ SDK के साथ एकाधिक Slides HTML फ़ाइलों को मर्ज करें
family: slides
platformtag: cpp
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="अनेक HTML फ़ाइलों को C++ के साथ मर्ज करें" h2="C++ के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML फ़ाइलों को C++ के साथ मर्ज करना" %}}
...
{{< blocks/products/pf/cloud-app app="merge" language="cpp" inputFormat="html" >}}
