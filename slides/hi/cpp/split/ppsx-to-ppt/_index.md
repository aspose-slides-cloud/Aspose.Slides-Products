---
title: Slides PPSX को C++ के माध्यम से एकाधिक PPTमें विभाजित करें
description: REST API और ओपन सोर्स C++ SDK के साथ Slides PPSX फ़ाइलों को PPT स्लाइडों में विभाजित करें
family: slides
platformtag: cpp
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSX को C++ के साथ अनेक PPT में विभाजित करें" h2="C++ के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSX को PPT में विभाजित करें C++ के साथ विभाजित करें" %}}
