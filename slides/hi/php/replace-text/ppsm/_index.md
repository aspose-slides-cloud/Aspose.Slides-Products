---
title: PPSM फ़ाइलों में टेक्स्ट को PHP के माध्यम से बदलें
description: Slides PPSM फ़ाइलों में टेक्स्ट को REST API और ओपन सोर्स PHP SDK से बदलें
family: slides
platformtag: php
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM फ़ाइलों में टेक्स्ट को PHP से बदलें" h2="PHP के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा में टेक्स्ट की घटनाओं को ढूंढें और बदलें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSM फ़ाइलों में टेक्स्ट को PHP से बदलना" %}}
