---
title: Slides PDF को Go के माध्यम से एकाधिक MDमें विभाजित करें
description: REST API और ओपन सोर्स Go SDK के साथ Slides PDF फ़ाइलों को MD स्लाइडों में विभाजित करें
family: slides
platformtag: go
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF को Go के साथ अनेक MD में विभाजित करें" h2="Go के लिए ओपन सोर्स क्लाउड एसडीके के साथ Slides डेटा को अन्य प्रारूपों में पढ़ें, संपादित करें और निर्यात करें">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PDF को MD में विभाजित करें Go के साथ विभाजित करें" %}}
