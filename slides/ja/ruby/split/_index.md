...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby を使用してプレゼンテーションをスライドに分割する" h2="オープン ソースの Cloud Ruby用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby によるプレゼンテーション分割" %}}
