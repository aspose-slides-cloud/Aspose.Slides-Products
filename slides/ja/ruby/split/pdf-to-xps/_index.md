---
title: Slides PDF を Ruby 経由で複数の XPS に分割する
description: REST API とオープン ソース Ruby SDK を使用して Slides PDF ファイルを XPS スライドに分割する
family: slides
platformtag: ruby
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby で PDF を複数の XPS に分割する" h2="オープン ソースの Cloud Ruby用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
