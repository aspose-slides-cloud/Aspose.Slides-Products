---
title: Ruby経由で複数のPPTファイルをマージ
description: REST API とオープン ソース Ruby SDK を使用して複数の Slides PPT ファイルをマージする
family: slides
platformtag: ruby
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の PPT ファイルを Ruby でマージする" h2="オープン ソースの Cloud Ruby用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
