---
title: Python経由で複数のPOTXファイルをマージ
description: REST API とオープン ソース Python SDK を使用して複数の Slides POTX ファイルをマージする
family: slides
platformtag: python
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の POTX ファイルを Python でマージする" h2="オープン ソースの Cloud Python用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
