---
title: Python経由で複数のPPTMファイルをマージ
description: REST API とオープン ソース Python SDK を使用して複数の Slides PPTM ファイルをマージする
family: slides
platformtag: python
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の PPTM ファイルを Python でマージする" h2="オープン ソースの Cloud Python用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
