---
title: Python 経由で POTM ファイル内のテキストを置換する
description: Slides POTM ファイル内のテキストを REST API とオープンソース Python SDK で置き換えます
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTM ファイル内のテキストを Python で置き換える" h2="オープンソースの Cloud Python用SDK を使用して、Slides データ内のテキストの出現箇所を検索して置換します">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Python を使用した POTM ファイル内のテキストの置換" %}}
