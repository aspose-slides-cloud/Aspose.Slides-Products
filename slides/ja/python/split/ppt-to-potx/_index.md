---
title: Slides PPT を Python 経由で複数の POTX に分割する
description: REST API とオープン ソース Python SDK を使用して Slides PPT ファイルを POTX スライドに分割する
family: slides
platformtag: python
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Python で PPT を複数の POTX に分割する" h2="オープン ソースの Cloud Python用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
