---
title: Slides POTM から Python 経由で PPTM に変換
description: REST API とオープン ソース Python SDK を使用して Slides POTM ファイルを作成、編集、PPTM に変換します
family: slides
platformtag: python
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Python で POTM を PPTM に変換" h2="オープン ソースの Cloud Python用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Python を使用した POTM から PPTM への変換" %}}
