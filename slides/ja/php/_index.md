---
title: PHP REST SDK を使用して PPT PPTX スライド ビューアーとコンバーターをビルドする
description: クラウド ストレージから PowerPoint および OpenOffice プレゼンテーションを取得して、クラウド内のスライドを表示、マージ、分割、および変換します
weight: 100
family: slides
platform: PHP
---
...
{{< blocks/products/pf/i18n/upper-banner h1="プレゼンテーション スライドを処理するための PHP Cloud SDK" h2="クラウド ストレージから PowerPoint および OpenOffice プレゼンテーションを取得して、クラウド内のスライドを表示、マージ、分割、および変換します。" logoImageSrc="/headers/aspose_slides-for-php.svg" pfName="Aspose.Slides" subTitlepfName="PHP 用 Cloud SDK" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="PHP 用 Cloud SDK" >}}
...
<p>PHP 用 Aspose.Slides Cloud SDK は、ソフトウェアをインストールせずに PPT スライドと PowerPoint プレゼンテーションを作成できるクラウドベースの PHP アプリケーションを作成するのに役立ちます。 PHP 用 Aspose.Slides Cloud SDK は、OpenOffice プレゼンテーション フォーマット、ODP および OTP もサポートしています。 PHP 用 Aspose.Slides Cloud SDK は Aspose.Slides REST API に基づいており、MIT ライセンスの下で提供されます。</p>
<p>PHP 用 Aspose.Slides Cloud SDK を使用すると、クラウド PHP プログラムで新しいプレゼンテーションを作成したり、クラウド ストレージにある既存のプレゼンテーションにアクセスしたりできます。 当社の PHP REST SDK を介して、プレゼンテーション全体の操作、個々のスライドの変更、マスター スライドの複製、PowerPoint プレゼンテーションのインタラクティブ シーケンスの更新、プレゼンテーションで使用するカスタム フォントの指定を行うことができます。</p>
<p>PHP 用 Aspose.Slides Cloud SDK は、PHP コードがプレゼンテーション スライドから形状、画像、メモを抽出するのを支援します。 PPTX、PPT、ODP、OTP を SWF、HTML、BMP、PNG、TIFF、JPEG、SVG 形式に変換することもできます。</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP プレゼンテーション SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>for </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="プレゼンテーション用 PHP SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>for </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     何もインストールする必要がないため、Aspose.Slides Cloud PHP SDK を簡単に使い始めることができます。
	 <a href="https://dashboard.aspose.cloud/#/apps">
	   Aspose for Cloud
     </a>
	 でアカウントを作成し、アプリケーション情報を取得するだけです。 アプリ SID とキーを取得したら、任意のプラットフォームで Aspose.Slides Cloud PHP SDK を試す準備が整います。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <p>
     PHP 用 Aspose.Slides Cloud SDK を使用すると、開発者はプレゼンテーション スライドの新しい形状を作成できます。 既存のスライド図形のプロパティ情報を読み取って更新できます。 プレゼンテーション スライド処理 Cloud SDK を使用すると、スライドの形状をサポートされている画像形式にレンダリングできます。 PHP 用 Aspose.Slides Cloud SDK は、プレゼンテーション スライド ノートの操作にも役立ちます。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="ソースコード" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-PHP" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Aspose.Slide Cloud SDK for PHP を使用する理由" tabId="success-stories" >}}
