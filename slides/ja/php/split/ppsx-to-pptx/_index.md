---
title: Slides PPSX を PHP 経由で複数の PPTX に分割する
description: REST API とオープン ソース PHP SDK を使用して Slides PPSX ファイルを PPTX スライドに分割する
family: slides
platformtag: php
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PHP で PPSX を複数の PPTX に分割する" h2="オープン ソースの Cloud PHP用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
