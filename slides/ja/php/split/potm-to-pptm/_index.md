---
title: Slides POTM を PHP 経由で複数の PPTM に分割する
description: REST API とオープン ソース PHP SDK を使用して Slides POTM ファイルを PPTM スライドに分割する
family: slides
platformtag: php
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PHP で POTM を複数の PPTM に分割する" h2="オープン ソースの Cloud PHP用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
