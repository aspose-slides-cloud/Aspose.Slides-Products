---
title: Slides POTM から .NET 経由で HTML5 に変換
description: REST API とオープン ソース .NET SDK を使用して Slides POTM ファイルを作成、編集、HTML5 に変換します
family: slides
platformtag: net
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1=".NET で POTM を HTML5 に変換" h2="オープン ソースの Cloud .NET用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET を使用した POTM から HTML5 への変換" %}}
