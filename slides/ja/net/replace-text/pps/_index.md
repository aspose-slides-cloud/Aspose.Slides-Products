---
title: .NET 経由で PPS ファイル内のテキストを置換する
description: Slides PPS ファイル内のテキストを REST API とオープンソース .NET SDK で置き換えます
family: slides
platformtag: net
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS ファイル内のテキストを .NET で置き換える" h2="オープンソースの Cloud .NET用SDK を使用して、Slides データ内のテキストの出現箇所を検索して置換します">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET を使用した PPS ファイル内のテキストの置換" %}}
