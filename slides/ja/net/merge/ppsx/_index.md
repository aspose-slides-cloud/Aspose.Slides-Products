---
title: .NET経由で複数のPPSXファイルをマージ
description: REST API とオープン ソース .NET SDK を使用して複数の Slides PPSX ファイルをマージする
family: slides
platformtag: net
feature: merge
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の PPSX ファイルを .NET でマージする" h2="オープン ソースの Cloud .NET用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
