---
title: .NET経由で複数のPPSMファイルをマージ
description: REST API とオープン ソース .NET SDK を使用して複数の Slides PPSM ファイルをマージする
family: slides
platformtag: net
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の PPSM ファイルを .NET でマージする" h2="オープン ソースの Cloud .NET用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
