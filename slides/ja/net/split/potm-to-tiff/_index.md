---
title: Slides POTM を .NET 経由で複数の TIFF に分割する
description: REST API とオープン ソース .NET SDK を使用して Slides POTM ファイルを TIFF スライドに分割する
family: slides
platformtag: net
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1=".NET で POTM を複数の TIFF に分割する" h2="オープン ソースの Cloud .NET用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
