---
title: Slides PPSM を Swift 経由で複数の PPSX に分割する
description: REST API とオープン ソース Swift SDK を使用して Slides PPSM ファイルを PPSX スライドに分割する
family: slides
platformtag: swift
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Swift で PPSM を複数の PPSX に分割する" h2="オープン ソースの Cloud Swift用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
