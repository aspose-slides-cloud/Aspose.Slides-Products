---
title: Slides HTML から Java 経由で PPSM に変換
description: REST API とオープン ソース Java SDK を使用して Slides HTML ファイルを作成、編集、PPSM に変換します
family: slides
platformtag: java
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java で HTML を PPSM に変換" h2="オープン ソースの Cloud Java用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java を使用した HTML から PPSM への変換" %}}
