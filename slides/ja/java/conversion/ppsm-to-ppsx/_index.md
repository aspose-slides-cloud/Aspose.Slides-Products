---
title: Slides PPSM から Java 経由で PPSX に変換
description: REST API とオープン ソース Java SDK を使用して Slides PPSM ファイルを作成、編集、PPSX に変換します
family: slides
platformtag: java
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java で PPSM を PPSX に変換" h2="オープン ソースの Cloud Java用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java を使用した PPSM から PPSX への変換" %}}
