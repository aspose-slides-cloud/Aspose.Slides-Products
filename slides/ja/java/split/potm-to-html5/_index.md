---
title: Slides POTM を Java 経由で複数の HTML5 に分割する
description: REST API とオープン ソース Java SDK を使用して Slides POTM ファイルを HTML5 スライドに分割する
family: slides
platformtag: java
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java で POTM を複数の HTML5 に分割する" h2="オープン ソースの Cloud Java用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
