---
title: Slides HTML を Java 経由で複数の TIFF に分割する
description: REST API とオープン ソース Java SDK を使用して Slides HTML ファイルを TIFF スライドに分割する
family: slides
platformtag: java
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java で HTML を複数の TIFF に分割する" h2="オープン ソースの Cloud Java用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
