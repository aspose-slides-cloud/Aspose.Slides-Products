---
title: Perl経由で複数のPPTMファイルをマージ
description: REST API とオープン ソース Perl SDK を使用して複数の Slides PPTM ファイルをマージする
family: slides
platformtag: perl
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の PPTM ファイルを Perl でマージする" h2="オープン ソースの Cloud Perl用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
