---
title: Slides ODP を Perl 経由で複数の PPSM に分割する
description: REST API とオープン ソース Perl SDK を使用して Slides ODP ファイルを PPSM スライドに分割する
family: slides
platformtag: perl
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Perl で ODP を複数の PPSM に分割する" h2="オープン ソースの Cloud Perl用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
