---
title: Slides PDF から cURL 経由で PPSM に変換
description: REST API とオープン ソース cURL SDK を使用して Slides PDF ファイルを作成、編集、PPSM に変換します
family: slides
platformtag: curl
feature: conversion
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL で PDF を PPSM に変換" h2="オープン ソースの Cloud cURL用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL を使用した PDF から PPSM への変換" %}}
