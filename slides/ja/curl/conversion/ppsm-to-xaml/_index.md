---
title: Slides PPSM から cURL 経由で XAML に変換
description: REST API とオープン ソース cURL SDK を使用して Slides PPSM ファイルを作成、編集、XAML に変換します
family: slides
platformtag: curl
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL で PPSM を XAML に変換" h2="オープン ソースの Cloud cURL用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL を使用した PPSM から XAML への変換" %}}
