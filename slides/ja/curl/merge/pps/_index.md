---
title: cURL経由で複数のPPSファイルをマージ
description: REST API とオープン ソース cURL SDK を使用して複数の Slides PPS ファイルをマージする
family: slides
platformtag: curl
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の PPS ファイルを cURL でマージする" h2="オープン ソースの Cloud cURL用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
