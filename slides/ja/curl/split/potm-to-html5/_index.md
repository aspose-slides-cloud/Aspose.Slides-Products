---
title: Slides POTM を cURL 経由で複数の HTML5 に分割する
description: REST API とオープン ソース cURL SDK を使用して Slides POTM ファイルを HTML5 スライドに分割する
family: slides
platformtag: curl
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL で POTM を複数の HTML5 に分割する" h2="オープン ソースの Cloud cURL用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
