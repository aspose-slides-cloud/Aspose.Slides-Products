---
title: Slides OTP を cURL 経由で複数の PDF に分割する
description: REST API とオープン ソース cURL SDK を使用して Slides OTP ファイルを PDF スライドに分割する
family: slides
platformtag: curl
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL で OTP を複数の PDF に分割する" h2="オープン ソースの Cloud cURL用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
