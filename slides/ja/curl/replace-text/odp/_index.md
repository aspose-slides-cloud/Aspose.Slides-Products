---
title: cURL 経由で ODP ファイル内のテキストを置換する
description: Slides ODP ファイル内のテキストを REST API とオープンソース cURL SDK で置き換えます
family: slides
platformtag: curl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP ファイル内のテキストを cURL で置き換える" h2="オープンソースの Cloud cURL用SDK を使用して、Slides データ内のテキストの出現箇所を検索して置換します">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL を使用した ODP ファイル内のテキストの置換" %}}
