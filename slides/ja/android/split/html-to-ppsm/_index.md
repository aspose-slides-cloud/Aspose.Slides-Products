---
title: Slides HTML を Android 経由で複数の PPSM に分割する
description: REST API とオープン ソース Android SDK を使用して Slides HTML ファイルを PPSM スライドに分割する
family: slides
platformtag: android
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Android で HTML を複数の PPSM に分割する" h2="オープン ソースの Cloud Android用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
