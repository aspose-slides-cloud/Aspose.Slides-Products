---
title: Android 経由で PPTM ファイル内のテキストを置換する
description: Slides PPTM ファイル内のテキストを REST API とオープンソース Android SDK で置き換えます
family: slides
platformtag: android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTM ファイル内のテキストを Android で置き換える" h2="オープンソースの Cloud Android用SDK を使用して、Slides データ内のテキストの出現箇所を検索して置換します">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Android を使用した PPTM ファイル内のテキストの置換" %}}
