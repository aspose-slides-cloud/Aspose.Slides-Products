---
title: Android経由で複数のPPSMファイルをマージ
description: REST API とオープン ソース Android SDK を使用して複数の Slides PPSM ファイルをマージする
family: slides
platformtag: android
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の PPSM ファイルを Android でマージする" h2="オープン ソースの Cloud Android用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
