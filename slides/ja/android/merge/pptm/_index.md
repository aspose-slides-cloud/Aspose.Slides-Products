---
title: Android経由で複数のPPTMファイルをマージ
description: REST API とオープン ソース Android SDK を使用して複数の Slides PPTM ファイルをマージする
family: slides
platformtag: android
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の PPTM ファイルを Android でマージする" h2="オープン ソースの Cloud Android用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
