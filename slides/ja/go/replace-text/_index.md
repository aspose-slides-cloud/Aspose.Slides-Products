...
{{< blocks/products/pf/agp/upper-banner-autogen h1="プレゼンテーション内のテキストを Go で置換する" h2="オープンソースの Cloud Go用SDK を使用して、Slides データ内のテキストの出現箇所を検索して置換します">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Go を使用したプレゼンテーション内のテキストの置換" %}}
