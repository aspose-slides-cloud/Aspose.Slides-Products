---
title: Slides PPS を Go 経由で複数の OTP に分割する
description: REST API とオープン ソース Go SDK を使用して Slides PPS ファイルを OTP スライドに分割する
family: slides
platformtag: go
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Go で PPS を複数の OTP に分割する" h2="オープン ソースの Cloud Go用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
