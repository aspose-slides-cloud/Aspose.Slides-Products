---
title: Slides PPS を C++ 経由で複数の OTP に分割する
description: REST API とオープン ソース C++ SDK を使用して Slides PPS ファイルを OTP スライドに分割する
family: slides
platformtag: cpp
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C++ で PPS を複数の OTP に分割する" h2="オープン ソースの Cloud C++用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
