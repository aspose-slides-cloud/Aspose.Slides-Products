---
title: Slides PPSX を C++ 経由で複数の POTM に分割する
description: REST API とオープン ソース C++ SDK を使用して Slides PPSX ファイルを POTM スライドに分割する
family: slides
platformtag: cpp
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C++ で PPSX を複数の POTM に分割する" h2="オープン ソースの Cloud C++用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
