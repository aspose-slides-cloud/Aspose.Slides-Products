---
title: C++経由で複数のPOTXファイルをマージ
description: REST API とオープン ソース C++ SDK を使用して複数の Slides POTX ファイルをマージする
family: slides
platformtag: cpp
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="複数の POTX ファイルを C++ でマージする" h2="オープン ソースの Cloud C++用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
