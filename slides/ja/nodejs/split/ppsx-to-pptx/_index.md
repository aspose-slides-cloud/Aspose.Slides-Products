---
title: Slides PPSX を Node.js 経由で複数の PPTX に分割する
description: REST API とオープン ソース Node.js SDK を使用して Slides PPSX ファイルを PPTX スライドに分割する
family: slides
platformtag: nodejs
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Node.js で PPSX を複数の PPTX に分割する" h2="オープン ソースの Cloud Node.js用SDK を使用して、Slides データの読み取り、編集、および他の形式へのエクスポート">}}
