---
title: クラウド用 Node.js プレゼンテーション ビルダー SDK | RESTful API
description: クラウドで PowerPoint および OpenOffice スライドを作成、コピー、マージ、分割、ダウンロード、および変換するための、統合がシームレスで使いやすい Node.js REST API
weight: 80
family: slides
platform: Node.js
---
...
{{< blocks/products/pf/i18n/upper-banner h1="クラウドでスライドを処理する Node.js REST SDK" h2="クラウドで PowerPoint および OpenOffice スライドを作成、コピー、マージ、分割、ダウンロード、および変換するための、統合がシームレスで使いやすい Node.js REST API。" logoImageSrc="/headers/aspose_slides-for-node.svg" pfName="Aspose.Slides" subTitlepfName="Node.js 用 Cloud SDK" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Node.js 用 Cloud SDK" >}}
...
<p>Node.js 用 Aspose.Slides Cloud SDK は、Node.js クラウドベース アプリケーションが、クラウド ストレージでホストされている PowerPoint および OpenOffice プレゼンテーションにアクセスして、PPT、PPTX、ODP、OTP から SWF、HTML、PDF、XPS への処理および変換を支援します。 PDF/A、JPEG、SVG、TIFF、BMP、PNG。</p>
<p>Node.js 用 Aspose.Slides Cloud SDK を使用すると、Node.js コードで PowerPoint プレゼンテーションを分割したり、プレゼンテーション スライドを結合したり、スライドをコピー、移動、または削除したりできます。 簡単な Node.js コマンドを使用して、クラウド上にあるプレゼンテーションのフォント、フォーマット、配色を取得します。 マスター スライド情報を読み取り、それを複製します。 スライド アニメーションのメイン シーケンスを更新します。 プレゼンテーション スライドから図形、メモ、画像を抽出します。</p>
<p>Node.js 用 Aspose.Slides Cloud SDK は Aspose.Slides REST API のラッパーであり、この PowerPoint プレゼンテーション操作クラウド SDK は MIT ライセンスの下で利用できます。</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-node.png" alt="Node.js プレゼンテーション SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>for </em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-node.png" alt="プレゼンテーション用 Node.js SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>for </em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     何もインストールする必要がないため、Aspose.Slides Cloud Node.js SDK を簡単に使い始めることができます。
	 <a href="https://dashboard.aspose.cloud/#/apps">
	   Aspose for Cloud
     </a>
	 でアカウントを作成し、アプリケーション情報を取得するだけです。 アプリ SID とキーを取得したら、任意のプラットフォームで Aspose.Slides Cloud Node.js SDK を試す準備が整います。	
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Node.js 用 Aspose.Slides Cloud SDK を使用すると、開発者はプレゼンテーション スライドの新しい形状を作成できます。 既存のスライド図形のプロパティ情報を読み取って更新できます。 プレゼンテーション スライド処理 Cloud SDK を使用すると、スライドの形状をサポートされている画像形式にレンダリングできます。 Node.js 用 Aspose.Slides Cloud SDK は、プレゼンテーション スライド ノートの操作にも役立ちます。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="ソースコード" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Node.js" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Aspose.Slide Cloud SDK for Node.js を使用する理由" tabId="success-stories" >}}
