---
title: Zusammenführen mehrerer Präsentationen über Java
description: Zusammenführen mehrerer Präsentationen mit REST API und Open Source Java SDK
family: slides
platformtag: java
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mehrere Präsentationen mit Java zusammenführen" h2="Lesen, bearbeiten und exportieren Sie Slides-Daten in andere Formate mit Open Source Cloud SDK für Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Präsentationen mit Java zusammenführen" %}}
