---
title: Zusammenführen mehrerer Präsentationen über PHP
description: Zusammenführen mehrerer Präsentationen mit REST API und Open Source PHP SDK
family: slides
platformtag: php
feature: merge
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mehrere Präsentationen mit PHP zusammenführen" h2="Lesen, bearbeiten und exportieren Sie Slides-Daten in andere Formate mit Open Source Cloud SDK für PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Präsentationen mit PHP zusammenführen" %}}
