---
title: Ersetzen von Text in PPTX-Dateien über PHP
description: Ersetzen Sie Text in Slides PPTX-Dateien mit REST API und Open Source PHP SDK
family: slides
platformtag: php
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in PPTX-Dateien durch PHP ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in PPTX-Dateien durch PHP ersetzen" %}}
