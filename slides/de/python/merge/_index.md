---
title: Zusammenführen mehrerer Präsentationen über Python
description: Zusammenführen mehrerer Präsentationen mit REST API und Open Source Python SDK
family: slides
platformtag: python
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mehrere Präsentationen mit Python zusammenführen" h2="Lesen, bearbeiten und exportieren Sie Slides-Daten in andere Formate mit Open Source Cloud SDK für Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Präsentationen mit Python zusammenführen" %}}
