---
title: Zusammenführen mehrerer POTM-Dateien über Python
description: Zusammenführen mehrerer Slides-Dateien mit REST API und Open Source Python SDK
family: slides
platformtag: python
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mehrere POTM-Dateien mit Python zusammenführen" h2="Lesen, bearbeiten und exportieren Sie Slides-Daten in andere Formate mit Open Source Cloud SDK für Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Zusammenführen von POTM-Dateien mit Python" %}}
