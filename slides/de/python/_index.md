---
title: PowerPoint- und OpenOffice-Folien-Builder über Python Cloud SDK
description: Ermöglichen Sie Ihren Cloud-basierten Python-Apps das Erstellen, Kopieren, Zusammenführen, Teilen, Herunterladen und Konvertieren von PowerPoint- und OpenOffice-Präsentationsfolien
weight: 110
family: slides
platform: Python
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Python REST SDK zum Erstellen und Konvertieren von Präsentationen" h2="Ermöglichen Sie Ihren Cloud-basierten Python-Apps das Erstellen, Kopieren, Zusammenführen, Teilen, Herunterladen und Konvertieren von PowerPoint- und OpenOffice-Präsentationsfolien." logoImageSrc="/headers/aspose_slides-for-python.svg" pfName="Aspose.Slides" subTitlepfName="Cloud-SDK für Python" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Cloud-SDK für Python" >}}
...
<p>Aspose.Slides Cloud SDK für Python baut auf der Aspose.Slides REST API auf und wird unter einer MIT-Lizenz angeboten. Aspose.Slides Cloud SDK für Python lässt sich einfach in Ihre Python-Anwendungen integrieren und ermöglicht ihnen das Abrufen, Verarbeiten und Konvertieren von PowerPoint- und OpenOffice-Präsentationsfolien in der Cloud, ohne Installation durch einen Drittanbieter.</p>
<p>Mit Aspose.Slides Cloud SDK für Python können Ihre Python-Programme einzelne Folien aus einer Präsentation herunterladen, Platzhalterinformationen von einer Folie abrufen, eine Folie kopieren, verschieben oder löschen. Mit dem Python SDK können Sie auch ein Schriftschema, ein Formatschema, ein Farbschema oder ein Thema einer Folie abrufen. Unterstützung ist auch für das Klonen von Folienmasterinformationen aus einer in der Cloud gehosteten Präsentation verfügbar.</p>
<p>Aspose.Slides Cloud SDK für Python ermöglicht es Ihren Python-Apps auch, mit Folienbildern, Formen, Notizen, Textvorkommen und anderen Dokumentattributen zu arbeiten. Sie können Python SDK ganz einfach verwenden, um PPT, PPTX, ODP, OTP in PDF, XPS, SWF, HTML oder viele der Bildformate (BMP, JPEG, TIFF, SVG, PNG) zu konvertieren.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-python.png" alt="Python Cloud SDK für Präsentationen"><header>Aspose.Slides</header><footer>Cloud <small> <em>für </em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram1-->
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
      Der Einstieg in Aspose.Slides Cloud-SDK für Python ist einfach, da Sie nichts installieren müssen. Erstellen Sie einfach ein Konto bei
      <a href="https://dashboard.aspose.cloud/#/apps">
        Aspose Cloud
      </a>
      und erhalten Sie Ihre Anwendungsinformationen. Sobald Sie die App-SID und den Schlüssel haben, können Sie das Aspose.Slides Cloud-SDK für Python auf jeder Plattform ausprobieren.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Quellcode" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Python" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.Slides Cloud SDK für Python?" tabId="success-stories" >}}
