---
title: Ersetzen von Text in PPTM-Dateien über Python
description: Ersetzen Sie Text in Slides PPTM-Dateien mit REST API und Open Source Python SDK
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in PPTM-Dateien durch Python ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in PPTM-Dateien durch Python ersetzen" %}}
...
1. Rufen Sie eine der Textersetzungsmethoden auf, je nachdem, wo sich Ihre PPTM-Dateien befinden und ob Sie Text im gesamten Dokument oder auf einer einzelnen Folie ersetzen müssen
