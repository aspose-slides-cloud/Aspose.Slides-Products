---
title: Ersetzen von Text in PPTM-Dateien über .NET
description: Ersetzen Sie Text in Slides PPTM-Dateien mit REST API und Open Source .NET SDK
family: slides
platformtag: net
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in PPTM-Dateien durch .NET ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in PPTM-Dateien durch .NET ersetzen" %}}
