---
title: Erstellen Sie Präsentationsersteller und -betrachter mit C# REST SDK
description: C# Cloud SDK zum Erstellen und Verarbeiten von PowerPoint- und OpenOffice-Präsentationen in der Cloud, ohne Software installieren zu müssen
weight: 70
family: slides
platform: .NET
---
...
{{< blocks/products/pf/i18n/upper-banner h1="C# SDK zum Anzeigen, Verarbeiten und Konvertieren von Folien in der Cloud" h2="C# Cloud SDK zum Erstellen und Verarbeiten von PowerPoint- und OpenOffice-Präsentationen in der Cloud, ohne Software installieren zu müssen." logoImageSrc="/headers/aspose_slides-for-net.svg" pfName="Aspose.Slides" subTitlepfName="Cloud-SDK für .NET" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Cloud-SDK für .NET" >}}
...
<p>Aspose.Slides Cloud SDK für .NET wird verwendet, um PPT-, PPTX-, ODP- und OTP-Verarbeitungsfunktionen nahtlos in Ihre Cloud-basierten Anwendungen zu integrieren, die mit C#, ASP.NET oder anderen .NET-unterstützten Sprachen erstellt wurden. Aspose.Slides Cloud SDK für .NET ist ein Wrapper um die Aspose.Slides REST API und wird unter einer MIT-Lizenz angeboten.</p>
<p>Aspose.Slides Cloud SDK für .NET verbessert Ihren C#-Code, um PowerPoint-Präsentationen zu erstellen, ausgewählte Folien zusammenzuführen, Präsentationen aufzuteilen sowie PowerPoint- und OpenOffice-Präsentationsdokumente in PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, HTML und SWF.</p>
<p>Aspose.Slides Cloud SDK für .NET ermöglicht es Ihrer Cloud-basierten .NET-Anwendung auch, mit Präsentationsfolienanimationen zu arbeiten, Masterfolieninformationen zu lesen und zu klonen, Foliennotizen zu extrahieren und herunterzuladen, Präsentationsbilder in ein bestimmtes Format zu extrahieren, Formen aus einer Folie zu extrahieren , sowie verschiedene andere Operationen mit Ihren C#-Programmen über unser Aspose.Slides Cloud SDK für .NET durchführen.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt=".NET PowerPoint Cloud-SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>für </em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt=".NET Cloud-SDK für Präsentationen"><header>Aspose.Slides</header><footer>Cloud <small> <em>für</em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
      Der Einstieg in Aspose.Slides Cloud-SDK für .NET ist einfach, da Sie nichts installieren müssen. Erstellen Sie einfach ein Konto bei
      <a href="https://dashboard.aspose.cloud/#/apps">
        Aspose Cloud
      </a>
      und erhalten Sie Ihre Anwendungsinformationen. Sobald Sie die App-SID und den Schlüssel haben, können Sie das Aspose.Slides Cloud-SDK für .NET auf jeder Plattform ausprobieren.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Quellcode" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.Slides Cloud SDK für .NET?" tabId="success-stories" >}}
