---
title: Ersetzen von Text in POTX-Dateien über Swift
description: Ersetzen Sie Text in Slides POTX-Dateien mit REST API und Open Source Swift SDK
family: slides
platformtag: swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in POTX-Dateien durch Swift ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in POTX-Dateien durch Swift ersetzen" %}}
