---
title: Ersetzen von Text in PPT-Dateien über Perl
description: Ersetzen Sie Text in Slides PPT-Dateien mit REST API und Open Source Perl SDK
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in PPT-Dateien durch Perl ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in PPT-Dateien durch Perl ersetzen" %}}
