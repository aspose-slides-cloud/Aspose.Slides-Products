---
title: Ersetzen von Text in Präsentationen über Node.js
description: Ersetzen Sie Text in Slides-Dateien mit REST API und Open Source Node.js SDK
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in Präsentationen durch Node.js ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in Präsentationen durch Node.js ersetzen" %}}
