---
title: Node.js Presentation Builder SDK für Cloud | RESTful-APIs
description: Nahtlose Integration und benutzerfreundliche Node.js-REST-API zum Erstellen, Kopieren, Zusammenführen, Teilen, Herunterladen und Konvertieren von PowerPoint- und OpenOffice-Folien in der Cloud
weight: 80
family: slides
platform: Node.js
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Node.js REST SDK zum Verarbeiten von Folien in der Cloud" h2="Nahtlose Integration und benutzerfreundliche Node.js-REST-API zum Erstellen, Kopieren, Zusammenführen, Teilen, Herunterladen und Konvertieren von PowerPoint- und OpenOffice-Folien in der Cloud." logoImageSrc="/headers/aspose_slides-for-node.svg" pfName="Aspose.Slides" subTitlepfName="Cloud-SDK für Node.js" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Cloud-SDK für Node.js" >}}
...
<p>Aspose.Slides Cloud SDK für Node.js unterstützt Ihre Cloud-basierten Node.js-Anwendungen beim Zugriff auf PowerPoint- und OpenOffice-Präsentationen, die im Cloud-Speicher gehostet werden, um sie zu verarbeiten und von PPT, PPTX, ODP, OTP in SWF, HTML, PDF, XPS zu konvertieren. PDF/A, JPEG, SVG, TIFF, BMP und PNG.</p>
<p>Aspose.Slides Cloud SDK für Node.js ermöglicht es Ihrem Node.js-Code, PowerPoint-Präsentationen aufzuteilen, Präsentationsfolien zusammenzuführen sowie Folien zu kopieren, zu verschieben oder zu löschen. Verwenden Sie einfache Node.js-Befehle, um Schriftart, Format und Farbschema von Präsentationen abzurufen, die sich in der Cloud befinden. Lesen Sie die Master-Folieninformationen und klonen Sie sie. Aktualisieren Sie die Hauptsequenz der Folienanimationen. Extrahieren Sie Formen, Notizen und Bilder aus Präsentationsfolien.</p>
<p>Aspose.Slides Cloud SDK für Node.js ist ein Wrapper um die Aspose.Slides REST API und dieses Cloud-SDK zur Manipulation von PowerPoint-Präsentationen ist unter der MIT-Lizenz verfügbar.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-node.png" alt="Node.js PowerPoint Cloud-SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>für </em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-node.png" alt="Node.js Cloud SDK für Präsentationen"><header>Aspose.Slides</header><footer>Cloud <small> <em>für</em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
      Der Einstieg in Aspose.Slides Cloud-SDK für Node.js ist einfach, da Sie nichts installieren müssen. Erstellen Sie einfach ein Konto bei
      <a href="https://dashboard.aspose.cloud/#/apps">
        Aspose Cloud
      </a>
      und erhalten Sie Ihre Anwendungsinformationen. Sobald Sie die App-SID und den Schlüssel haben, können Sie das Aspose.Slides Cloud-SDK für Node.js auf jeder Plattform ausprobieren.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Quellcode" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Node.js" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Warum Aspose.Slides Cloud SDK für Node.js?" tabId="success-stories" >}}
