---
title: Ersetzen von Text in ODP-Dateien über Go
description: Ersetzen Sie Text in Slides ODP-Dateien mit REST API und Open Source Go SDK
family: slides
platformtag: go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in ODP-Dateien durch Go ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in ODP-Dateien durch Go ersetzen" %}}
