---
title: Ersetzen von Text in OTP-Dateien über Go
description: Ersetzen Sie Text in Slides OTP-Dateien mit REST API und Open Source Go SDK
family: slides
platformtag: go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in OTP-Dateien durch Go ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in OTP-Dateien durch Go ersetzen" %}}
