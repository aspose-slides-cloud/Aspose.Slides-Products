---
title: Ersetzen von Text in OTP-Dateien über cURL
description: Ersetzen Sie Text in Slides OTP-Dateien mit REST API und Open Source cURL SDK
family: slides
platformtag: curl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in OTP-Dateien durch cURL ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in OTP-Dateien durch cURL ersetzen" %}}
