---
title: Ersetzen von Text in POTX-Dateien über Ruby
description: Ersetzen Sie Text in Slides POTX-Dateien mit REST API und Open Source Ruby SDK
family: slides
platformtag: ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in POTX-Dateien durch Ruby ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in POTX-Dateien durch Ruby ersetzen" %}}
