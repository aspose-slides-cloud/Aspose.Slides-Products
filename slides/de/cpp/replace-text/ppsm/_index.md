---
title: Ersetzen von Text in PPSM-Dateien über C++
description: Ersetzen Sie Text in Slides PPSM-Dateien mit REST API und Open Source C++ SDK
family: slides
platformtag: cpp
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Text in PPSM-Dateien durch C++ ersetzen" h2="Suchen und ersetzen Sie Textvorkommen in Slides-Daten mit dem Open-Source-Cloud SDK für C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Text in PPSM-Dateien durch C++ ersetzen" %}}
