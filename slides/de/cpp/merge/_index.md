---
title: Zusammenführen mehrerer Präsentationen über C++
description: Zusammenführen mehrerer Präsentationen mit REST API und Open Source C++ SDK
family: slides
platformtag: cpp
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mehrere Präsentationen mit C++ zusammenführen" h2="Lesen, bearbeiten und exportieren Sie Slides-Daten in andere Formate mit Open Source Cloud SDK für C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Präsentationen mit C++ zusammenführen" %}}
