---
title: Zusammenführen mehrerer PPSM-Dateien über C++
description: Zusammenführen mehrerer Slides-Dateien mit REST API und Open Source C++ SDK
family: slides
platformtag: cpp
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mehrere PPSM-Dateien mit C++ zusammenführen" h2="Lesen, bearbeiten und exportieren Sie Slides-Daten in andere Formate mit Open Source Cloud SDK für C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Zusammenführen von PPSM-Dateien mit C++" %}}
...
{{< blocks/products/pf/cloud-app app="merge" language="cpp" inputFormat="ppsm" >}}
