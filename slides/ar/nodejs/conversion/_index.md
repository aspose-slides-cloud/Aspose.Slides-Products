---
title: تحويل العروض التقديمية عبر Node.js
description: قم بإنشاء أو تحرير أو تحويل ملفات Slides باستخدام REST API وNode.js SDK مفتوح المصدر
family: slides
platformtag: nodejs
feature: conversion
platform: Node.js
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل العروض التقديمية باستخدام Node.js" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل العرض التقديمي باستخدام Node.js" %}}
