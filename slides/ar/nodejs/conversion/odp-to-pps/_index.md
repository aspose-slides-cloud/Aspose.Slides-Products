---
title: التحويل من Slides ODP إلى PPS عبر Node.js
description: إنشاء أو تحرير أو تحويل ملفات Slides ODP إلى PPS باستخدام REST API وNode.js SDK مفتوح المصدر
family: slides
platformtag: nodejs
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل ODP إلى PPS باستخدام Node.js" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من ODP إلى PPS باستخدام Node.js" %}}
