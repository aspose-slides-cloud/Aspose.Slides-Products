---
title: التحويل من Slides OTP إلى PPTX عبر Node.js
description: إنشاء أو تحرير أو تحويل ملفات Slides OTP إلى PPTX باستخدام REST API وNode.js SDK مفتوح المصدر
family: slides
platformtag: nodejs
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل OTP إلى PPTX باستخدام Node.js" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من OTP إلى PPTX باستخدام Node.js" %}}
