---
title: دمج عدة ملفات PPS عبر Ruby
description: دمج عدة ملفات Slides PPS مع REST API وRuby SDK مفتوح المصدر
family: slides
platformtag: ruby
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPS مع Ruby" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPS مع Ruby" %}}
...
1. قم باستدعاء إحدى طرق الدمج، اعتمادًا على مكان إدخال ملفات PPS، والمكان الذي تريد تخزين الملف المدمج فيه، وما إذا كنت بحاجة إلى دمج أجزاء من الملفات
