---
title: دمج عدة ملفات PPTX عبر Ruby
description: دمج عدة ملفات Slides PPTX مع REST API وRuby SDK مفتوح المصدر
family: slides
platformtag: ruby
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPTX مع Ruby" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPTX مع Ruby" %}}
...
1. قم باستدعاء إحدى طرق الدمج، اعتمادًا على مكان إدخال ملفات PPTX، والمكان الذي تريد تخزين الملف المدمج فيه، وما إذا كنت بحاجة إلى دمج أجزاء من الملفات
