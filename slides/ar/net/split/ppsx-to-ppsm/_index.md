---
title: قم بتقسيم Slides PPSX إلى PPSM متعددة عبر .NET
description: قم بتقسيم ملفات Slides PPSX إلى شرائح PPSM باستخدام REST API و.NET SDK مفتوحة المصدر
family: slides
platformtag: net
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم PPSX إلى PPSM متعددة باستخدام .NET" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSX إلى PPSM انقسم باستخدام .NET" %}}
