---
title: قم بتقسيم Slides OTP إلى PPTM متعددة عبر .NET
description: قم بتقسيم ملفات Slides OTP إلى شرائح PPTM باستخدام REST API و.NET SDK مفتوحة المصدر
family: slides
platformtag: net
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم OTP إلى PPTM متعددة باستخدام .NET" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="OTP إلى PPTM انقسم باستخدام .NET" %}}
