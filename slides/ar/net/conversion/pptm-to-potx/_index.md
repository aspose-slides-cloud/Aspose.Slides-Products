---
title: التحويل من Slides PPTM إلى POTX عبر .NET
description: إنشاء أو تحرير أو تحويل ملفات Slides PPTM إلى POTX باستخدام REST API و.NET SDK مفتوح المصدر
family: slides
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPTM إلى POTX باستخدام .NET" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPTM إلى POTX باستخدام .NET" %}}
