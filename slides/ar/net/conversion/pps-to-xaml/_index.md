---
title: التحويل من Slides PPS إلى XAML عبر .NET
description: إنشاء أو تحرير أو تحويل ملفات Slides PPS إلى XAML باستخدام REST API و.NET SDK مفتوح المصدر
family: slides
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPS إلى XAML باستخدام .NET" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPS إلى XAML باستخدام .NET" %}}
