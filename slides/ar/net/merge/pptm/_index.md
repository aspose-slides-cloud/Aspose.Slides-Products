---
title: دمج عدة ملفات PPTM عبر .NET
description: دمج عدة ملفات Slides PPTM مع REST API و.NET SDK مفتوح المصدر
family: slides
platformtag: net
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPTM مع .NET" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPTM مع .NET" %}}
