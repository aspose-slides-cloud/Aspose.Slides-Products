---
title: دمج عدة ملفات POTX عبر .NET
description: دمج عدة ملفات Slides POTX مع REST API و.NET SDK مفتوح المصدر
family: slides
platformtag: net
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات POTX مع .NET" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات POTX مع .NET" %}}
