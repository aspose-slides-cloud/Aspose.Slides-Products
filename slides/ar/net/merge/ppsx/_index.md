---
title: دمج عدة ملفات PPSX عبر .NET
description: دمج عدة ملفات Slides PPSX مع REST API و.NET SDK مفتوح المصدر
family: slides
platformtag: net
feature: merge
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPSX مع .NET" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPSX مع .NET" %}}
