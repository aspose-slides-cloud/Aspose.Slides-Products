---
title: دمج عروض تقديمية متعددة عبر Swift
description: دمج العروض التقديمية المتعددة باستخدام REST API وSwift SDK مفتوح المصدر
family: slides
platformtag: swift
feature: merge
platform: Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عروض تقديمية متعددة مع Swift" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج العروض التقديمية مع Swift" %}}
...
1. قم باستدعاء إحدى طرق الدمج، اعتمادًا على مكان ملفات الإدخال الخاصة بك، والمكان الذي تريد تخزين الملف المدمج فيه، وما إذا كنت بحاجة إلى دمج أجزاء من الملفات
