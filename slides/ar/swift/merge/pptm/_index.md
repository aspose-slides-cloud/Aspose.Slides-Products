---
title: دمج عدة ملفات PPTM عبر Swift
description: دمج عدة ملفات Slides PPTM مع REST API وSwift SDK مفتوح المصدر
family: slides
platformtag: swift
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPTM مع Swift" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPTM مع Swift" %}}
...
1. قم باستدعاء إحدى طرق الدمج، اعتمادًا على مكان إدخال ملفات PPTM، والمكان الذي تريد تخزين الملف المدمج فيه، وما إذا كنت بحاجة إلى دمج أجزاء من الملفات
