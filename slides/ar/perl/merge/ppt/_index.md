---
title: دمج عدة ملفات PPT عبر Perl
description: دمج عدة ملفات Slides PPT مع REST API وPerl SDK مفتوح المصدر
family: slides
platformtag: perl
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPT مع Perl" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPT مع Perl" %}}
