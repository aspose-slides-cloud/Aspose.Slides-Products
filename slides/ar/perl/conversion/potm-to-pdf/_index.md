---
title: التحويل من Slides POTM إلى PDF عبر Perl
description: إنشاء أو تحرير أو تحويل ملفات Slides POTM إلى PDF باستخدام REST API وPerl SDK مفتوح المصدر
family: slides
platformtag: perl
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل POTM إلى PDF باستخدام Perl" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من POTM إلى PDF باستخدام Perl" %}}
