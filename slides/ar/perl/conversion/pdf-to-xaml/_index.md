---
title: التحويل من Slides PDF إلى XAML عبر Perl
description: إنشاء أو تحرير أو تحويل ملفات Slides PDF إلى XAML باستخدام REST API وPerl SDK مفتوح المصدر
family: slides
platformtag: perl
feature: conversion
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PDF إلى XAML باستخدام Perl" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PDF إلى XAML باستخدام Perl" %}}
