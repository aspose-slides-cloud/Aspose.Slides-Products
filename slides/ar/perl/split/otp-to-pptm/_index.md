---
title: قم بتقسيم Slides OTP إلى PPTM متعددة عبر Perl
description: قم بتقسيم ملفات Slides OTP إلى شرائح PPTM باستخدام REST API وPerl SDK مفتوحة المصدر
family: slides
platformtag: perl
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم OTP إلى PPTM متعددة باستخدام Perl" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="OTP إلى PPTM انقسم باستخدام Perl" %}}
