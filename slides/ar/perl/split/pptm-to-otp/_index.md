---
title: قم بتقسيم Slides PPTM إلى OTP متعددة عبر Perl
description: قم بتقسيم ملفات Slides PPTM إلى شرائح OTP باستخدام REST API وPerl SDK مفتوحة المصدر
family: slides
platformtag: perl
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم PPTM إلى OTP متعددة باستخدام Perl" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM إلى OTP انقسم باستخدام Perl" %}}
