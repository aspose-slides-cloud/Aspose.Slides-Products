---
title: استبدال النص في ملفات PPTM عبر Python
description: استبدل النص في ملفات Slides  بـ REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="استبدال النص في ملفات PPTM بـ Python" h2="البحث عن تكرارات النص واستبدالها في بيانات Slides باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="استبدال النص في ملفات PPTM بـ Python" %}}
