---
title: قم بتقسيم Slides POTX إلى XAML متعددة عبر Python
description: قم بتقسيم ملفات Slides POTX إلى شرائح XAML باستخدام REST API وPython SDK مفتوحة المصدر
family: slides
platformtag: python
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم POTX إلى XAML متعددة باستخدام Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX إلى XAML انقسم باستخدام Python" %}}
