---
title: قم بتقسيم Slides POTM إلى PNG متعددة عبر Python
description: قم بتقسيم ملفات Slides POTM إلى شرائح PNG باستخدام REST API وPython SDK مفتوحة المصدر
family: slides
platformtag: python
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم POTM إلى PNG متعددة باستخدام Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTM إلى PNG انقسم باستخدام Python" %}}
