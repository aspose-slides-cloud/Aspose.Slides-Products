---
title: قم بتقسيم Slides PPTM إلى OTP متعددة عبر Python
description: قم بتقسيم ملفات Slides PPTM إلى شرائح OTP باستخدام REST API وPython SDK مفتوحة المصدر
family: slides
platformtag: python
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم PPTM إلى OTP متعددة باستخدام Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM إلى OTP انقسم باستخدام Python" %}}
