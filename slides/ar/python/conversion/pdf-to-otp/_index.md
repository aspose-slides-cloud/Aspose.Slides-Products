---
title: التحويل من Slides PDF إلى OTP عبر Python
description: إنشاء أو تحرير أو تحويل ملفات Slides PDF إلى OTP باستخدام REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: conversion
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PDF إلى OTP باستخدام Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PDF إلى OTP باستخدام Python" %}}
