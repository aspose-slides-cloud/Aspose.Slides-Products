---
title: التحويل من Slides PPT إلى PPS عبر Python
description: إنشاء أو تحرير أو تحويل ملفات Slides PPT إلى PPS باستخدام REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPT إلى PPS باستخدام Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPT إلى PPS باستخدام Python" %}}
