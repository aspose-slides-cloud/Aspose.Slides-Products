---
title: التحويل من Slides PPSM إلى HTML عبر Python
description: إنشاء أو تحرير أو تحويل ملفات Slides PPSM إلى HTML باستخدام REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPSM إلى HTML باستخدام Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPSM إلى HTML باستخدام Python" %}}
