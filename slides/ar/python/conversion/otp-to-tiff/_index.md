---
title: التحويل من Slides OTP إلى TIFF عبر Python
description: إنشاء أو تحرير أو تحويل ملفات Slides OTP إلى TIFF باستخدام REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل OTP إلى TIFF باستخدام Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من OTP إلى TIFF باستخدام Python" %}}
