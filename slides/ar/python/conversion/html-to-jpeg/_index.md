---
title: التحويل من Slides HTML إلى JPEG عبر Python
description: إنشاء أو تحرير أو تحويل ملفات Slides HTML إلى JPEG باستخدام REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل HTML إلى JPEG باستخدام Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من HTML إلى JPEG باستخدام Python" %}}
