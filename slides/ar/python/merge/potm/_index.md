---
title: دمج عدة ملفات POTM عبر Python
description: دمج عدة ملفات Slides POTM مع REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات POTM مع Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات POTM مع Python" %}}
