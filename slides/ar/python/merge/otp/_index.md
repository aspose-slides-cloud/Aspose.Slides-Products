---
title: دمج عدة ملفات OTP عبر Python
description: دمج عدة ملفات Slides OTP مع REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات OTP مع Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات OTP مع Python" %}}
