---
title: دمج عروض تقديمية متعددة عبر Python
description: دمج العروض التقديمية المتعددة باستخدام REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: merge
platform: Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عروض تقديمية متعددة مع Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج العروض التقديمية مع Python" %}}
