---
title: دمج عدة ملفات ODP عبر Python
description: دمج عدة ملفات Slides ODP مع REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: merge
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات ODP مع Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات ODP مع Python" %}}
