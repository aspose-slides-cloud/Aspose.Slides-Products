---
title: دمج عدة ملفات HTML عبر Python
description: دمج عدة ملفات Slides HTML مع REST API وPython SDK مفتوح المصدر
family: slides
platformtag: python
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات HTML مع Python" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات HTML مع Python" %}}
