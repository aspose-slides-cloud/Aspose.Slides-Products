---
title: التحويل من Slides HTML إلى JPEG عبر PHP
description: إنشاء أو تحرير أو تحويل ملفات Slides HTML إلى JPEG باستخدام REST API وPHP SDK مفتوح المصدر
family: slides
platformtag: php
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل HTML إلى JPEG باستخدام PHP" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من HTML إلى JPEG باستخدام PHP" %}}
