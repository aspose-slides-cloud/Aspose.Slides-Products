---
title: التحويل من Slides PPSM إلى PNG عبر PHP
description: إنشاء أو تحرير أو تحويل ملفات Slides PPSM إلى PNG باستخدام REST API وPHP SDK مفتوح المصدر
family: slides
platformtag: php
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPSM إلى PNG باستخدام PHP" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPSM إلى PNG باستخدام PHP" %}}
