---
title: التحويل من Slides PDF إلى ODP عبر PHP
description: إنشاء أو تحرير أو تحويل ملفات Slides PDF إلى ODP باستخدام REST API وPHP SDK مفتوح المصدر
family: slides
platformtag: php
feature: conversion
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PDF إلى ODP باستخدام PHP" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PDF إلى ODP باستخدام PHP" %}}
