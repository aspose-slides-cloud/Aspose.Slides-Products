---
title: التحويل من Slides PPSX إلى POTX عبر PHP
description: إنشاء أو تحرير أو تحويل ملفات Slides PPSX إلى POTX باستخدام REST API وPHP SDK مفتوح المصدر
family: slides
platformtag: php
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPSX إلى POTX باستخدام PHP" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPSX إلى POTX باستخدام PHP" %}}
