---
title: قم ببناء عارض ومحول شرائح PPT PPTX عبر PHP REST SDK
description: قم بإحضار عروض PowerPoint وOpenOffice التقديمية من وحدة التخزين السحابية لعرض الشرائح ودمجها وتقسيمها وتحويلها في السحابة
weight: 100
family: slides
platform: PHP
---
...
{{< blocks/products/pf/i18n/upper-banner h1="PHP Cloud SDK لمعالجة شرائح العرض التقديمي" h2="قم بإحضار عروض PowerPoint وOpenOffice التقديمية من وحدة التخزين السحابية لعرض الشرائح ودمجها وتقسيمها وتحويلها في السحابة." logoImageSrc="/headers/aspose_slides-for-php.svg" pfName="Aspose.Slides" subTitlepfName="Cloud PHP SDK" downloadUrl="" >}}
...
<p>يساعدك Aspose.Slides Cloud SDK for PHP على إنشاء تطبيقات PHP مستندة إلى السحابة يمكنها إنشاء شرائح PPT وعروض PowerPoint التقديمية دون تثبيت أي برنامج. يدعم Aspose.Slides Cloud SDK لـ PHP أيضًا تنسيقات العرض التقديمي OpenOffice وODP وOTP. يعتمد Aspose.Slides Cloud SDK لـ PHP على Aspose.Slides REST API ويتم تقديمه بموجب ترخيص MIT.</p>
<p>باستخدام Aspose.Slides Cloud SDK لـ PHP، ستتمكن برامج PHP السحابية من إنشاء عروض تقديمية جديدة أو الوصول إلى العروض التقديمية الموجودة في وحدة التخزين السحابية. من خلال PHP REST SDK، يمكنك العمل مع العرض التقديمي بأكمله، وتعديل الشرائح الفردية، واستنساخ الشريحة الرئيسية، وتحديث التسلسل التفاعلي لعرض PowerPoint التقديمي، وتحديد الخطوط المخصصة لاستخدامها في العرض التقديمي.</p>
<p>يساعد Aspose.Slides Cloud SDK for PHP كود PHP الخاص بك على استخراج الأشكال والصور والملاحظات من شرائح العرض التقديمي. يمكنك أيضًا تحويل PPTX وPPT وODP وOTP إلى تنسيقات SWF وHTML وBMP وPNG وTIFF وJPEG وSVG.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP Slides Cloud"><header>Aspose.Slides</header><footer>PHP <small> <em>ل </em> </small>Cloud</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP SDK للعروض التقديمية"><header>Aspose.Slides</header><footer>PHP <small> <em>ل </em> </small>Cloud</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
      من السهل البدء باستخدام Aspose.Slides Cloud PHP SDK حيث لا تحتاج إلى أي شيء للتثبيت. ما عليك سوى إنشاء حساب على
      <a href="https://dashboard.aspose.cloud/#/apps">
       Aspose لCloud
      </a>
      والحصول على معلومات التطبيق الخاص بك. بمجرد حصولك على معرف SID ومفتاح التطبيق، تكون جاهزًا لتجربة Aspose.Slides Cloud PHP SDK على أي نظام أساسي.	
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="مصدر الرمز" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-PHP" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.Slides Cloud SDK لنظام PHP؟" tabId="success-stories" >}}
