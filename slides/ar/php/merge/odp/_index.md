---
title: دمج عدة ملفات ODP عبر PHP
description: دمج عدة ملفات Slides ODP مع REST API وPHP SDK مفتوح المصدر
family: slides
platformtag: php
feature: merge
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات ODP مع PHP" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات ODP مع PHP" %}}
