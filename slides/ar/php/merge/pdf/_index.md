---
title: دمج عدة ملفات PDF عبر PHP
description: دمج عدة ملفات Slides PDF مع REST API وPHP SDK مفتوح المصدر
family: slides
platformtag: php
feature: merge
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PDF مع PHP" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PDF مع PHP" %}}
