---
title: دمج عدة ملفات PPSM عبر PHP
description: دمج عدة ملفات Slides PPSM مع REST API وPHP SDK مفتوح المصدر
family: slides
platformtag: php
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPSM مع PHP" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPSM مع PHP" %}}
