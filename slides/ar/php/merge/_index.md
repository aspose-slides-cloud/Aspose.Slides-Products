---
title: دمج عروض تقديمية متعددة عبر PHP
description: دمج العروض التقديمية المتعددة باستخدام REST API وPHP SDK مفتوح المصدر
family: slides
platformtag: php
feature: merge
platform: PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عروض تقديمية متعددة مع PHP" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج العروض التقديمية مع PHP" %}}
