---
title: قم بتقسيم Slides PPSX إلى PPSM متعددة عبر PHP
description: قم بتقسيم ملفات Slides PPSX إلى شرائح PPSM باستخدام REST API وPHP SDK مفتوحة المصدر
family: slides
platformtag: php
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم PPSX إلى PPSM متعددة باستخدام PHP" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSX إلى PPSM انقسم باستخدام PHP" %}}
