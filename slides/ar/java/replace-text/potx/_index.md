---
title: استبدال النص في ملفات POTX عبر Java
description: استبدل النص في ملفات Slides  بـ REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="استبدال النص في ملفات POTX بـ Java" h2="البحث عن تكرارات النص واستبدالها في بيانات Slides باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="استبدال النص في ملفات POTX بـ Java" %}}
