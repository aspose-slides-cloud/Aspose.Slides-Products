---
title: دمج عدة ملفات PPS عبر Java
description: دمج عدة ملفات Slides PPS مع REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPS مع Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPS مع Java" %}}
