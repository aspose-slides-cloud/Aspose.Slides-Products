---
title: دمج عدة ملفات PPTM عبر Java
description: دمج عدة ملفات Slides PPTM مع REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPTM مع Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPTM مع Java" %}}
