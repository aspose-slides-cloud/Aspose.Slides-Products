---
title: دمج عروض تقديمية متعددة عبر Java
description: دمج العروض التقديمية المتعددة باستخدام REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: merge
platform: Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عروض تقديمية متعددة مع Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج العروض التقديمية مع Java" %}}
