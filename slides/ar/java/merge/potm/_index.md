---
title: دمج عدة ملفات POTM عبر Java
description: دمج عدة ملفات Slides POTM مع REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات POTM مع Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات POTM مع Java" %}}
