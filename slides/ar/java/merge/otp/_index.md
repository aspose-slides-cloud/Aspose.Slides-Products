---
title: دمج عدة ملفات OTP عبر Java
description: دمج عدة ملفات Slides OTP مع REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات OTP مع Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات OTP مع Java" %}}
