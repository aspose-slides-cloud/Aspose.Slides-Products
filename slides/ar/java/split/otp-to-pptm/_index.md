---
title: قم بتقسيم Slides OTP إلى PPTM متعددة عبر Java
description: قم بتقسيم ملفات Slides OTP إلى شرائح PPTM باستخدام REST API وJava SDK مفتوحة المصدر
family: slides
platformtag: java
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم OTP إلى PPTM متعددة باستخدام Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="OTP إلى PPTM انقسم باستخدام Java" %}}
