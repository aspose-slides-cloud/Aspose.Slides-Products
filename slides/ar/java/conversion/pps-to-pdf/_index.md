---
title: التحويل من Slides PPS إلى PDF عبر Java
description: إنشاء أو تحرير أو تحويل ملفات Slides PPS إلى PDF باستخدام REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: conversion
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPS إلى PDF باستخدام Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPS إلى PDF باستخدام Java" %}}
