---
title: التحويل من Slides POTX إلى BMP عبر Java
description: إنشاء أو تحرير أو تحويل ملفات Slides POTX إلى BMP باستخدام REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل POTX إلى BMP باستخدام Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من POTX إلى BMP باستخدام Java" %}}
