---
title: التحويل من Slides POTM إلى BMP عبر Java
description: إنشاء أو تحرير أو تحويل ملفات Slides POTM إلى BMP باستخدام REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل POTM إلى BMP باستخدام Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من POTM إلى BMP باستخدام Java" %}}
