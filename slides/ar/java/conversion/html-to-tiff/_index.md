---
title: التحويل من Slides HTML إلى TIFF عبر Java
description: إنشاء أو تحرير أو تحويل ملفات Slides HTML إلى TIFF باستخدام REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل HTML إلى TIFF باستخدام Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من HTML إلى TIFF باستخدام Java" %}}
