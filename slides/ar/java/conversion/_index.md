---
title: تحويل العروض التقديمية عبر Java
description: قم بإنشاء أو تحرير أو تحويل ملفات Slides باستخدام REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: conversion
platform: Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل العروض التقديمية باستخدام Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل العرض التقديمي باستخدام Java" %}}
