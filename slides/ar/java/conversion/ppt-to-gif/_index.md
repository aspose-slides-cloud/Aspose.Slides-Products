---
title: التحويل من Slides PPT إلى GIF عبر Java
description: إنشاء أو تحرير أو تحويل ملفات Slides PPT إلى GIF باستخدام REST API وJava SDK مفتوح المصدر
family: slides
platformtag: java
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPT إلى GIF باستخدام Java" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPT إلى GIF باستخدام Java" %}}
