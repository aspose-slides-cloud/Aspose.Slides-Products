---
title: دمج عدة ملفات PPS عبر C++
description: دمج عدة ملفات Slides PPS مع REST API وC++ SDK مفتوح المصدر
family: slides
platformtag: cpp
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PPS مع C++" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PPS مع C++" %}}
