---
title: التحويل من Slides PPTX إلى HTML عبر C++
description: إنشاء أو تحرير أو تحويل ملفات Slides PPTX إلى HTML باستخدام REST API وC++ SDK مفتوح المصدر
family: slides
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPTX إلى HTML باستخدام C++" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPTX إلى HTML باستخدام C++" %}}
