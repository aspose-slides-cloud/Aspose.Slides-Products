---
title: تحويل العروض التقديمية عبر C++
description: قم بإنشاء أو تحرير أو تحويل ملفات Slides باستخدام REST API وC++ SDK مفتوح المصدر
family: slides
platformtag: cpp
feature: conversion
platform: C++
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل العروض التقديمية باستخدام C++" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل العرض التقديمي باستخدام C++" %}}
