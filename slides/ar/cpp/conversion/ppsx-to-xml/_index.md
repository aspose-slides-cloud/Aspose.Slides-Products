---
title: التحويل من Slides PPSX إلى XML عبر C++
description: إنشاء أو تحرير أو تحويل ملفات Slides PPSX إلى XML باستخدام REST API وC++ SDK مفتوح المصدر
family: slides
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPSX إلى XML باستخدام C++" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPSX إلى XML باستخدام C++" %}}
