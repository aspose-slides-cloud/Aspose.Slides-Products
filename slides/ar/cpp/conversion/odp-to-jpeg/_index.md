---
title: التحويل من Slides ODP إلى JPEG عبر C++
description: إنشاء أو تحرير أو تحويل ملفات Slides ODP إلى JPEG باستخدام REST API وC++ SDK مفتوح المصدر
family: slides
platformtag: cpp
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل ODP إلى JPEG باستخدام C++" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من ODP إلى JPEG باستخدام C++" %}}
