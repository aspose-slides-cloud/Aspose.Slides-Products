---
title: التحويل من Slides PPSM إلى XPS عبر Android
description: إنشاء أو تحرير أو تحويل ملفات Slides PPSM إلى XPS باستخدام REST API وAndroid SDK مفتوح المصدر
family: slides
platformtag: android
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPSM إلى XPS باستخدام Android" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPSM إلى XPS باستخدام Android" %}}
