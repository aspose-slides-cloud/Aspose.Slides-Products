---
title: تحويل العروض التقديمية عبر Android
description: قم بإنشاء أو تحرير أو تحويل ملفات Slides باستخدام REST API وAndroid SDK مفتوح المصدر
family: slides
platformtag: android
feature: conversion
platform: Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل العروض التقديمية باستخدام Android" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل العرض التقديمي باستخدام Android" %}}
