---
title: التحويل من Slides ODP إلى HTML عبر Android
description: إنشاء أو تحرير أو تحويل ملفات Slides ODP إلى HTML باستخدام REST API وAndroid SDK مفتوح المصدر
family: slides
platformtag: android
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل ODP إلى HTML باستخدام Android" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من ODP إلى HTML باستخدام Android" %}}
