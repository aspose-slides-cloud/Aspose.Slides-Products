---
title: دمج عدة ملفات PDF عبر Android
description: دمج عدة ملفات Slides PDF مع REST API وAndroid SDK مفتوح المصدر
family: slides
platformtag: android
feature: merge
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات PDF مع Android" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات PDF مع Android" %}}
