---
title: قم بتقسيم Slides POTX إلى XAML متعددة عبر Android
description: قم بتقسيم ملفات Slides POTX إلى شرائح XAML باستخدام REST API وAndroid SDK مفتوحة المصدر
family: slides
platformtag: android
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم POTX إلى XAML متعددة باستخدام Android" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX إلى XAML انقسم باستخدام Android" %}}
