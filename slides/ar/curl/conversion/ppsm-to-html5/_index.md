---
title: التحويل من Slides PPSM إلى HTML5 عبر cURL
description: إنشاء أو تحرير أو تحويل ملفات Slides PPSM إلى HTML5 باستخدام REST API وcURL SDK مفتوح المصدر
family: slides
platformtag: curl
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPSM إلى HTML5 باستخدام cURL" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPSM إلى HTML5 باستخدام cURL" %}}
