---
title: التحويل من Slides PPSX إلى HTML عبر cURL
description: إنشاء أو تحرير أو تحويل ملفات Slides PPSX إلى HTML باستخدام REST API وcURL SDK مفتوح المصدر
family: slides
platformtag: curl
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPSX إلى HTML باستخدام cURL" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPSX إلى HTML باستخدام cURL" %}}
