---
title: دمج عدة ملفات POTM عبر cURL
description: دمج عدة ملفات Slides POTM مع REST API وcURL SDK مفتوح المصدر
family: slides
platformtag: curl
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عدة ملفات POTM مع cURL" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج ملفات POTM مع cURL" %}}
