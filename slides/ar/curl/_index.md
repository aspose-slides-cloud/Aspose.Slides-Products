---
title: إنشاء شرائح PowerPoint ودمجها وتقسيمها وتحويلها عبر cURL
description: تنفيذ إنشاء شرائح العرض التقديمي لـ PowerPoint وOpenOffice ومعالجتها ودمجها وتحويلها من خلال أوامر cURL البسيطة عبر REST API
weight: 40
family: slides
platform: cURL
---
...
{{< blocks/products/pf/i18n/upper-banner h1="أنشئ تطبيقات صانع ومحول العروض التقديمية لـ PPT عبر cURL" h2="قم بإجراء إنشاء شرائح العرض التقديمي لـ PowerPoint وOpenOffice ومعالجتها ودمجها وتحويلها عن طريق أوامر cURL البسيطة عبر REST API." logoImageSrc="/headers/aspose_slides-for-curl.svg" pfName="Aspose.Slides" subTitlepfName="سحابة لcURL" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="سحابة لcURL" >}}
...
<p>يتيح لك Aspose.Slides Cloud for cURL تحويل عروض PowerPoint وOpenOffice التقديمية والشرائح إلى تنسيقات أخرى مدعومة. على سبيل المثال، يمكنك تحويل PPT إلى PDF وBMP وPNG وSVG وTIFF وJPEG وSWF وHTML. يمكنك إجراء عمليات متنوعة على شرائح العرض التقديمي وموضوعات العرض التقديمي وملاحظات الشرائح وصور الشرائح والشرائح الرئيسية والخطوط المخصصة والعديد من الخصائص الأخرى لمستندات العرض التقديمي لـ Microsoft PowerPoint وOpenOffice.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="cURL Slides Cloud"><header>Aspose.Slides</header><footer>cURL <small> <em>ل </em> </small>Cloud</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="cURL Cloud للعروض التقديمية"><header>Aspose.Slides</header><footer>cURL <small> <em>ل </em> </small>Cloud</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
      من السهل البدء باستخدام Aspose.Slides Cloud for cURL حيث لا تحتاج إلى أي شيء للتثبيت. ما عليك سوى إنشاء حساب على
      <a href="https://dashboard.aspose.cloud/#/apps">
       Aspose لCloud
      </a>
      والحصول على معلومات التطبيق الخاص بك. بمجرد حصولك على معرف SID ومفتاح التطبيق، تكون جاهزًا لتجربة Aspose.Slides Cloud for cURL على أي نظام أساسي.	
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     يتيح Aspose.Slides Cloud for cURL للمطورين إجراء عمليات معالجة شرائح العرض التقديمي الأساسية والمتقدمة. يمكنك قراءة معلومات شرائح العرض التقديمي. إنشاء شرائح جديدة. نسخ أو تعديل أو حذف الشرائح الموجودة. قم بتحويل شرائح العرض التقديمي من تنسيقات PowerPoint إلى التنسيقات المدعومة الأخرى عبر Cloud SDK. يمكنك أيضًا التعامل مع خلفية الشريحة عن طريق تطبيق خلفية جديدة وقراءة وإزالة الخلفية الموجودة لأي شريحة. يمكّنك Aspose.Slides Cloud for cURL من إعادة ترتيب موضع الشريحة داخل العرض التقديمي. يمكنك أيضًا نسخ شريحة من عرض تقديمي حالي أو عرض تقديمي آخر. يمكن أيضًا استرداد تعليقات شرائح العرض التقديمي.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     يتيح Aspose.Slides Cloud for cURL للمطورين إنشاء أشكال جديدة لشرائح العرض التقديمي. يمكنك قراءة وتحديث معلومات الخصائص لأشكال الشرائح الموجودة. كما أنه يمكّنك من تقديم أشكال الشرائح إلى تنسيقات الصور المدعومة. يساعدك Aspose.Slides Cloud for cURL أيضًا على العمل مع ملاحظات شرائح العرض التقديمي.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="لماذا Aspose.Slides Cloud لـ cURL؟" tabId="success-stories" >}}
