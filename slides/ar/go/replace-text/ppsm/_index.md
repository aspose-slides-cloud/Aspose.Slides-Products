---
title: استبدال النص في ملفات PPSM عبر Go
description: استبدل النص في ملفات Slides  بـ REST API وGo SDK مفتوح المصدر
family: slides
platformtag: go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="استبدال النص في ملفات PPSM بـ Go" h2="البحث عن تكرارات النص واستبدالها في بيانات Slides باستخدام Cloud SDK مفتوح المصدر لـ Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="استبدال النص في ملفات PPSM بـ Go" %}}
