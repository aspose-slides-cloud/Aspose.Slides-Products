---
title: دمج عروض تقديمية متعددة عبر Go
description: دمج العروض التقديمية المتعددة باستخدام REST API وGo SDK مفتوح المصدر
family: slides
platformtag: go
feature: merge
platform: Go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="دمج عروض تقديمية متعددة مع Go" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="دمج العروض التقديمية مع Go" %}}
