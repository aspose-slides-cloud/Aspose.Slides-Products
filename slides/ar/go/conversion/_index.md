---
title: تحويل العروض التقديمية عبر Go
description: قم بإنشاء أو تحرير أو تحويل ملفات Slides باستخدام REST API وGo SDK مفتوح المصدر
family: slides
platformtag: go
feature: conversion
platform: Go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل العروض التقديمية باستخدام Go" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تحويل العرض التقديمي باستخدام Go" %}}
