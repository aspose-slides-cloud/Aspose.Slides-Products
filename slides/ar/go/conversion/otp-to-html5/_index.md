---
title: التحويل من Slides OTP إلى HTML5 عبر Go
description: إنشاء أو تحرير أو تحويل ملفات Slides OTP إلى HTML5 باستخدام REST API وGo SDK مفتوح المصدر
family: slides
platformtag: go
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل OTP إلى HTML5 باستخدام Go" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من OTP إلى HTML5 باستخدام Go" %}}
