---
title: التحويل من Slides PPT إلى MPEG4 عبر Go
description: إنشاء أو تحرير أو تحويل ملفات Slides PPT إلى MPEG4 باستخدام REST API وGo SDK مفتوح المصدر
family: slides
platformtag: go
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PPT إلى MPEG4 باستخدام Go" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="التحويل من PPT إلى MPEG4 باستخدام Go" %}}
