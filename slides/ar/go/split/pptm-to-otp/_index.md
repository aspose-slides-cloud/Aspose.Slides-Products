---
title: قم بتقسيم Slides PPTM إلى OTP متعددة عبر Go
description: قم بتقسيم ملفات Slides PPTM إلى شرائح OTP باستخدام REST API وGo SDK مفتوحة المصدر
family: slides
platformtag: go
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="قم بتقسيم PPTM إلى OTP متعددة باستخدام Go" h2="قراءة بيانات Slides وتحريرها وتصديرها إلى تنسيقات أخرى باستخدام Cloud SDK مفتوح المصدر لـ Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM إلى OTP انقسم باستخدام Go" %}}
