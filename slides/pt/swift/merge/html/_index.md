---
title: Mesclar vários arquivos HTML via Swift
description: Mescle vários arquivos Slides HTML com REST API e Open Source Swift SDK
family: slides
platformtag: swift
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos HTML com Swift" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Swift de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos HTML com Swift" %}}
...
1. Chame um dos métodos de mesclagem, dependendo de onde estão seus arquivos HTML de entrada, onde deseja armazenar o arquivo mesclado e se precisa mesclar partes de arquivos
