---
title: Mesclar vários arquivos POTM via Swift
description: Mescle vários arquivos Slides POTM com REST API e Open Source Swift SDK
family: slides
platformtag: swift
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos POTM com Swift" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Swift de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos POTM com Swift" %}}
