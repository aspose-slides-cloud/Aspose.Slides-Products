---
title: Converter de Slides OTP para SWF via Swift
description: Crie, edite ou converta arquivos Slides OTP em SWF com REST API e Open Source Swift SDK
family: slides
platformtag: swift
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter OTP para SWF com Swift" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Swift de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de OTP para SWF com Swift" %}}
