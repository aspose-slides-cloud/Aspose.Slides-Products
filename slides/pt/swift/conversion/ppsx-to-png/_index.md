---
title: Converter de Slides PPSX para PNG via Swift
description: Crie, edite ou converta arquivos Slides PPSX em PNG com REST API e Open Source Swift SDK
family: slides
platformtag: swift
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PPSX para PNG com Swift" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Swift de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de PPSX para PNG com Swift" %}}
