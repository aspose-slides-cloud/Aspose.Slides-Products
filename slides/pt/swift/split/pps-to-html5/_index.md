---
title: Dividir Slides PPS em vários HTML5 via Swift
description: Divida arquivos Slides PPS em slides HTML5 com REST API e Open Source Swift SDK
family: slides
platformtag: swift
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPS em vários HTML5 com Swift" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Swift de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPS em HTML5 dividido com Swift" %}}
