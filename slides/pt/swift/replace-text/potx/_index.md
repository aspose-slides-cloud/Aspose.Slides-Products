---
title: Substitua texto em arquivos POTX via Swift
description: Substitua o texto nos arquivos Slides POTX pela API REST e Swift SDK de código aberto
family: slides
platformtag: swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos POTX por Swift" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos POTX por Swift" %}}
