---
title: Dividir Slides ODP em vários PPTM via Java
description: Divida arquivos Slides ODP em slides PPTM com REST API e Open Source Java SDK
family: slides
platformtag: java
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir ODP em vários PPTM com Java" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Java de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODP em PPTM dividido com Java" %}}
