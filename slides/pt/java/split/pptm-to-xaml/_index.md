---
title: Dividir Slides PPTM em vários XAML via Java
description: Divida arquivos Slides PPTM em slides XAML com REST API e Open Source Java SDK
family: slides
platformtag: java
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPTM em vários XAML com Java" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Java de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM em XAML dividido com Java" %}}
