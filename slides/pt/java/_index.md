---
title: Crie um visualizador e conversor de PPT baseado em nuvem via Java SDK
description: Desenvolva aplicativos Java baseados em nuvem para acessar apresentações em PowerPoint e OpenOffice armazenadas na nuvem para visualização, processamento e conversão
weight: 60
family: slides
platform: Java
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Java REST API para processar apresentações PPT" h2="Desenvolva aplicativos Java baseados em nuvem para acessar apresentações em PowerPoint e OpenOffice armazenadas na nuvem para visualização, processamento e conversão." logoImageSrc="/headers/aspose_slides-for-java.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK para Java" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud SDK para Java ajuda os programadores a criar soluções baseadas em nuvem para criar, visualizar, processar e converter apresentações do PowerPoint e do OpenOffice na nuvem. Aspose.Slides Cloud SDK para Java funciona como uma interface para a API REST subjacente do Aspose.Slides e é oferecido sob uma licença MIT.</p>
<p>Usando o Aspose.Slides Cloud SDK para Java, você pode criar rapidamente aplicativos de criador de apresentação, visualizador de slides e conversor de apresentação baseados em nuvem em Java. Você pode trabalhar com slide mestre, tema de apresentação, notas de slide e fontes personalizadas.</p>
<p>Aspose.Slides Cloud SDK para Java também permite que seu código java processe imagens, formas e animações em slides do PowerPoint. Usando nosso Java Cloud SDK, você pode converter formatos de arquivo PPT, PPTX, ODP e OTP para PDF, XPS, SVG, BMP, TIFF, JPEG, PNG, HTML e SWF.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-java.png" alt="Java PowerPoint Cloud SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Java</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-java.png" alt="Java Cloud SDK para apresentações"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Java</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     É fácil começar a usar o Aspose.Slides Cloud SDK para Java, pois você não precisa instalar nada. Basta criar uma conta no
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose para Cloud
     </a>
	 e obter as informações do seu aplicativo. Assim que tiver o SID e a chave do aplicativo, você estará pronto para experimentar o Aspose.Slides Cloud SDK para Java em qualquer plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Código fonte" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Slides Cloud SDK para Java?" tabId="success-stories" >}}
