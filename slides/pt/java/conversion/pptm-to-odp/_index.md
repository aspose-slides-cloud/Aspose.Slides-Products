---
title: Converter de Slides PPTM para ODP via Java
description: Crie, edite ou converta arquivos Slides PPTM em ODP com REST API e Open Source Java SDK
family: slides
platformtag: java
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PPTM para ODP com Java" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Java de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de PPTM para ODP com Java" %}}
