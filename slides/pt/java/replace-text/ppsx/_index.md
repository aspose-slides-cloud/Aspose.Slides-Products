---
title: Substitua texto em arquivos PPSX via Java
description: Substitua o texto nos arquivos Slides PPSX pela API REST e Java SDK de código aberto
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos PPSX por Java" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos PPSX por Java" %}}
