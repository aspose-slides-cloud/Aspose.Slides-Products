---
title: Substitua texto em apresentações via Java
description: Substitua o texto nos arquivos Slides pela API REST e Java SDK de código aberto
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substitua o texto nas apresentações por Java" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em apresentações por Java" %}}
