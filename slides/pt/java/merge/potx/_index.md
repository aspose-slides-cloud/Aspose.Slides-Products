---
title: Mesclar vários arquivos POTX via Java
description: Mescle vários arquivos Slides POTX com REST API e Open Source Java SDK
family: slides
platformtag: java
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos POTX com Java" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Java de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos POTX com Java" %}}
