---
title: Mesclar vários arquivos PPT via Android
description: Mescle vários arquivos Slides PPT com REST API e Open Source Android SDK
family: slides
platformtag: android
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos PPT com Android" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Android de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos PPT com Android" %}}
...
1. Chame um dos métodos de mesclagem, dependendo de onde estão seus arquivos PPT de entrada, onde deseja armazenar o arquivo mesclado e se precisa mesclar partes de arquivos
