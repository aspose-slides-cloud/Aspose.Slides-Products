---
title: Mesclar vários arquivos OTP via Android
description: Mescle vários arquivos Slides OTP com REST API e Open Source Android SDK
family: slides
platformtag: android
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos OTP com Android" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Android de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos OTP com Android" %}}
...
1. Chame um dos métodos de mesclagem, dependendo de onde estão seus arquivos OTP de entrada, onde deseja armazenar o arquivo mesclado e se precisa mesclar partes de arquivos
