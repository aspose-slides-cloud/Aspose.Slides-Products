---
title: Converter de Slides PPT para SVG via Android
description: Crie, edite ou converta arquivos Slides PPT em SVG com REST API e Open Source Android SDK
family: slides
platformtag: android
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PPT para SVG com Android" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Android de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de PPT para SVG com Android" %}}
