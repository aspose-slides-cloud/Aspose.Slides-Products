---
title: Converter apresentações via Android
description: Crie, edite ou converta arquivos Slides com REST API e Open Source Android SDK
family: slides
platformtag: android
feature: conversion
platform: Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter apresentações com Android" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Android de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de apresentação com Android" %}}
...
1. Chame um dos métodos de conversão, dependendo de onde está seu arquivo de entrada e onde você deseja armazenar o arquivo resultante
