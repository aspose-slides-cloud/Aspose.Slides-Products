---
title: Dividir Slides PPSM em vários PNG via Android
description: Divida arquivos Slides PPSM em slides PNG com REST API e Open Source Android SDK
family: slides
platformtag: android
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPSM em vários PNG com Android" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Android de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSM em PNG dividido com Android" %}}
