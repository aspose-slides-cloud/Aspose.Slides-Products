---
title: Substitua texto em arquivos PPSM via Android
description: Substitua o texto nos arquivos Slides PPSM pela API REST e Android SDK de código aberto
family: slides
platformtag: android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos PPSM por Android" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos PPSM por Android" %}}
...
1. Chame um dos métodos de substituição de texto, dependendo de onde estão seus arquivos PPSM e se você precisa substituir o texto em todo o documento ou em um único slide
