---
title: Substitua texto em arquivos ODP via Android
description: Substitua o texto nos arquivos Slides ODP pela API REST e Android SDK de código aberto
family: slides
platformtag: android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos ODP por Android" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos ODP por Android" %}}
