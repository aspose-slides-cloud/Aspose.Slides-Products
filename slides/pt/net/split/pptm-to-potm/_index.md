---
title: Dividir Slides PPTM em vários POTM via .NET
description: Divida arquivos Slides PPTM em slides POTM com REST API e Open Source .NET SDK
family: slides
platformtag: net
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPTM em vários POTM com .NET" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para .NET de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM em POTM dividido com .NET" %}}
