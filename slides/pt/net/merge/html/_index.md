---
title: Mesclar vários arquivos HTML via .NET
description: Mescle vários arquivos Slides HTML com REST API e Open Source .NET SDK
family: slides
platformtag: net
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos HTML com .NET" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para .NET de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos HTML com .NET" %}}
