---
title: Crie um criador e visualizador de apresentações com C# REST SDK
description: C# Cloud SDK para ajudá-lo a criar e processar apresentações em PowerPoint e OpenOffice na nuvem, sem instalar nenhum software
weight: 70
family: slides
platform: .NET
---
...
{{< blocks/products/pf/i18n/upper-banner h1="C# SDK para visualizar, processar e converter slides na nuvem" h2="C# Cloud SDK para ajudá-lo a criar e processar apresentações em PowerPoint e OpenOffice na nuvem, sem instalar nenhum software." logoImageSrc="/headers/aspose_slides-for-net.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK para .NET" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud SDK para .NET aprimora seu código C# para criar apresentações em PowerPoint, mesclar slides selecionados, dividir apresentações, bem como converter documentos de apresentação em PowerPoint e OpenOffice para PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, HTML e SWF.</p>
<p>Aspose.Slides Cloud SDK para .NET também permite que seu aplicativo .NET baseado em nuvem trabalhe com animações de slides de apresentação, leia e clone informações de slides mestres, extraia e baixe notas de slides, extraia imagens de apresentação para um formato específico, extraia formas de um slide , além de executar várias outras operações usando seus programas C# por meio de nosso Aspose.Slides Cloud SDK para .NET.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt=".NET PowerPoint Cloud SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt=".NET Cloud SDK para apresentações"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     É fácil começar a usar o Aspose.Slides Cloud SDK para .NET, pois você não precisa instalar nada. Basta criar uma conta no
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose para Cloud
     </a>
	 e obter as informações do seu aplicativo. Assim que tiver o SID e a chave do aplicativo, você estará pronto para experimentar o Aspose.Slides Cloud SDK para .NET em qualquer plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Slides Cloud SDK para .NET?" tabId="success-stories" >}}
