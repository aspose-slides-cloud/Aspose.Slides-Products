---
title: Dividir Slides ODP em vários GIF via C++
description: Divida arquivos Slides ODP em slides GIF com REST API e Open Source C++ SDK
family: slides
platformtag: cpp
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir ODP em vários GIF com C++" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para C++ de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODP em GIF dividido com C++" %}}
