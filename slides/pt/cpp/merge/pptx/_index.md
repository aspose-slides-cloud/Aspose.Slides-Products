---
title: Mesclar vários arquivos PPTX via C++
description: Mescle vários arquivos Slides PPTX com REST API e Open Source C++ SDK
family: slides
platformtag: cpp
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos PPTX com C++" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para C++ de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos PPTX com C++" %}}
