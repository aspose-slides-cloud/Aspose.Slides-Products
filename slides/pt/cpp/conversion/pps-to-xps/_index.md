---
title: Converter de Slides PPS para XPS via C++
description: Crie, edite ou converta arquivos Slides PPS em XPS com REST API e Open Source C++ SDK
family: slides
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PPS para XPS com C++" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para C++ de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de PPS para XPS com C++" %}}
