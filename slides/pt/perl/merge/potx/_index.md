---
title: Mesclar vários arquivos POTX via Perl
description: Mescle vários arquivos Slides POTX com REST API e Open Source Perl SDK
family: slides
platformtag: perl
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos POTX com Perl" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Perl de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos POTX com Perl" %}}
