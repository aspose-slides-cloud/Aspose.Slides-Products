---
title: Converter de Slides PPTM para SVG via Perl
description: Crie, edite ou converta arquivos Slides PPTM em SVG com REST API e Open Source Perl SDK
family: slides
platformtag: perl
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PPTM para SVG com Perl" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Perl de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de PPTM para SVG com Perl" %}}
