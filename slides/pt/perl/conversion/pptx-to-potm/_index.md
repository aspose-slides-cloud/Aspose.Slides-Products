---
title: Converter de Slides PPTX para POTM via Perl
description: Crie, edite ou converta arquivos Slides PPTX em POTM com REST API e Open Source Perl SDK
family: slides
platformtag: perl
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PPTX para POTM com Perl" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Perl de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de PPTX para POTM com Perl" %}}
