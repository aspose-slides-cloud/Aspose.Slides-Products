---
title: Substitua texto em arquivos PPSM via Perl
description: Substitua o texto nos arquivos Slides PPSM pela API REST e Perl SDK de código aberto
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos PPSM por Perl" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos PPSM por Perl" %}}
