---
title: Dividir Slides POTM em vários PPS via Perl
description: Divida arquivos Slides POTM em slides PPS com REST API e Open Source Perl SDK
family: slides
platformtag: perl
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir POTM em vários PPS com Perl" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Perl de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTM em PPS dividido com Perl" %}}
