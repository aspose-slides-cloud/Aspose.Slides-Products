---
title: Substitua texto em arquivos PPTM via Python
description: Substitua o texto nos arquivos Slides PPTM pela API REST e Python SDK de código aberto
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos PPTM por Python" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos PPTM por Python" %}}
...
1. Chame um dos métodos de substituição de texto, dependendo de onde estão seus arquivos PPTM e se você precisa substituir o texto em todo o documento ou em um único slide
