---
title: Substitua texto em apresentações via Python
description: Substitua o texto nos arquivos Slides pela API REST e Python SDK de código aberto
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substitua o texto nas apresentações por Python" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em apresentações por Python" %}}
