---
title: Dividir Slides PPSX em vários ODP via Python
description: Divida arquivos Slides PPSX em slides ODP com REST API e Open Source Python SDK
family: slides
platformtag: python
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPSX em vários ODP com Python" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Python de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSX em ODP dividido com Python" %}}
