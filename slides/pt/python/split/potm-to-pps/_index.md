---
title: Dividir Slides POTM em vários PPS via Python
description: Divida arquivos Slides POTM em slides PPS com REST API e Open Source Python SDK
family: slides
platformtag: python
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir POTM em vários PPS com Python" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Python de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTM em PPS dividido com Python" %}}
