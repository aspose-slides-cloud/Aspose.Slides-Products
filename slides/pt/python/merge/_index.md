...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar várias apresentações via Python" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Python de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando apresentações com Python" %}}
