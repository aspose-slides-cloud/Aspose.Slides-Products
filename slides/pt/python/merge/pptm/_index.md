---
title: Mesclar vários arquivos PPTM via Python
description: Mescle vários arquivos Slides PPTM com REST API e Open Source Python SDK
family: slides
platformtag: python
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos PPTM com Python" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Python de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos PPTM com Python" %}}
...
1. Chame um dos métodos de mesclagem, dependendo de onde estão seus arquivos PPTM de entrada, onde deseja armazenar o arquivo mesclado e se precisa mesclar partes de arquivos
