---
title: SDK do construtor de apresentações Node.js para nuvem | APIs RESTful
description: Fácil de integrar e fácil de usar API REST Node.js para criar, copiar, mesclar, dividir, baixar e converter slides do PowerPoint e OpenOffice na nuvem
weight: 80
family: slides
platform: Node.js
---
...
{{< blocks/products/pf/i18n/upper-banner h1="SDK REST Node.js para processar slides na nuvem" h2="Perfeita para integrar e fácil de usar a API REST do Node.js para criar, copiar, mesclar, dividir, baixar e converter slides do PowerPoint e OpenOffice na nuvem." logoImageSrc="/headers/aspose_slides-for-node.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK para Node.js" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud SDK para Node.js ajuda seus aplicativos baseados em nuvem Node.js a acessar apresentações PowerPoint e OpenOffice hospedadas no armazenamento em nuvem para processar e converter de PPT, PPTX, ODP, OTP para SWF, HTML, PDF, XPS, PDF/A, JPEG, SVG, TIFF, BMP e PNG.</p>
<p>Aspose.Slides Cloud SDK para Node.js permite que seu código Node.js divida apresentações do PowerPoint, mescle slides de apresentação, bem como copie, mova ou exclua slides. Use comandos Node.js simples para obter fonte, formato e esquema de cores de apresentações localizadas na nuvem. Leia as informações do slide mestre e clone-as. Atualize a sequência principal de animações de slides. Extraia formas, notas e imagens de slides de apresentação.</p>
<p>Aspose.Slides Cloud SDK para Node.js é um wrapper em torno da Aspose.Slides REST API e este SDK de nuvem de manipulação de apresentação do PowerPoint está disponível sob a licença MIT.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-node.png" alt="Node.js PowerPoint Cloud SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-node.png" alt="Node.js Cloud SDK para apresentações"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     É fácil começar a usar o Aspose.Slides Cloud SDK para Node.js, pois você não precisa instalar nada. Basta criar uma conta no
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose para Cloud
     </a>
	 e obter as informações do seu aplicativo. Assim que tiver o SID e a chave do aplicativo, você estará pronto para experimentar o Aspose.Slides Cloud SDK para Node.js em qualquer plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Código fonte" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Node.js" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Slides Cloud SDK para Node.js?" tabId="success-stories" >}}
