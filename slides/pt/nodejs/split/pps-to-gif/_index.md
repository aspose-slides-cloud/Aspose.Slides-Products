---
title: Dividir Slides PPS em vários GIF via Node.js
description: Divida arquivos Slides PPS em slides GIF com REST API e Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPS em vários GIF com Node.js" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Node.js de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPS em GIF dividido com Node.js" %}}
