---
title: Substitua texto em arquivos POTM via Node.js
description: Substitua o texto nos arquivos Slides POTM pela API REST e Node.js SDK de código aberto
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos POTM por Node.js" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos POTM por Node.js" %}}
