---
title: Substitua texto em arquivos PPSX via Node.js
description: Substitua o texto nos arquivos Slides PPSX pela API REST e Node.js SDK de código aberto
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos PPSX por Node.js" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos PPSX por Node.js" %}}
...
1. Chame um dos métodos de substituição de texto, dependendo de onde estão seus arquivos PPSX e se você precisa substituir o texto em todo o documento ou em um único slide
