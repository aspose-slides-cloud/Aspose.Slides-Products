---
title: Mesclar vários arquivos PPTX via Node.js
description: Mescle vários arquivos Slides PPTX com REST API e Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos PPTX com Node.js" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Node.js de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos PPTX com Node.js" %}}
