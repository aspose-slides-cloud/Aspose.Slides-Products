---
title: Mesclar vários arquivos POTX via Node.js
description: Mescle vários arquivos Slides POTX com REST API e Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos POTX com Node.js" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Node.js de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos POTX com Node.js" %}}
...
1. Chame um dos métodos de mesclagem, dependendo de onde estão seus arquivos POTX de entrada, onde deseja armazenar o arquivo mesclado e se precisa mesclar partes de arquivos
