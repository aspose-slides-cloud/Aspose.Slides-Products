---
title: Mesclar vários arquivos PPSM via Node.js
description: Mescle vários arquivos Slides PPSM com REST API e Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos PPSM com Node.js" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Node.js de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos PPSM com Node.js" %}}
...
1. Chame um dos métodos de mesclagem, dependendo de onde estão seus arquivos PPSM de entrada, onde deseja armazenar o arquivo mesclado e se precisa mesclar partes de arquivos
