---
title: Converter de Slides HTML para PPTM via cURL
description: Crie, edite ou converta arquivos Slides HTML em PPTM com REST API e Open Source cURL SDK
family: slides
platformtag: curl
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter HTML para PPTM com cURL" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para cURL de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de HTML para PPTM com cURL" %}}
