---
title: Converter de Slides POTX para TIFF via cURL
description: Crie, edite ou converta arquivos Slides POTX em TIFF com REST API e Open Source cURL SDK
family: slides
platformtag: curl
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter POTX para TIFF com cURL" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para cURL de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de POTX para TIFF com cURL" %}}
