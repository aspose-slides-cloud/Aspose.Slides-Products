---
title: Mesclar vários arquivos PDF via cURL
description: Mescle vários arquivos Slides PDF com REST API e Open Source cURL SDK
family: slides
platformtag: curl
feature: merge
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos PDF com cURL" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para cURL de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos PDF com cURL" %}}
