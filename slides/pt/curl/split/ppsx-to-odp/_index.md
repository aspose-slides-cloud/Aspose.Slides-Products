---
title: Dividir Slides PPSX em vários ODP via cURL
description: Divida arquivos Slides PPSX em slides ODP com REST API e Open Source cURL SDK
family: slides
platformtag: curl
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPSX em vários ODP com cURL" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para cURL de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSX em ODP dividido com cURL" %}}
