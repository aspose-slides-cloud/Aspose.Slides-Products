---
title: Substitua texto em arquivos PPTX via cURL
description: Substitua o texto nos arquivos Slides PPTX pela API REST e cURL SDK de código aberto
family: slides
platformtag: curl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos PPTX por cURL" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos PPTX por cURL" %}}
