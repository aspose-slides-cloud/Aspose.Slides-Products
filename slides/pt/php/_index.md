---
title: Crie um visualizador e conversor de slides PPT PPTX via PHP REST SDK
description: Obtenha apresentações do PowerPoint e OpenOffice do armazenamento em nuvem para visualizar, mesclar, dividir e converter slides na nuvem
weight: 100
family: slides
platform: PHP
---
...
{{< blocks/products/pf/i18n/upper-banner h1="PHP Cloud SDK para processar slides de apresentação" h2="Obtenha apresentações do PowerPoint e do OpenOffice do armazenamento em nuvem para visualizar, mesclar, dividir e converter slides na nuvem." logoImageSrc="/headers/aspose_slides-for-php.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK para PHP" downloadUrl="" >}}
...
<p>Usando Aspose.Slides Cloud SDK para PHP, seus programas PHP em nuvem seriam capazes de criar novas apresentações ou acessar apresentações existentes localizadas no armazenamento em nuvem. Por meio de nosso PHP REST SDK, você pode trabalhar com toda a apresentação, modificar slides individuais, clonar slide mestre, atualizar a sequência interativa da apresentação do PowerPoint e especificar fontes personalizadas a serem usadas na apresentação.</p>
<p>Aspose.Slides Cloud SDK para PHP ajuda seu código PHP a extrair formas, imagens e notas dos slides da apresentação. Você também pode converter PPTX, PPT, ODP e OTP para os formatos SWF, HTML, BMP, PNG, TIFF, JPEG e SVG.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP PowerPoint Cloud SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP Cloud SDK para apresentações"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     É fácil começar a usar o Aspose.Slides Cloud SDK para PHP, pois você não precisa instalar nada. Basta criar uma conta no
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose para Cloud
     </a>
	 e obter as informações do seu aplicativo. Assim que tiver o SID e a chave do aplicativo, você estará pronto para experimentar o Aspose.Slides Cloud SDK para PHP em qualquer plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Slides Cloud SDK para PHP?" tabId="success-stories" >}}
