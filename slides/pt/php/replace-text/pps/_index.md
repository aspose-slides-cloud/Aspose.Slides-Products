---
title: Substitua texto em arquivos PPS via PHP
description: Substitua o texto nos arquivos Slides PPS pela API REST e PHP SDK de código aberto
family: slides
platformtag: php
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos PPS por PHP" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos PPS por PHP" %}}
