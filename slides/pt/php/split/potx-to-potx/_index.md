---
title: Dividir Slides POTX em vários POTX via PHP
description: Divida arquivos Slides POTX em slides POTX com REST API e Open Source PHP SDK
family: slides
platformtag: php
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir POTX em vários POTX com PHP" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para PHP de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX em POTX dividido com PHP" %}}
