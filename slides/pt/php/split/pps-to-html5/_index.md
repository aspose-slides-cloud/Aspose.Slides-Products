---
title: Dividir Slides PPS em vários HTML5 via PHP
description: Divida arquivos Slides PPS em slides HTML5 com REST API e Open Source PHP SDK
family: slides
platformtag: php
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPS em vários HTML5 com PHP" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para PHP de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPS em HTML5 dividido com PHP" %}}
