---
title: Mesclar vários arquivos OTP via PHP
description: Mescle vários arquivos Slides OTP com REST API e Open Source PHP SDK
family: slides
platformtag: php
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos OTP com PHP" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para PHP de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos OTP com PHP" %}}
