---
title: Converter de Slides PPSX para TIFF via PHP
description: Crie, edite ou converta arquivos Slides PPSX em TIFF com REST API e Open Source PHP SDK
family: slides
platformtag: php
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PPSX para TIFF com PHP" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para PHP de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de PPSX para TIFF com PHP" %}}
