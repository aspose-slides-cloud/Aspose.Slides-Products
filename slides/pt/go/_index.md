---
title: API REST do criador de apresentações do PowerPoint e SDK Go lang
description: Aprimore seus aplicativos de linguagem Go baseados em nuvem para acessar apresentações de armazenamento em nuvem para modificar e converter sem qualquer software
weight: 50
family: slides
platform: Go
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Processe slides na nuvem por meio do Golang REST SDK" h2="Aprimore seus aplicativos de linguagem Go baseados em nuvem para acessar apresentações de armazenamento em nuvem para modificar e converter sem nenhum software." logoImageSrc="/headers/aspose_slides-for-go.svg" pfName="Aspose.Slides" subTitlepfName="Cloud Go SDK" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud SDK para Go foi desenvolvido para ajudar os programadores Golang no processamento e manipulação de slides de apresentação do Microsoft PowerPoint e OpenOffice hospedados na nuvem. Este SDK de nuvem é baseado na API REST Aspose.Slides e funciona sem instalar nenhum software de terceiros. Aspose.Slides Cloud SDK para Go é oferecido sob uma licença MIT.</p>
<p>Usando o Aspose.Slides Cloud SDK para Go, você pode integrar perfeitamente o visualizador de apresentação, o criador e a funcionalidade do conversor em seus aplicativos baseados em nuvem desenvolvidos na linguagem de programação Go. Isso permitirá que seu código Golang crie novas apresentações ou acesse slides de apresentação existentes do armazenamento em nuvem. Seus programas Go poderão trabalhar com apresentações inteiras, slides individuais, suas notas, temas, animações, formas, imagens, textos, bem como fontes personalizadas.</p>
<p>Aspose.Slides Cloud SDK para Go permite que seu aplicativo Go converta os formatos Microsoft PowerPoint (PPT, PPTX) e OpenOffice (ODP, OTP) em vários formatos suportados, como PDF, SWF, XPS, HTML, BMP, PNG, JPEG, TIFF e SVG.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-go.png" alt="Go PowerPoint Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Go</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-go.png" alt="Go Cloud SDK para apresentações"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Go</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     É fácil começar a usar o Aspose.Slides Cloud Go SDK, pois você não precisa instalar nada. Basta criar uma conta no
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose para Cloud
     </a>
	 e obter as informações do seu aplicativo. Assim que tiver o SID e a chave do aplicativo, você estará pronto para experimentar o Aspose.Slides Cloud Go SDK em qualquer plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Código fonte" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Go" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Slides Cloud SDK para Go?" tabId="success-stories" >}}
