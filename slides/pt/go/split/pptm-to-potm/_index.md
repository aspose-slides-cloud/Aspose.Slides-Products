---
title: Dividir Slides PPTM em vários POTM via Go
description: Divida arquivos Slides PPTM em slides POTM com REST API e Open Source Go SDK
family: slides
platformtag: go
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPTM em vários POTM com Go" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Go de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM em POTM dividido com Go" %}}
