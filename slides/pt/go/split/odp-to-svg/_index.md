---
title: Dividir Slides ODP em vários SVG via Go
description: Divida arquivos Slides ODP em slides SVG com REST API e Open Source Go SDK
family: slides
platformtag: go
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir ODP em vários SVG com Go" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Go de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODP em SVG dividido com Go" %}}
