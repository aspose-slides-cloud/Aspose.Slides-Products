---
title: Mesclar vários arquivos PPSM via Go
description: Mescle vários arquivos Slides PPSM com REST API e Open Source Go SDK
family: slides
platformtag: go
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos PPSM com Go" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Go de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos PPSM com Go" %}}
