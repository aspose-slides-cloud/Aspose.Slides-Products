---
title: Substitua texto em arquivos ODP via Go
description: Substitua o texto nos arquivos Slides ODP pela API REST e Go SDK de código aberto
family: slides
platformtag: go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Substituindo texto em arquivos ODP por Go" h2="Encontre e substitua ocorrências de texto em dados Slides com Cloud SDK de código aberto para Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Substituindo texto em arquivos ODP por Go" %}}
