---
title: Converter de Slides PPSX para PPTX via Ruby
description: Crie, edite ou converta arquivos Slides PPSX em PPTX com REST API e Open Source Ruby SDK
family: slides
platformtag: ruby
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PPSX para PPTX com Ruby" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Ruby de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de PPSX para PPTX com Ruby" %}}
