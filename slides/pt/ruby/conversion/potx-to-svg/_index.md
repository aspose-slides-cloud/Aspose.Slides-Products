---
title: Converter de Slides POTX para SVG via Ruby
description: Crie, edite ou converta arquivos Slides POTX em SVG com REST API e Open Source Ruby SDK
family: slides
platformtag: ruby
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter POTX para SVG com Ruby" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Ruby de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversão de POTX para SVG com Ruby" %}}
