---
title: Mesclar vários arquivos PPS via Ruby
description: Mescle vários arquivos Slides PPS com REST API e Open Source Ruby SDK
family: slides
platformtag: ruby
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mesclar vários arquivos PPS com Ruby" h2="Leia, edite e exporte dados do Slides para outros formatos com Cloud SDK para Ruby de código aberto">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclando arquivos PPS com Ruby" %}}
...
1. Chame um dos métodos de mesclagem, dependendo de onde estão seus arquivos PPS de entrada, onde deseja armazenar o arquivo mesclado e se precisa mesclar partes de arquivos
