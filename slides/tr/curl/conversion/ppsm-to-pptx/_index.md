---
title: cURL aracılığıyla Slides PPSM'ten PPTX'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides PPSM dosyalarını Oluşturun, Düzenleyin veya PPTX'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile PPSM'i PPTX'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
