---
title: cURL aracılığıyla Slides PPS'ten SVG'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides PPS dosyalarını Oluşturun, Düzenleyin veya SVG'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile PPS'i SVG'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
