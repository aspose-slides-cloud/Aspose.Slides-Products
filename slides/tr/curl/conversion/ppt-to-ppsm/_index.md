---
title: cURL aracılığıyla Slides PPT'ten PPSM'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides PPT dosyalarını Oluşturun, Düzenleyin veya PPSM'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile PPT'i PPSM'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
