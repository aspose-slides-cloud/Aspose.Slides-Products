---
title: cURL aracılığıyla Slides PPSX'ten PDF'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides PPSX dosyalarını Oluşturun, Düzenleyin veya PDF'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile PPSX'i PDF'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
