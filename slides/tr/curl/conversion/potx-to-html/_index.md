---
title: cURL aracılığıyla Slides POTX'ten HTML'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides POTX dosyalarını Oluşturun, Düzenleyin veya HTML'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile POTX'i HTML'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL ile POTX'ten HTML'e Dönüştürme" %}}
