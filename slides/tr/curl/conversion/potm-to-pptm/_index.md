---
title: cURL aracılığıyla Slides POTM'ten PPTM'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides POTM dosyalarını Oluşturun, Düzenleyin veya PPTM'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile POTM'i PPTM'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
