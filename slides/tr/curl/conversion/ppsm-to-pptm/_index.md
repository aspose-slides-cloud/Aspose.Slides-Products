---
title: cURL aracılığıyla Slides PPSM'ten PPTM'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides PPSM dosyalarını Oluşturun, Düzenleyin veya PPTM'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile PPSM'i PPTM'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL ile PPSM'ten PPTM'e Dönüştürme" %}}
