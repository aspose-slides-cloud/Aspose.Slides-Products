---
title: cURL aracılığıyla Slides POTX'ten XPS'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides POTX dosyalarını Oluşturun, Düzenleyin veya XPS'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile POTX'i XPS'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
