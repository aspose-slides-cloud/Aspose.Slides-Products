---
title: cURL aracılığıyla Slides ODP'ten PNG'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides ODP dosyalarını Oluşturun, Düzenleyin veya PNG'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile ODP'i PNG'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
