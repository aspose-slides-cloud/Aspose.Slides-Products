---
title: cURL aracılığıyla Slides HTML'ten ODP'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides HTML dosyalarını Oluşturun, Düzenleyin veya ODP'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile HTML'i ODP'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
