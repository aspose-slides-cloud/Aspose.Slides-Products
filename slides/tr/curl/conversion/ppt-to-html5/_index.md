---
title: cURL aracılığıyla Slides PPT'ten HTML5'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides PPT dosyalarını Oluşturun, Düzenleyin veya HTML5'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile PPT'i HTML5'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
