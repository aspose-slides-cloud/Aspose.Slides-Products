---
title: cURL aracılığıyla Slides ODP'ten PPSX'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides ODP dosyalarını Oluşturun, Düzenleyin veya PPSX'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile ODP'i PPSX'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
