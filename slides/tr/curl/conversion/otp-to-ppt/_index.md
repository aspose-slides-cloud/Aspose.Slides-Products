---
title: cURL aracılığıyla Slides OTP'ten PPT'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides OTP dosyalarını Oluşturun, Düzenleyin veya PPT'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile OTP'i PPT'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
