---
title: cURL aracılığıyla sunumları dönüştürün
description: REST API ve Açık Kaynak cURL SDK ile Slides dosyaları oluşturun, Düzenleyin veya Dönüştürün
family: slides
platformtag: curl
feature: conversion
platform: cURL
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile Sunumları Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL ile Sunum Dönüştürme" %}}
