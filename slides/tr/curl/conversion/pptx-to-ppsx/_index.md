---
title: cURL aracılığıyla Slides PPTX'ten PPSX'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides PPTX dosyalarını Oluşturun, Düzenleyin veya PPSX'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile PPTX'i PPSX'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
