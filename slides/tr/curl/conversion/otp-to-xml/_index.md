---
title: cURL aracılığıyla Slides OTP'ten XML'ye dönüştürme
description: REST API ve Açık Kaynak cURL SDK ile Slides OTP dosyalarını Oluşturun, Düzenleyin veya XML'ye Dönüştürün
family: slides
platformtag: curl
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile OTP'i XML'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL ile OTP'ten XML'e Dönüştürme" %}}
