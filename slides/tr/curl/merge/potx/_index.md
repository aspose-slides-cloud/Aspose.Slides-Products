---
title: cURL aracılığıyla birden çok POTX dosyasını birleştirme
description: Birden çok Slides POTX dosyasını REST API ve Açık Kaynak cURL SDK ile birleştirin
family: slides
platformtag: curl
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Birden çok POTX dosyasını cURL ile birleştirin" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX Dosyalarını cURL ile Birleştirme" %}}
