---
title: Slides PPSM'i cURL aracılığıyla birden fazla TIFF'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides PPSM dosyalarını TIFF slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM'i cURL ile TIFF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
