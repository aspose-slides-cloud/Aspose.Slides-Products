---
title: Slides PPTM'i cURL aracılığıyla birden fazla JPEG'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides PPTM dosyalarını JPEG slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTM'i cURL ile JPEG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
