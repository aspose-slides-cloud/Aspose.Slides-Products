---
title: Slides PPSX'i cURL aracılığıyla birden fazla XAML'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides PPSX dosyalarını XAML slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSX'i cURL ile XAML Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
