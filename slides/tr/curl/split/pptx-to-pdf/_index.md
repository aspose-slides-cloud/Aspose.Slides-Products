---
title: Slides PPTX'i cURL aracılığıyla birden fazla PDF'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides PPTX dosyalarını PDF slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTX'i cURL ile PDF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
