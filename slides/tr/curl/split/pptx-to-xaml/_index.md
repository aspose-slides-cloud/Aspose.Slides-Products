---
title: Slides PPTX'i cURL aracılığıyla birden fazla XAML'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides PPTX dosyalarını XAML slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTX'i cURL ile XAML Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
