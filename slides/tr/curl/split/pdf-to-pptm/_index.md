---
title: Slides PDF'i cURL aracılığıyla birden fazla PPTM'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides PDF dosyalarını PPTM slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF'i cURL ile PPTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
