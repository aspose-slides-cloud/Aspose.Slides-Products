---
title: cURL aracılığıyla sunumları bölme
description: REST API ve Open Source cURL SDK ile Slides dosyalarını slaytlara ayırın
family: slides
platformtag: curl
feature: split
platform: cURL
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL ile sunumları slaytlara ayırın" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL ile Sunum Bölme" %}}
