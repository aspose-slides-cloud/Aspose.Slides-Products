---
title: Slides POTX'i cURL aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides POTX dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTX'i cURL ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
