---
title: Slides PPS'i cURL aracılığıyla birden fazla MD'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides PPS dosyalarını MD slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS'i cURL ile MD Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
