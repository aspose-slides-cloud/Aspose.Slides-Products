---
title: Slides ODP'i cURL aracılığıyla birden fazla PDF'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides ODP dosyalarını PDF slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i cURL ile PDF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
