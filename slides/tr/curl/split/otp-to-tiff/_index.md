---
title: Slides OTP'i cURL aracılığıyla birden fazla TIFF'ye ayırın
description: REST API ve Open Source cURL SDK ile Slides OTP dosyalarını TIFF slaytlarına ayırın
family: slides
platformtag: curl
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="OTP'i cURL ile TIFF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for cURL ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
