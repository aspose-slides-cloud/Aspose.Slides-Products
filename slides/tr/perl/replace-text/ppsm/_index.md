---
title: PPSM dosyalarındaki metni Perl aracılığıyla değiştirin
description: Slides PPSM dosyalarındaki metni REST API ve Açık Kaynak Perl SDK ile değiştirin
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM dosyalarındaki metni Perl ile değiştirme" h2="{platform}} için açık kaynak Cloud SDK ile Slides verilerindeki metin oluşumlarını bulun ve değiştirin">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSM Dosyalarındaki Metni Perl ile Değiştirmek" %}}
