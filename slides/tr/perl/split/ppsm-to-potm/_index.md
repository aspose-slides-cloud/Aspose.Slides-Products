---
title: Slides PPSM'i Perl aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source Perl SDK ile Slides PPSM dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: perl
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM'i Perl ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Perl ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
