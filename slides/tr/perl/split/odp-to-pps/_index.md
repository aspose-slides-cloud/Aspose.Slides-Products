---
title: Slides ODP'i Perl aracılığıyla birden fazla PPS'ye ayırın
description: REST API ve Open Source Perl SDK ile Slides ODP dosyalarını PPS slaytlarına ayırın
family: slides
platformtag: perl
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i Perl ile PPS Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Perl ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
