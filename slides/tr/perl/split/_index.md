---
title: Perl aracılığıyla sunumları bölme
description: REST API ve Open Source Perl SDK ile Slides dosyalarını slaytlara ayırın
family: slides
platformtag: perl
feature: split
platform: Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Perl ile sunumları slaytlara ayırın" h2="Açık kaynaklı Cloud SDK for Perl ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Perl ile Sunum Bölme" %}}
