---
title: ODP dosyalarındaki metni Java aracılığıyla değiştirin
description: Slides ODP dosyalarındaki metni REST API ve Açık Kaynak Java SDK ile değiştirin
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP dosyalarındaki metni Java ile değiştirme" h2="{platform}} için açık kaynak Cloud SDK ile Slides verilerindeki metin oluşumlarını bulun ve değiştirin">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODP Dosyalarındaki Metni Java ile Değiştirmek" %}}
