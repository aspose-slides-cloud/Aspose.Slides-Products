---
title: Slides HTML'i Java aracılığıyla birden fazla PPSX'ye ayırın
description: REST API ve Open Source Java SDK ile Slides HTML dosyalarını PPSX slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="HTML'i Java ile PPSX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
