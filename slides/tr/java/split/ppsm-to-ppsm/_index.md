---
title: Slides PPSM'i Java aracılığıyla birden fazla PPSM'ye ayırın
description: REST API ve Open Source Java SDK ile Slides PPSM dosyalarını PPSM slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM'i Java ile PPSM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java ile PPSM'ten PPSM'e Dönüştürme" %}}
