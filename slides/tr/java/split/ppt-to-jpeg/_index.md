---
title: Slides PPT'i Java aracılığıyla birden fazla JPEG'ye ayırın
description: REST API ve Open Source Java SDK ile Slides PPT dosyalarını JPEG slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPT'i Java ile JPEG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
