---
title: Slides ODP'i Java aracılığıyla birden fazla POTX'ye ayırın
description: REST API ve Open Source Java SDK ile Slides ODP dosyalarını POTX slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i Java ile POTX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java ile ODP'ten POTX'e Dönüştürme" %}}
