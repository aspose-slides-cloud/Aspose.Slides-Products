---
title: Slides ODP'i Java aracılığıyla birden fazla TIFF'ye ayırın
description: REST API ve Open Source Java SDK ile Slides ODP dosyalarını TIFF slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i Java ile TIFF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
