---
title: Slides POTM'i Java aracılığıyla birden fazla MD'ye ayırın
description: REST API ve Open Source Java SDK ile Slides POTM dosyalarını MD slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTM'i Java ile MD Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
