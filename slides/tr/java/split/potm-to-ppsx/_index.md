---
title: Slides POTM'i Java aracılığıyla birden fazla PPSX'ye ayırın
description: REST API ve Open Source Java SDK ile Slides POTM dosyalarını PPSX slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTM'i Java ile PPSX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
