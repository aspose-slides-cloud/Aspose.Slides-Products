---
title: Slides PPSX'i Java aracılığıyla birden fazla PPTX'ye ayırın
description: REST API ve Open Source Java SDK ile Slides PPSX dosyalarını PPTX slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSX'i Java ile PPTX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
