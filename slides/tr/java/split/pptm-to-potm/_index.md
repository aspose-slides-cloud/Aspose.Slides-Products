---
title: Slides PPTM'i Java aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source Java SDK ile Slides PPTM dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTM'i Java ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
