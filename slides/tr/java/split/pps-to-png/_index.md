---
title: Slides PPS'i Java aracılığıyla birden fazla PNG'ye ayırın
description: REST API ve Open Source Java SDK ile Slides PPS dosyalarını PNG slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS'i Java ile PNG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
