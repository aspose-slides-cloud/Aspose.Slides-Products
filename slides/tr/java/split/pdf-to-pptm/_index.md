---
title: Slides PDF'i Java aracılığıyla birden fazla PPTM'ye ayırın
description: REST API ve Open Source Java SDK ile Slides PDF dosyalarını PPTM slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF'i Java ile PPTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
