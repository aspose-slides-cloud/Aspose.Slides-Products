---
title: Java aracılığıyla sunumları bölme
description: REST API ve Open Source Java SDK ile Slides dosyalarını slaytlara ayırın
family: slides
platformtag: java
feature: split
platform: Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile sunumları slaytlara ayırın" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java ile Sunum Bölme" %}}
