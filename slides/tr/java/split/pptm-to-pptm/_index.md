---
title: Slides PPTM'i Java aracılığıyla birden fazla PPTM'ye ayırın
description: REST API ve Open Source Java SDK ile Slides PPTM dosyalarını PPTM slaytlarına ayırın
family: slides
platformtag: java
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTM'i Java ile PPTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java ile PPTM'ten PPTM'e Dönüştürme" %}}
