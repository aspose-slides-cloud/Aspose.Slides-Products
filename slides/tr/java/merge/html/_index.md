---
title: Java aracılığıyla birden çok HTML dosyasını birleştirme
description: Birden çok Slides HTML dosyasını REST API ve Açık Kaynak Java SDK ile birleştirin
family: slides
platformtag: java
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Birden çok HTML dosyasını Java ile birleştirin" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML Dosyalarını Java ile Birleştirme" %}}
