---
title: Java aracılığıyla Slides PPTM'ten XAML'ye dönüştürme
description: REST API ve Açık Kaynak Java SDK ile Slides PPTM dosyalarını Oluşturun, Düzenleyin veya XAML'ye Dönüştürün
family: slides
platformtag: java
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile PPTM'i XAML'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
