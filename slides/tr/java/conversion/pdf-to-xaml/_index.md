---
title: Java aracılığıyla Slides PDF'ten XAML'ye dönüştürme
description: REST API ve Açık Kaynak Java SDK ile Slides PDF dosyalarını Oluşturun, Düzenleyin veya XAML'ye Dönüştürün
family: slides
platformtag: java
feature: conversion
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile PDF'i XAML'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java ile PDF'ten XAML'e Dönüştürme" %}}
