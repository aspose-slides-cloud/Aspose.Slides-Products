---
title: Java aracılığıyla Slides POTX'ten SVG'ye dönüştürme
description: REST API ve Açık Kaynak Java SDK ile Slides POTX dosyalarını Oluşturun, Düzenleyin veya SVG'ye Dönüştürün
family: slides
platformtag: java
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile POTX'i SVG'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java ile POTX'ten SVG'e Dönüştürme" %}}
