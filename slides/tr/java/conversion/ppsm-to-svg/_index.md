---
title: Java aracılığıyla Slides PPSM'ten SVG'ye dönüştürme
description: REST API ve Açık Kaynak Java SDK ile Slides PPSM dosyalarını Oluşturun, Düzenleyin veya SVG'ye Dönüştürün
family: slides
platformtag: java
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile PPSM'i SVG'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Java ile PPSM'ten SVG'e Dönüştürme" %}}
