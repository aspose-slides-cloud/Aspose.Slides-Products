---
title: Java aracılığıyla Slides PPS'ten PPSX'ye dönüştürme
description: REST API ve Açık Kaynak Java SDK ile Slides PPS dosyalarını Oluşturun, Düzenleyin veya PPSX'ye Dönüştürün
family: slides
platformtag: java
feature: conversion
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java ile PPS'i PPSX'ye dönüştürün" h2="Açık kaynaklı Cloud SDK for Java ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
