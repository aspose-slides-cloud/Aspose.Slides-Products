---
title: Node.js aracılığıyla sunumları bölme
description: REST API ve Open Source Node.js SDK ile Slides dosyalarını slaytlara ayırın
family: slides
platformtag: nodejs
feature: split
platform: Node.js
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Node.js ile sunumları slaytlara ayırın" h2="Açık kaynaklı Cloud SDK for Node.js ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Node.js ile Sunum Bölme" %}}
