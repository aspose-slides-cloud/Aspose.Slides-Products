---
title: Slides PPS'i Node.js aracılığıyla birden fazla MD'ye ayırın
description: REST API ve Open Source Node.js SDK ile Slides PPS dosyalarını MD slaytlarına ayırın
family: slides
platformtag: nodejs
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS'i Node.js ile MD Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Node.js ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
