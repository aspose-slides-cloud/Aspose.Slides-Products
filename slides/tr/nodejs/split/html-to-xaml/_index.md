---
title: Slides HTML'i Node.js aracılığıyla birden fazla XAML'ye ayırın
description: REST API ve Open Source Node.js SDK ile Slides HTML dosyalarını XAML slaytlarına ayırın
family: slides
platformtag: nodejs
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="HTML'i Node.js ile XAML Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Node.js ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
