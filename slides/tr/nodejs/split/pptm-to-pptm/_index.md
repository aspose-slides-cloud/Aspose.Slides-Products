---
title: Slides PPTM'i Node.js aracılığıyla birden fazla PPTM'ye ayırın
description: REST API ve Open Source Node.js SDK ile Slides PPTM dosyalarını PPTM slaytlarına ayırın
family: slides
platformtag: nodejs
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTM'i Node.js ile PPTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Node.js ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Node.js ile PPTM'ten PPTM'e Dönüştürme" %}}
