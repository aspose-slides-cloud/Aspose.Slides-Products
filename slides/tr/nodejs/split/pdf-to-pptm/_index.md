---
title: Slides PDF'i Node.js aracılığıyla birden fazla PPTM'ye ayırın
description: REST API ve Open Source Node.js SDK ile Slides PDF dosyalarını PPTM slaytlarına ayırın
family: slides
platformtag: nodejs
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF'i Node.js ile PPTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Node.js ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
