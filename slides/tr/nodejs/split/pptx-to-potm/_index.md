---
title: Slides PPTX'i Node.js aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source Node.js SDK ile Slides PPTX dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: nodejs
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTX'i Node.js ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Node.js ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
