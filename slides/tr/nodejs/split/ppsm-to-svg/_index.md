---
title: Slides PPSM'i Node.js aracılığıyla birden fazla SVG'ye ayırın
description: REST API ve Open Source Node.js SDK ile Slides PPSM dosyalarını SVG slaytlarına ayırın
family: slides
platformtag: nodejs
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM'i Node.js ile SVG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Node.js ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
