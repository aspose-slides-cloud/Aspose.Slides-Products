---
title: Slides ODP'i Node.js aracılığıyla birden fazla PDF'ye ayırın
description: REST API ve Open Source Node.js SDK ile Slides ODP dosyalarını PDF slaytlarına ayırın
family: slides
platformtag: nodejs
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i Node.js ile PDF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Node.js ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
