---
title: PPS dosyalarındaki metni Go aracılığıyla değiştirin
description: Slides PPS dosyalarındaki metni REST API ve Açık Kaynak Go SDK ile değiştirin
family: slides
platformtag: go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS dosyalarındaki metni Go ile değiştirme" h2="{platform}} için açık kaynak Cloud SDK ile Slides verilerindeki metin oluşumlarını bulun ve değiştirin">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPS Dosyalarındaki Metni Go ile Değiştirmek" %}}
