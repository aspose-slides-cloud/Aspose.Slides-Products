---
title: Go aracılığıyla birden fazla sunumu birleştirin
description: Birden çok sunumu REST API ve Açık Kaynak Go SDK ile birleştirin
family: slides
platformtag: go
feature: merge
platform: Go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Go ile birden fazla sunumu birleştirin" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Go ile sunumları birleştirme" %}}
