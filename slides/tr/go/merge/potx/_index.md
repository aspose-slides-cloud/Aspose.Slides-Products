---
title: Go aracılığıyla birden çok POTX dosyasını birleştirme
description: Birden çok Slides POTX dosyasını REST API ve Açık Kaynak Go SDK ile birleştirin
family: slides
platformtag: go
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Birden çok POTX dosyasını Go ile birleştirin" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX Dosyalarını Go ile Birleştirme" %}}
