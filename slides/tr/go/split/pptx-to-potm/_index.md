---
title: Slides PPTX'i Go aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source Go SDK ile Slides PPTX dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTX'i Go ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
