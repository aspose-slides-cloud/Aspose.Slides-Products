---
title: Slides POTX'i Go aracılığıyla birden fazla MD'ye ayırın
description: REST API ve Open Source Go SDK ile Slides POTX dosyalarını MD slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTX'i Go ile MD Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
