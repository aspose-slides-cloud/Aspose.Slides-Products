---
title: Slides POTM'i Go aracılığıyla birden fazla TIFF'ye ayırın
description: REST API ve Open Source Go SDK ile Slides POTM dosyalarını TIFF slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTM'i Go ile TIFF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
