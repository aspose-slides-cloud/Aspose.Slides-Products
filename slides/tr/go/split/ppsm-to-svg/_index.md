---
title: Slides PPSM'i Go aracılığıyla birden fazla SVG'ye ayırın
description: REST API ve Open Source Go SDK ile Slides PPSM dosyalarını SVG slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM'i Go ile SVG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
