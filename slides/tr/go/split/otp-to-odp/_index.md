---
title: Slides OTP'i Go aracılığıyla birden fazla ODP'ye ayırın
description: REST API ve Open Source Go SDK ile Slides OTP dosyalarını ODP slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="OTP'i Go ile ODP Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
