---
title: Slides PPS'i Go aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source Go SDK ile Slides PPS dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS'i Go ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
