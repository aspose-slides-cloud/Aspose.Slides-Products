---
title: Slides ODP'i Go aracılığıyla birden fazla SVG'ye ayırın
description: REST API ve Open Source Go SDK ile Slides ODP dosyalarını SVG slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i Go ile SVG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
