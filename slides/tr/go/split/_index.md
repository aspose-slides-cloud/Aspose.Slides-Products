---
title: Go aracılığıyla sunumları bölme
description: REST API ve Open Source Go SDK ile Slides dosyalarını slaytlara ayırın
family: slides
platformtag: go
feature: split
platform: Go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Go ile sunumları slaytlara ayırın" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Go ile Sunum Bölme" %}}
