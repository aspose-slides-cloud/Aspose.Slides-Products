---
title: Slides PDF'i Go aracılığıyla birden fazla XAML'ye ayırın
description: REST API ve Open Source Go SDK ile Slides PDF dosyalarını XAML slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF'i Go ile XAML Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
