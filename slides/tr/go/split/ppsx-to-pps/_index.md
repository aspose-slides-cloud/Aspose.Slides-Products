---
title: Slides PPSX'i Go aracılığıyla birden fazla PPS'ye ayırın
description: REST API ve Open Source Go SDK ile Slides PPSX dosyalarını PPS slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSX'i Go ile PPS Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
