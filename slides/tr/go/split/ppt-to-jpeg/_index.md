---
title: Slides PPT'i Go aracılığıyla birden fazla JPEG'ye ayırın
description: REST API ve Open Source Go SDK ile Slides PPT dosyalarını JPEG slaytlarına ayırın
family: slides
platformtag: go
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPT'i Go ile JPEG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Go ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
