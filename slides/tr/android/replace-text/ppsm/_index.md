---
title: PPSM dosyalarındaki metni Android aracılığıyla değiştirin
description: Slides PPSM dosyalarındaki metni REST API ve Açık Kaynak Android SDK ile değiştirin
family: slides
platformtag: android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM dosyalarındaki metni Android ile değiştirme" h2="{platform}} için açık kaynak Cloud SDK ile Slides verilerindeki metin oluşumlarını bulun ve değiştirin">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSM Dosyalarındaki Metni Android ile Değiştirmek" %}}
