---
title: POTX dosyalarındaki metni Swift aracılığıyla değiştirin
description: Slides POTX dosyalarındaki metni REST API ve Açık Kaynak Swift SDK ile değiştirin
family: slides
platformtag: swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTX dosyalarındaki metni Swift ile değiştirme" h2="{platform}} için açık kaynak Cloud SDK ile Slides verilerindeki metin oluşumlarını bulun ve değiştirin">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX Dosyalarındaki Metni Swift ile Değiştirmek" %}}
