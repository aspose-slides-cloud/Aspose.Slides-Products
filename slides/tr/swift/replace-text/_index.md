---
title: Sunumlardaki metni Swift aracılığıyla değiştirin
description: Slides dosyalarındaki metni REST API ve Açık Kaynak Swift SDK ile değiştirin
family: slides
platformtag: swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sunumlardaki metni Swift ile değiştirin" h2="{platform}} için açık kaynak Cloud SDK ile Slides verilerindeki metin oluşumlarını bulun ve değiştirin">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sunumlardaki metni Swift ile değiştirmek" %}}
