---
title: Swift aracılığıyla birden fazla sunumu birleştirin
description: Birden çok sunumu REST API ve Açık Kaynak Swift SDK ile birleştirin
family: slides
platformtag: swift
feature: merge
platform: Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Swift ile birden fazla sunumu birleştirin" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Swift ile sunumları birleştirme" %}}
