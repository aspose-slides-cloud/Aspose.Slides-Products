---
title: Slides POTX'i Swift aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source Swift SDK ile Slides POTX dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: swift
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTX'i Swift ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
