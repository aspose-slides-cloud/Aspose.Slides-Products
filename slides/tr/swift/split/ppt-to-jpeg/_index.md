---
title: Slides PPT'i Swift aracılığıyla birden fazla JPEG'ye ayırın
description: REST API ve Open Source Swift SDK ile Slides PPT dosyalarını JPEG slaytlarına ayırın
family: slides
platformtag: swift
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPT'i Swift ile JPEG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
