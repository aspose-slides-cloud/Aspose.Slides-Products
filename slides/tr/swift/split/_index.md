---
title: Swift aracılığıyla sunumları bölme
description: REST API ve Open Source Swift SDK ile Slides dosyalarını slaytlara ayırın
family: slides
platformtag: swift
feature: split
platform: Swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Swift ile sunumları slaytlara ayırın" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Swift ile Sunum Bölme" %}}
