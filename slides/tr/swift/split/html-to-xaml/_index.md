---
title: Slides HTML'i Swift aracılığıyla birden fazla XAML'ye ayırın
description: REST API ve Open Source Swift SDK ile Slides HTML dosyalarını XAML slaytlarına ayırın
family: slides
platformtag: swift
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="HTML'i Swift ile XAML Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
