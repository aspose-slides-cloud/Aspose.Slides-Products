---
title: Slides PPS'i Swift aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source Swift SDK ile Slides PPS dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: swift
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS'i Swift ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
