---
title: Slides OTP'i Swift aracılığıyla birden fazla TIFF'ye ayırın
description: REST API ve Open Source Swift SDK ile Slides OTP dosyalarını TIFF slaytlarına ayırın
family: slides
platformtag: swift
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="OTP'i Swift ile TIFF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
