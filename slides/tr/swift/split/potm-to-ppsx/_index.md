---
title: Slides POTM'i Swift aracılığıyla birden fazla PPSX'ye ayırın
description: REST API ve Open Source Swift SDK ile Slides POTM dosyalarını PPSX slaytlarına ayırın
family: slides
platformtag: swift
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTM'i Swift ile PPSX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
