---
title: Slides ODP'i Swift aracılığıyla birden fazla XPS'ye ayırın
description: REST API ve Open Source Swift SDK ile Slides ODP dosyalarını XPS slaytlarına ayırın
family: slides
platformtag: swift
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i Swift ile XPS Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
