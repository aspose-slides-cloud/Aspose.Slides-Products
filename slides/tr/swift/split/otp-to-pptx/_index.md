---
title: Slides OTP'i Swift aracılığıyla birden fazla PPTX'ye ayırın
description: REST API ve Open Source Swift SDK ile Slides OTP dosyalarını PPTX slaytlarına ayırın
family: slides
platformtag: swift
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="OTP'i Swift ile PPTX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
