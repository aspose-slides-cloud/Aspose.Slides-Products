---
title: Slides PDF'i Swift aracılığıyla birden fazla PNG'ye ayırın
description: REST API ve Open Source Swift SDK ile Slides PDF dosyalarını PNG slaytlarına ayırın
family: slides
platformtag: swift
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF'i Swift ile PNG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Swift ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
