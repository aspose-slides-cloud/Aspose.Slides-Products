---
title: Slides PPTX'i PHP aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source PHP SDK ile Slides PPTX dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: php
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTX'i PHP ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for PHP ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
