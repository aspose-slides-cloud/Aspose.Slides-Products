---
title: Slides OTP'i PHP aracılığıyla birden fazla PPTX'ye ayırın
description: REST API ve Open Source PHP SDK ile Slides OTP dosyalarını PPTX slaytlarına ayırın
family: slides
platformtag: php
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="OTP'i PHP ile PPTX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for PHP ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
