---
title: Slides PPSM'i PHP aracılığıyla birden fazla PPSM'ye ayırın
description: REST API ve Open Source PHP SDK ile Slides PPSM dosyalarını PPSM slaytlarına ayırın
family: slides
platformtag: php
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM'i PHP ile PPSM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for PHP ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PHP ile PPSM'ten PPSM'e Dönüştürme" %}}
