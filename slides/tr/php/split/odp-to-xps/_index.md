---
title: Slides ODP'i PHP aracılığıyla birden fazla XPS'ye ayırın
description: REST API ve Open Source PHP SDK ile Slides ODP dosyalarını XPS slaytlarına ayırın
family: slides
platformtag: php
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i PHP ile XPS Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for PHP ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
