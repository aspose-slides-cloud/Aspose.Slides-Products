---
title: Slides PPSX'i PHP aracılığıyla birden fazla PPS'ye ayırın
description: REST API ve Open Source PHP SDK ile Slides PPSX dosyalarını PPS slaytlarına ayırın
family: slides
platformtag: php
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSX'i PHP ile PPS Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for PHP ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
