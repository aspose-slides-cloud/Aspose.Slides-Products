---
title: PHP aracılığıyla birden çok PPT dosyasını birleştirme
description: Birden çok Slides PPT dosyasını REST API ve Açık Kaynak PHP SDK ile birleştirin
family: slides
platformtag: php
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Birden çok PPT dosyasını PHP ile birleştirin" h2="Açık kaynaklı Cloud SDK for PHP ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPT Dosyalarını PHP ile Birleştirme" %}}
