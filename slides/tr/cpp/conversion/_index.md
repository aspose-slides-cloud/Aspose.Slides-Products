---
title: C++ aracılığıyla sunumları dönüştürün
description: REST API ve Açık Kaynak C++ SDK ile Slides dosyaları oluşturun, Düzenleyin veya Dönüştürün
family: slides
platformtag: cpp
feature: conversion
platform: C++
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C++ ile Sunumları Dönüştürün" h2="Açık kaynaklı Cloud SDK for C++ ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C++ ile Sunum Dönüştürme" %}}
