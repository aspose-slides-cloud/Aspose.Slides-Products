---
title: Slides POTX'i C++ aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source C++ SDK ile Slides POTX dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: cpp
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTX'i C++ ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for C++ ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
