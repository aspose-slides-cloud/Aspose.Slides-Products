---
title: Slides PPTX'i C++ aracılığıyla birden fazla XAML'ye ayırın
description: REST API ve Open Source C++ SDK ile Slides PPTX dosyalarını XAML slaytlarına ayırın
family: slides
platformtag: cpp
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTX'i C++ ile XAML Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for C++ ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
