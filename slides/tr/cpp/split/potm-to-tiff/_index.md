---
title: Slides POTM'i C++ aracılığıyla birden fazla TIFF'ye ayırın
description: REST API ve Open Source C++ SDK ile Slides POTM dosyalarını TIFF slaytlarına ayırın
family: slides
platformtag: cpp
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTM'i C++ ile TIFF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for C++ ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
