---
title: Slides HTML'i C++ aracılığıyla birden fazla PPSX'ye ayırın
description: REST API ve Open Source C++ SDK ile Slides HTML dosyalarını PPSX slaytlarına ayırın
family: slides
platformtag: cpp
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="HTML'i C++ ile PPSX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for C++ ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
