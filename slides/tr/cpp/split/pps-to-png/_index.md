---
title: Slides PPS'i C++ aracılığıyla birden fazla PNG'ye ayırın
description: REST API ve Open Source C++ SDK ile Slides PPS dosyalarını PNG slaytlarına ayırın
family: slides
platformtag: cpp
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS'i C++ ile PNG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for C++ ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
