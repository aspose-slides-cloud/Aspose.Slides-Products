---
title: C++ aracılığıyla sunumları bölme
description: REST API ve Open Source C++ SDK ile Slides dosyalarını slaytlara ayırın
family: slides
platformtag: cpp
feature: split
platform: C++
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C++ ile sunumları slaytlara ayırın" h2="Açık kaynaklı Cloud SDK for C++ ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C++ ile Sunum Bölme" %}}
