---
title: Slides ODP'i C++ aracılığıyla birden fazla PDF'ye ayırın
description: REST API ve Open Source C++ SDK ile Slides ODP dosyalarını PDF slaytlarına ayırın
family: slides
platformtag: cpp
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i C++ ile PDF Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for C++ ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
