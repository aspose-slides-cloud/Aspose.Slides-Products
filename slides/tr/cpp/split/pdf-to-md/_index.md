---
title: Slides PDF'i C++ aracılığıyla birden fazla MD'ye ayırın
description: REST API ve Open Source C++ SDK ile Slides PDF dosyalarını MD slaytlarına ayırın
family: slides
platformtag: cpp
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF'i C++ ile MD Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for C++ ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
