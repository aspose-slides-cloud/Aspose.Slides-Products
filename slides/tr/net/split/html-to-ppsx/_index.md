---
title: Slides HTML'i .NET aracılığıyla birden fazla PPSX'ye ayırın
description: REST API ve Open Source .NET SDK ile Slides HTML dosyalarını PPSX slaytlarına ayırın
family: slides
platformtag: net
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="HTML'i .NET ile PPSX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
