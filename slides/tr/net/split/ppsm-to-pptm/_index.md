---
title: Slides PPSM'i .NET aracılığıyla birden fazla PPTM'ye ayırın
description: REST API ve Open Source .NET SDK ile Slides PPSM dosyalarını PPTM slaytlarına ayırın
family: slides
platformtag: net
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM'i .NET ile PPTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
