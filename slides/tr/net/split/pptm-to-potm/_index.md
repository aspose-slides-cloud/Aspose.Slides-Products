---
title: Slides PPTM'i .NET aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source .NET SDK ile Slides PPTM dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: net
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTM'i .NET ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
