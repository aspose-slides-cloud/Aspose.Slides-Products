---
title: .NET aracılığıyla sunumları bölme
description: REST API ve Open Source .NET SDK ile Slides dosyalarını slaytlara ayırın
family: slides
platformtag: net
feature: split
platform: .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1=".NET ile sunumları slaytlara ayırın" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET ile Sunum Bölme" %}}
1. Ücretsiz API kotası ve yetkilendirme ayrıntılarını almak için <a href="https://dashboard.aspose.cloud/">Gösterge Tablosunda</a> bir hesap oluşturun
1. ```SlidesApi```'yi İstemci Kimliği ve İstemci Sırrı ile Başlatın
1. Girdi HTML dosyanızın nerede olduğuna ve ortaya çıkan MPEG4 dosyalarını nerede depolamak istediğinize bağlı olarak bölme yöntemlerinden birini çağırın
