---
title: Slides ODP'i .NET aracılığıyla birden fazla SVG'ye ayırın
description: REST API ve Open Source .NET SDK ile Slides ODP dosyalarını SVG slaytlarına ayırın
family: slides
platformtag: net
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i .NET ile SVG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
