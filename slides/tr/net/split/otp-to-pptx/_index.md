---
title: Slides OTP'i .NET aracılığıyla birden fazla PPTX'ye ayırın
description: REST API ve Open Source .NET SDK ile Slides OTP dosyalarını PPTX slaytlarına ayırın
family: slides
platformtag: net
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="OTP'i .NET ile PPTX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
