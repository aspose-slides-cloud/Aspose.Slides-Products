---
title: Slides PDF'i .NET aracılığıyla birden fazla XAML'ye ayırın
description: REST API ve Open Source .NET SDK ile Slides PDF dosyalarını XAML slaytlarına ayırın
family: slides
platformtag: net
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF'i .NET ile XAML Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
