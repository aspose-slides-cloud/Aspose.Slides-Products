---
title: Slides POTX'i .NET aracılığıyla birden fazla MD'ye ayırın
description: REST API ve Open Source .NET SDK ile Slides POTX dosyalarını MD slaytlarına ayırın
family: slides
platformtag: net
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTX'i .NET ile MD Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
