---
title: Slides PPSX'i .NET aracılığıyla birden fazla PPS'ye ayırın
description: REST API ve Open Source .NET SDK ile Slides PPSX dosyalarını PPS slaytlarına ayırın
family: slides
platformtag: net
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSX'i .NET ile PPS Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
