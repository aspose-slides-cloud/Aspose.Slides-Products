---
title: Slides PPS'i .NET aracılığıyla birden fazla BMP'ye ayırın
description: REST API ve Open Source .NET SDK ile Slides PPS dosyalarını BMP slaytlarına ayırın
family: slides
platformtag: net
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS'i .NET ile BMP Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
