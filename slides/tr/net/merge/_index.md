---
title: .NET aracılığıyla birden fazla sunumu birleştirin
description: Birden çok sunumu REST API ve Açık Kaynak .NET SDK ile birleştirin
family: slides
platformtag: net
feature: merge
platform: .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1=".NET ile birden fazla sunumu birleştirin" h2="Açık kaynaklı Cloud SDK for .NET ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET ile sunumları birleştirme" %}}
