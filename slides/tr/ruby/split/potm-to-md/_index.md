---
title: Slides POTM'i Ruby aracılığıyla birden fazla MD'ye ayırın
description: REST API ve Open Source Ruby SDK ile Slides POTM dosyalarını MD slaytlarına ayırın
family: slides
platformtag: ruby
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTM'i Ruby ile MD Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Ruby ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
