---
title: Slides PPS'i Ruby aracılığıyla birden fazla PNG'ye ayırın
description: REST API ve Open Source Ruby SDK ile Slides PPS dosyalarını PNG slaytlarına ayırın
family: slides
platformtag: ruby
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS'i Ruby ile PNG Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Ruby ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
