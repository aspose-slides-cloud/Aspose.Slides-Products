---
title: Ruby aracılığıyla sunumları bölme
description: REST API ve Open Source Ruby SDK ile Slides dosyalarını slaytlara ayırın
family: slides
platformtag: ruby
feature: split
platform: Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile sunumları slaytlara ayırın" h2="Açık kaynaklı Cloud SDK for Ruby ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile Sunum Bölme" %}}
