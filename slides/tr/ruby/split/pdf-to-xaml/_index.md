---
title: Slides PDF'i Ruby aracılığıyla birden fazla XAML'ye ayırın
description: REST API ve Open Source Ruby SDK ile Slides PDF dosyalarını XAML slaytlarına ayırın
family: slides
platformtag: ruby
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF'i Ruby ile XAML Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Ruby ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
