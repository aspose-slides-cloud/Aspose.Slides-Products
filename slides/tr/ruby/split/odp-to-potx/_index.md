---
title: Slides ODP'i Ruby aracılığıyla birden fazla POTX'ye ayırın
description: REST API ve Open Source Ruby SDK ile Slides ODP dosyalarını POTX slaytlarına ayırın
family: slides
platformtag: ruby
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i Ruby ile POTX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Ruby ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
