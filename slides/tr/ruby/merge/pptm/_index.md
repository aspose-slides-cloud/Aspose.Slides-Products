---
title: Ruby aracılığıyla birden çok PPTM dosyasını birleştirme
description: Birden çok Slides PPTM dosyasını REST API ve Açık Kaynak Ruby SDK ile birleştirin
family: slides
platformtag: ruby
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Birden çok PPTM dosyasını Ruby ile birleştirin" h2="Açık kaynaklı Cloud SDK for Ruby ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM Dosyalarını Ruby ile Birleştirme" %}}
