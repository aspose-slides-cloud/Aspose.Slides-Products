---
title: Ruby aracılığıyla birden fazla sunumu birleştirin
description: Birden çok sunumu REST API ve Açık Kaynak Ruby SDK ile birleştirin
family: slides
platformtag: ruby
feature: merge
platform: Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ruby ile birden fazla sunumu birleştirin" h2="Açık kaynaklı Cloud SDK for Ruby ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ruby ile sunumları birleştirme" %}}
