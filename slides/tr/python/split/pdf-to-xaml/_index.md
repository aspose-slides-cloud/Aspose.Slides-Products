---
title: Slides PDF'i Python aracılığıyla birden fazla XAML'ye ayırın
description: REST API ve Open Source Python SDK ile Slides PDF dosyalarını XAML slaytlarına ayırın
family: slides
platformtag: python
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PDF'i Python ile XAML Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Python ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
