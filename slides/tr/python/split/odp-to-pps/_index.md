---
title: Slides ODP'i Python aracılığıyla birden fazla PPS'ye ayırın
description: REST API ve Open Source Python SDK ile Slides ODP dosyalarını PPS slaytlarına ayırın
family: slides
platformtag: python
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="ODP'i Python ile PPS Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Python ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
