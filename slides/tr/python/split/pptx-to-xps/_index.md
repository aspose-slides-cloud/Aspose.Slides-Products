---
title: Slides PPTX'i Python aracılığıyla birden fazla XPS'ye ayırın
description: REST API ve Open Source Python SDK ile Slides PPTX dosyalarını XPS slaytlarına ayırın
family: slides
platformtag: python
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTX'i Python ile XPS Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Python ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
