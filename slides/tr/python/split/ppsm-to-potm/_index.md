---
title: Slides PPSM'i Python aracılığıyla birden fazla POTM'ye ayırın
description: REST API ve Open Source Python SDK ile Slides PPSM dosyalarını POTM slaytlarına ayırın
family: slides
platformtag: python
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM'i Python ile POTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Python ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
