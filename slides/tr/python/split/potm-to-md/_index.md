---
title: Slides POTM'i Python aracılığıyla birden fazla MD'ye ayırın
description: REST API ve Open Source Python SDK ile Slides POTM dosyalarını MD slaytlarına ayırın
family: slides
platformtag: python
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTM'i Python ile MD Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Python ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
