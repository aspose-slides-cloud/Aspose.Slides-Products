---
title: Slides PPS'i Python aracılığıyla birden fazla PPTM'ye ayırın
description: REST API ve Open Source Python SDK ile Slides PPS dosyalarını PPTM slaytlarına ayırın
family: slides
platformtag: python
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPS'i Python ile PPTM Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Python ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
