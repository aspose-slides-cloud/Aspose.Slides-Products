---
title: Slides OTP'i Python aracılığıyla birden fazla PPSX'ye ayırın
description: REST API ve Open Source Python SDK ile Slides OTP dosyalarını PPSX slaytlarına ayırın
family: slides
platformtag: python
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="OTP'i Python ile PPSX Bölünmesine Dönüştürün" h2="Açık kaynaklı Cloud SDK for Python ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
