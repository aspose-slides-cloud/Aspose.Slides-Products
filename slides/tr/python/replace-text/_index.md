---
title: Sunumlardaki metni Python aracılığıyla değiştirin
description: Slides dosyalarındaki metni REST API ve Açık Kaynak Python SDK ile değiştirin
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sunumlardaki metni Python ile değiştirin" h2="{platform}} için açık kaynak Cloud SDK ile Slides verilerindeki metin oluşumlarını bulun ve değiştirin">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sunumlardaki metni Python ile değiştirmek" %}}
