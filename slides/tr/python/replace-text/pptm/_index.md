---
title: PPTM dosyalarındaki metni Python aracılığıyla değiştirin
description: Slides PPTM dosyalarındaki metni REST API ve Açık Kaynak Python SDK ile değiştirin
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTM dosyalarındaki metni Python ile değiştirme" h2="{platform}} için açık kaynak Cloud SDK ile Slides verilerindeki metin oluşumlarını bulun ve değiştirin">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM Dosyalarındaki Metni Python ile Değiştirmek" %}}
