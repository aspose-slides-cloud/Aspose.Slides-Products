---
title: Python aracılığıyla birden çok PPTX dosyasını birleştirme
description: Birden çok Slides PPTX dosyasını REST API ve Açık Kaynak Python SDK ile birleştirin
family: slides
platformtag: python
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Birden çok PPTX dosyasını Python ile birleştirin" h2="Açık kaynaklı Cloud SDK for Python ile Slides verilerini okuyun, düzenleyin ve diğer biçimlere aktarın">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTX Dosyalarını Python ile Birleştirme" %}}
