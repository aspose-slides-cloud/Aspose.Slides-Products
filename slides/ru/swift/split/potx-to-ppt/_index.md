---
title: Разделение Slides POTX на несколько PPT с помощью Swift
description: Разделите файлы Slides POTX на слайды PPT с помощью REST API и Swift SDK с открытым исходным кодом
family: slides
platformtag: swift
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение POTX на несколько PPT с помощью Swift" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение POTX на PPT с помощью Swift" %}}
