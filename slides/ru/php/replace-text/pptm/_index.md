---
title: Замена текста в PPTM-файлах c помощью PHP
description: Замена текста в файлах Slides PPTM с помощью REST API и PHP SDK с открытым исходным кодом
family: slides
platformtag: php
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Замена текста в файлах PPTM с помощью PHP" h2="Найдите и замените вхождения текста в данных Slides с помощью Cloud SDK с открытым исходным кодом для PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Замена текста в PPTM-файлах с помощью PHP" %}}
