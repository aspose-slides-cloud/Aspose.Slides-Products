---
title: Создайте программу просмотра и конвертера слайдов PPT PPTX с помощью PHP REST SDK
description: Извлекайте презентации PowerPoint и OpenOffice из облачного хранилища, чтобы просматривать, объединять, разделять и преобразовывать слайды в облаке
weight: 100
family: slides
platform: PHP
---
...
{{< blocks/products/pf/i18n/upper-banner h1="PHP Cloud SDK для обработки слайдов презентации" h2="Получайте презентации PowerPoint и OpenOffice из облачного хранилища, чтобы просматривать, объединять, разделять и преобразовывать слайды в облаке." logoImageSrc="/headers/aspose_slides-for-php.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK для PHP" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Cloud SDK для PHP" >}}
...
<p>Aspose.Slides Cloud SDK для PHP помогает создавать облачные PHP-приложения, которые могут создавать слайды PPT и презентации PowerPoint без установки какого-либо программного обеспечения. Aspose.Slides Cloud SDK для PHP также поддерживает форматы презентаций OpenOffice, ODP и OTP. Aspose.Slides Cloud SDK для PHP основан на Aspose.Slides REST API и предлагается по лицензии MIT.</p>
<p>Используя Aspose.Slides Cloud SDK для PHP, ваши облачные PHP-программы смогут создавать новые презентации или получать доступ к существующим презентациям, расположенным в облачном хранилище. С помощью нашего PHP REST SDK вы можете работать со всей презентацией, изменять отдельные слайды, клонировать мастер-слайд, обновлять интерактивную последовательность презентации PowerPoint и указывать пользовательские шрифты для использования в презентации.</p>
<p>Aspose.Slides Cloud SDK для PHP помогает вашему коду PHP извлекать фигуры, изображения и заметки из слайдов презентации. Вы также можете конвертировать PPTX, PPT, ODP и OTP в форматы SWF, HTML, BMP, PNG, TIFF, JPEG, SVG.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP PowerPoint Cloud SDK"><header>Aspose.Slides</header><footer>Cloud <small> <em>для </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP Cloud SDK для презентаций"><header>Aspose.Slides</header><footer>Cloud <small> <em>для </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	  Начать работу с Aspose.Slides Cloud SDK для PHP легко, так как вам не нужно ничего устанавливать. Просто создайте учетную запись на странице
	  <a href="https://dashboard.aspose.cloud/#/apps">.
        Aspose для облака
      </a>
	  и получите информацию о приложении. Получив SID и ключ приложения, вы готовы попробовать Aspose.Slides Cloud SDK для PHP на любой платформе.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides Cloud SDK для PHP позволяет разработчикам создавать новые формы для слайдов презентации. Вы можете читать и обновлять информацию о свойствах существующих фигур слайдов. Наша обработка слайдов презентаций с помощью Cloud SDK позволяет отображать формы слайдов в поддерживаемых форматах изображений. Aspose.Slides Cloud SDK для PHP также помогает работать с примечаниями к слайдам презентации.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Исходный код" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-PHP" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Slides Cloud SDK для PHP?" tabId="success-stories" >}}
