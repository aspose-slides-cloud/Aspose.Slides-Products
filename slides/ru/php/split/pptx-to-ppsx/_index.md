---
title: Разделение Slides PPTX на несколько PPSX с помощью PHP
description: Разделите файлы Slides PPTX на слайды PPSX с помощью REST API и PHP SDK с открытым исходным кодом
family: slides
platformtag: php
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение PPTX на несколько PPSX с помощью PHP" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение PPTX на PPSX с помощью PHP" %}}
