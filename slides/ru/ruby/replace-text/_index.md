...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Замена текста в презентациях с помощью Ruby" h2="Найдите и замените вхождения текста в данных Slides с помощью Cloud SDK с открытым исходным кодом для Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Замена текста в презентациях с помощью Ruby" %}}
