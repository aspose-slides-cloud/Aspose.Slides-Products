---
title: Разделение Slides OTP на несколько SVG с помощью Node.js
description: Разделите файлы Slides OTP на слайды SVG с помощью REST API и Node.js SDK с открытым исходным кодом
family: slides
platformtag: nodejs
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение OTP на несколько SVG с помощью Node.js" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение OTP на SVG с помощью Node.js" %}}
