---
title: Замена текста в ODP-файлах c помощью Perl
description: Замена текста в файлах Slides ODP с помощью REST API и Perl SDK с открытым исходным кодом
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Замена текста в файлах ODP с помощью Perl" h2="Найдите и замените вхождения текста в данных Slides с помощью Cloud SDK с открытым исходным кодом для Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Замена текста в ODP-файлах с помощью Perl" %}}
