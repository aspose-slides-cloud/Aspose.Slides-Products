---
title: Разделение Slides PPT на несколько XAML с помощью .NET
description: Разделите файлы Slides PPT на слайды XAML с помощью REST API и .NET SDK с открытым исходным кодом
family: slides
platformtag: net
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение PPT на несколько XAML с помощью .NET" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение PPT на XAML с помощью .NET" %}}
