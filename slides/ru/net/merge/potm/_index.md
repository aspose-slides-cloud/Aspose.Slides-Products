---
title: Объединение нескольких POTM файлов с помощью .NET
description: Объединение нескольких файлов Slides POTM с помощью REST API и .NET SDK с открытым исходным кодом
family: slides
platformtag: net
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Объединение нескольких файлов POTM с помощью .NET" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Объединение POTM файлов с помощью .NET" %}}
