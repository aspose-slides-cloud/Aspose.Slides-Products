---
title: Замена текста в OTP-файлах c помощью .NET
description: Замена текста в файлах Slides OTP с помощью REST API и .NET SDK с открытым исходным кодом
family: slides
platformtag: net
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Замена текста в файлах OTP с помощью .NET" h2="Найдите и замените вхождения текста в данных Slides с помощью Cloud SDK с открытым исходным кодом для .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Замена текста в OTP-файлах с помощью .NET" %}}
