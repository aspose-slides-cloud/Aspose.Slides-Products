---
title: Объединение нескольких презентаций с помощью C++
description: Объединение нескольких презентаций с помощью REST API и C++ SDK с открытым исходным кодом
family: slides
platformtag: cpp
feature: merge
platform: C++
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Объединение нескольких презентаций с помощью C++" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Объединение презентаций с помощью C++" %}}
