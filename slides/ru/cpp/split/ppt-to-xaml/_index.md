---
title: Разделение Slides PPT на несколько XAML с помощью C++
description: Разделите файлы Slides PPT на слайды XAML с помощью REST API и C++ SDK с открытым исходным кодом
family: slides
platformtag: cpp
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение PPT на несколько XAML с помощью C++" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение PPT на XAML с помощью C++" %}}
