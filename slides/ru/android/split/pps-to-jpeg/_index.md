---
title: Разделение Slides PPS на несколько JPEG с помощью Android
description: Разделите файлы Slides PPS на слайды JPEG с помощью REST API и Android SDK с открытым исходным кодом
family: slides
platformtag: android
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение PPS на несколько JPEG с помощью Android" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение PPS на JPEG с помощью Android" %}}
