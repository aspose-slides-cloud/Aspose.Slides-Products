---
title: Разделение Slides HTML на несколько XPS с помощью Android
description: Разделите файлы Slides HTML на слайды XPS с помощью REST API и Android SDK с открытым исходным кодом
family: slides
platformtag: android
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение HTML на несколько XPS с помощью Android" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение HTML на XPS с помощью Android" %}}
