---
title: Разделение Slides HTML на несколько XPS с помощью Go
description: Разделите файлы Slides HTML на слайды XPS с помощью REST API и Go SDK с открытым исходным кодом
family: slides
platformtag: go
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение HTML на несколько XPS с помощью Go" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение HTML на XPS с помощью Go" %}}
