---
title: Разделение Slides PPT на несколько JPEG с помощью Java
description: Разделите файлы Slides PPT на слайды JPEG с помощью REST API и Java SDK с открытым исходным кодом
family: slides
platformtag: java
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение PPT на несколько JPEG с помощью Java" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение PPT на JPEG с помощью Java" %}}
