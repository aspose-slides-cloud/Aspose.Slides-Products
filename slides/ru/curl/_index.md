---
title: Создавайте, объединяйте, разделяйте и конвертируйте слайды PowerPoint через cURL
description: Создание, обработка, объединение и преобразование слайдов презентаций PowerPoint и OpenOffice с помощью простых команд cURL через REST API
weight: 40
family: slides
platform: cURL
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Создавайте приложения для создания презентаций и конвертеров PPT через cURL" h2="Выполняйте создание, обработку, объединение и преобразование слайдов презентаций PowerPoint и OpenOffice с помощью простых команд cURL через REST API." logoImageSrc="/headers/aspose_slides-for-curl.svg" pfName="Aspose.Slides" subTitlepfName="Cloud для cURL" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Cloud для cURL" >}}
...
<p>Aspose.Slides Cloud для cURL позволяет конвертировать презентации и слайды PowerPoint и OpenOffice в другие поддерживаемые форматы. Например, вы можете конвертировать PPT в PDF, BMP, PNG, SVG, TIFF, JPEG, SWF и HTML. Вы можете выполнять различные операции со слайдами презентации, темами презентации, заметками к слайду, изображениями слайдов, мастер-слайдами, пользовательскими шрифтами и различными другими свойствами презентационных документов Microsoft PowerPoint и OpenOffice.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="cURL Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>для </em> </small>cURL</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="cURL Cloud для презентаций"><header>Aspose.Slides</header><footer>Cloud <small> <em>для </em> </small>cURL</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	  Начать работу с Aspose.Slides Cloud для cURL легко, так как вам не нужно ничего устанавливать. Просто создайте учетную запись на странице
	  <a href="https://dashboard.aspose.cloud/#/apps">.
        Aspose для облака
      </a>
	  и получите информацию о приложении. Получив SID и ключ приложения, вы готовы попробовать Aspose.Slides Cloud для cURL на любой платформе.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides Cloud для cURL позволяет разработчикам выполнять операции по обработке слайдов презентации от базовых до расширенных. Вы можете прочитать информацию о слайдах презентации. Создавайте новые слайды. Скопируйте, измените или удалите существующие слайды. Преобразование слайдов презентации из форматов PowerPoint в другие поддерживаемые форматы с помощью Cloud SDK. Вы также можете управлять фоном слайда, применяя новый фон, читая и удаляя существующий фон для любого слайда. Aspose.Slides Cloud для cURL позволяет изменить порядок расположения слайдов в презентации. Вы также можете скопировать слайд из текущей или другой презентации. Также можно получить комментарии к слайдам презентации.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Обработка фигур и заметок в слайдах
    </h2>
    <p>
     Aspose.Slides Cloud для cURL позволяет разработчикам создавать новые формы для слайдов презентации. Вы можете читать и обновлять информацию о свойствах существующих фигур слайдов. Он также позволяет отображать формы слайдов в поддерживаемых форматах изображений. Aspose.Slides Cloud для cURL также помогает вам работать с примечаниями к слайдам презентации.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Исходный код" href="https://github.com/aspose-slides-cloud/aspose-slides-cloud-curl" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Slides Cloud для cURL?" tabId="success-stories" >}}
