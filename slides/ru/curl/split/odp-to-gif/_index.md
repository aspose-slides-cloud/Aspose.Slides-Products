---
title: Разделение Slides ODP на несколько GIF с помощью cURL
description: Разделите файлы Slides ODP на слайды GIF с помощью REST API и cURL SDK с открытым исходным кодом
family: slides
platformtag: curl
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение ODP на несколько GIF с помощью cURL" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение ODP на GIF с помощью cURL" %}}
