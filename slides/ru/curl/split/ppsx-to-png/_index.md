---
title: Разделение Slides PPSX на несколько PNG с помощью cURL
description: Разделите файлы Slides PPSX на слайды PNG с помощью REST API и cURL SDK с открытым исходным кодом
family: slides
platformtag: curl
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение PPSX на несколько PNG с помощью cURL" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение PPSX на PNG с помощью cURL" %}}
