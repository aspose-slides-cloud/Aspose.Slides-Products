---
title: Разделение Slides PDF на несколько XAML с помощью Python
description: Разделите файлы Slides PDF на слайды XAML с помощью REST API и Python SDK с открытым исходным кодом
family: slides
platformtag: python
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Разделение PDF на несколько XAML с помощью Python" h2="Чтение, редактирование и экспорт данных Slides в другие форматы с помощью Cloud SDK с открытым исходным кодом для Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Разделение PDF на XAML с помощью Python" %}}
