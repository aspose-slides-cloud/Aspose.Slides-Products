---
title: Sostituisci il testo nelle presentazioni tramite Go
description: Sostituisci il testo nei file Slides con l'API REST e l'SDK Go open source
family: slides
platformtag: go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nelle presentazioni con Go" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file di presentazione con Go" %}}
