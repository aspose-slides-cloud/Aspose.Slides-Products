---
title: Unisci più presentazioni tramite Go
description: Unisci più presentazioni con l'API REST e l'SDK Go open source
family: slides
platformtag: go
feature: merge
platform: Go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più presentazioni con Go" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione delle presentazioni con Go" %}}
