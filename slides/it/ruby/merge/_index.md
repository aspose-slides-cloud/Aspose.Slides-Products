---
title: Unisci più presentazioni tramite Ruby
description: Unisci più presentazioni con l'API REST e l'SDK Ruby open source
family: slides
platformtag: ruby
feature: merge
platform: Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più presentazioni con Ruby" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione delle presentazioni con Ruby" %}}
