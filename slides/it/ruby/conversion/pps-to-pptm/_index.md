---
title: Converti da Slides PPS a PPTM tramite Ruby
description: Crea, modifica o converti file Slides PPS in PPTM con API REST e SDK Ruby open source
family: slides
platformtag: ruby
feature: conversion
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti PPS in PPTM con Ruby" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da PPS a PPTM con Ruby" %}}
