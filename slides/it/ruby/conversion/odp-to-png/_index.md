---
title: Converti da Slides ODP a PNG tramite Ruby
description: Crea, modifica o converti file Slides ODP in PNG con API REST e SDK Ruby open source
family: slides
platformtag: ruby
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti ODP in PNG con Ruby" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da ODP a PNG con Ruby" %}}
