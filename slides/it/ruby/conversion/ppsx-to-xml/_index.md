---
title: Converti da Slides PPSX a XML tramite Ruby
description: Crea, modifica o converti file Slides PPSX in XML con API REST e SDK Ruby open source
family: slides
platformtag: ruby
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti PPSX in XML con Ruby" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da PPSX a XML con Ruby" %}}
