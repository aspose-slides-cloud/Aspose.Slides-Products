---
title: Dividi Slides OTP in più BMP tramite Ruby
description: Dividi file Slides OTP in diapositive BMP con API REST e SDK Ruby open source
family: slides
platformtag: ruby
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividi OTP in più BMP con Ruby" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="OTP in BMP diviso con Ruby" %}}
