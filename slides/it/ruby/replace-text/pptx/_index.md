---
title: Sostituisci il testo nei file PPTX tramite Ruby
description: Sostituisci il testo nei file Slides PPTX con l'API REST e l'SD open source Ruby
family: slides
platformtag: ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nei file PPTX con Ruby" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file PPTX con Ruby" %}}
...
1. Chiama uno dei metodi di sostituzione del testo, a seconda di dove sono i tuoi file PPTX e se devi sostituire il testo nell'intero documento o in una singola diapositiva
