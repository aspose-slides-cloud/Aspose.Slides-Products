---
title: Sostituisci il testo nei file PPTX tramite C++
description: Sostituisci il testo nei file Slides PPTX con l'API REST e l'SD open source C++
family: slides
platformtag: cpp
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nei file PPTX con C++" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file PPTX con C++" %}}
