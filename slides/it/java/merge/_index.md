---
title: Unisci più presentazioni tramite Java
description: Unisci più presentazioni con l'API REST e l'SDK Java open source
family: slides
platformtag: java
feature: merge
platform: Java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più presentazioni con Java" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione delle presentazioni con Java" %}}
