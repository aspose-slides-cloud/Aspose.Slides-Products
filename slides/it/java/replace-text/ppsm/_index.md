---
title: Sostituisci il testo nei file PPSM tramite Java
description: Sostituisci il testo nei file Slides PPSM con l'API REST e l'SD open source Java
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nei file PPSM con Java" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file PPSM con Java" %}}
