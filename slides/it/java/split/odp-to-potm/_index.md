---
title: Dividi Slides ODP in più POTM tramite Java
description: Dividi file Slides ODP in diapositive POTM con API REST e SDK Java open source
family: slides
platformtag: java
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividi ODP in più POTM con Java" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODP in POTM diviso con Java" %}}
