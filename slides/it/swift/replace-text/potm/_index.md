---
title: Sostituisci il testo nei file POTM tramite Swift
description: Sostituisci il testo nei file Slides POTM con l'API REST e l'SD open source Swift
family: slides
platformtag: swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nei file POTM con Swift" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file POTM con Swift" %}}
...
1. Chiama uno dei metodi di sostituzione del testo, a seconda di dove sono i tuoi file POTM e se devi sostituire il testo nell'intero documento o in una singola diapositiva
