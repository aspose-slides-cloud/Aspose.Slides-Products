---
title: Sostituisci il testo nei file PPSM tramite Swift
description: Sostituisci il testo nei file Slides PPSM con l'API REST e l'SD open source Swift
family: slides
platformtag: swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nei file PPSM con Swift" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file PPSM con Swift" %}}
