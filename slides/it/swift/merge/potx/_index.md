---
title: Unisci più file POTX tramite Swift
description: Unisci più file Slides POTX con l'API REST e l'SDK Swift open source
family: slides
platformtag: swift
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più file POTX con Swift" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione di file POTX con Swift" %}}
