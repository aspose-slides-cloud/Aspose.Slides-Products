---
title: Converti da Slides PPSM a HTML5 tramite Swift
description: Crea, modifica o converti file Slides PPSM in HTML5 con API REST e SDK Swift open source
family: slides
platformtag: swift
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti PPSM in HTML5 con Swift" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da PPSM a HTML5 con Swift" %}}
