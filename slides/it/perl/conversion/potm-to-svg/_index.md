---
title: Converti da Slides POTM a SVG tramite Perl
description: Crea, modifica o converti file Slides POTM in SVG con API REST e SDK Perl open source
family: slides
platformtag: perl
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti POTM in SVG con Perl" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da POTM a SVG con Perl" %}}
