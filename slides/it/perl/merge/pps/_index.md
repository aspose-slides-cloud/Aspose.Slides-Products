---
title: Unisci più file PPS tramite Perl
description: Unisci più file Slides PPS con l'API REST e l'SDK Perl open source
family: slides
platformtag: perl
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più file PPS con Perl" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione di file PPS con Perl" %}}
