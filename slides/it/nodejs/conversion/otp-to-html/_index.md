---
title: Converti da Slides OTP a HTML tramite Node.js
description: Crea, modifica o converti file Slides OTP in HTML con API REST e SDK Node.js open source
family: slides
platformtag: nodejs
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti OTP in HTML con Node.js" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da OTP a HTML con Node.js" %}}
...
1. Chiama uno dei metodi di conversione, a seconda di dove si trova il file OTP di input e dove desideri archiviare il file HTML risultante
