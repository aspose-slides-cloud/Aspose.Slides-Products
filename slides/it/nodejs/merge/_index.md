---
title: Unisci più presentazioni tramite Node.js
description: Unisci più presentazioni con l'API REST e l'SDK Node.js open source
family: slides
platformtag: nodejs
feature: merge
platform: Node.js
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più presentazioni con Node.js" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione delle presentazioni con Node.js" %}}
