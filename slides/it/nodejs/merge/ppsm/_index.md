---
title: Unisci più file PPSM tramite Node.js
description: Unisci più file Slides PPSM con l'API REST e l'SDK Node.js open source
family: slides
platformtag: nodejs
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più file PPSM con Node.js" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione di file PPSM con Node.js" %}}
...
1. Chiama uno dei metodi di unione, a seconda di dove si trovano i file PPSM di input, dove desideri archiviare il file unito e se devi unire parti di file
