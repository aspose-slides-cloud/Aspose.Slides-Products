---
title: Sostituisci il testo nelle presentazioni tramite Node.js
description: Sostituisci il testo nei file Slides con l'API REST e l'SDK Node.js open source
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nelle presentazioni con Node.js" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file di presentazione con Node.js" %}}
