---
title: Sostituisci il testo nei file PPT tramite Node.js
description: Sostituisci il testo nei file Slides PPT con l'API REST e l'SD open source Node.js
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nei file PPT con Node.js" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file PPT con Node.js" %}}
...
1. Chiama uno dei metodi di sostituzione del testo, a seconda di dove sono i tuoi file PPT e se devi sostituire il testo nell'intero documento o in una singola diapositiva
