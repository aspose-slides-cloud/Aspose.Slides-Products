---
title: SDK per la creazione di presentazioni Node.js per il cloud | API RESTful
description: API REST Node.js facile da integrare e da usare per creare, copiare, unire, dividere, scaricare e convertire diapositive PowerPoint e OpenOffice nel cloud
weight: 80
family: slides
platform: Node.js
---
...
{{< blocks/products/pf/i18n/upper-banner h1="SDK REST Node.js per elaborare le diapositive nel cloud" h2="API REST Node.js semplice da integrare e facile da usare per creare, copiare, unire, dividere, scaricare e convertire diapositive PowerPoint e OpenOffice nel cloud." logoImageSrc="/headers/aspose_slides-for-node.svg" pfName="Aspose.Slides" subTitlepfName="SDK Cloud per Node.js" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="SDK Cloud per Node.js" >}}
...
<p>Aspose.Slides Cloud SDK per Node.js aiuta le tue applicazioni basate su cloud Node.js ad accedere alle presentazioni PowerPoint e OpenOffice ospitate nell'archivio cloud per elaborare e convertire da PPT, PPTX, ODP, OTP a SWF, HTML, PDF, XPS, PDF/A, JPEG, SVG, TIFF, BMP e PNG.</p>
<p>Aspose.Slides Cloud SDK per Node.js consente al codice Node.js di dividere presentazioni PowerPoint, unire diapositive di presentazione, nonché copiare, spostare o eliminare diapositive. Utilizza semplici comandi Node.js per ottenere carattere, formato e combinazione di colori delle presentazioni situate sul cloud. Leggi le informazioni sulla diapositiva master e clonala. Aggiorna la sequenza principale delle animazioni delle diapositive. Estrai forme, note e immagini dalle diapositive della presentazione.</p>
<p>Aspose.Slides Cloud SDK per Node.js è un wrapper attorno all'API REST Aspose.Slides e questo SDK cloud per la manipolazione delle presentazioni PowerPoint è disponibile con la licenza MIT.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-node.png" alt="SDK Node.js PowerPoint Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>per </em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-node.png" alt="Node.js Cloud SDK per presentazioni"><header>Aspose.Slides</header><footer>Cloud <small> <em>per </em> </small>Node.js</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
      È facile iniziare con Aspose.Slides Cloud SDK per Node.js poiché non è necessario installare nulla. Crea semplicemente un account su
      <a href="https://dashboard.aspose.cloud/#/apps">
        Aspose per Cloud
      </a>
      e ottieni le informazioni sulla tua richiesta. Una volta ottenuto il SID e la chiave dell'app, sei pronto per provare Aspose.Slides Cloud SDK per Node.js su qualsiasi piattaforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Codice sorgente" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Node.js" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Slides Cloud SDK per Node.js?" tabId="success-stories" >}}
