---
title: Converti da Slides POTM a GIF tramite Android
description: Crea, modifica o converti file Slides POTM in GIF con API REST e SDK Android open source
family: slides
platformtag: android
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti POTM in GIF con Android" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da POTM a GIF con Android" %}}
...
1. Chiama uno dei metodi di conversione, a seconda di dove si trova il file POTM di input e dove desideri archiviare il file GIF risultante
