---
title: Unisci più file OTP tramite Android
description: Unisci più file Slides OTP con l'API REST e l'SDK Android open source
family: slides
platformtag: android
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più file OTP con Android" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione di file OTP con Android" %}}
...
1. Chiama uno dei metodi di unione, a seconda di dove si trovano i file OTP di input, dove desideri archiviare il file unito e se devi unire parti di file
