---
title: Sostituisci il testo nelle presentazioni tramite Android
description: Sostituisci il testo nei file Slides con l'API REST e l'SDK Android open source
family: slides
platformtag: android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nelle presentazioni con Android" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file di presentazione con Android" %}}
