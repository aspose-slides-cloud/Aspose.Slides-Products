---
title: Sostituisci il testo nei file PPT tramite Android
description: Sostituisci il testo nei file Slides PPT con l'API REST e l'SD open source Android
family: slides
platformtag: android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nei file PPT con Android" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file PPT con Android" %}}
