---
title: Sostituisci il testo nei file POTX tramite cURL
description: Sostituisci il testo nei file Slides POTX con l'API REST e l'SD open source cURL
family: slides
platformtag: curl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nei file POTX con cURL" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file POTX con cURL" %}}
