---
title: Unisci più presentazioni tramite cURL
description: Unisci più presentazioni con l'API REST e l'SDK cURL open source
family: slides
platformtag: curl
feature: merge
platform: cURL
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più presentazioni con cURL" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione delle presentazioni con cURL" %}}
