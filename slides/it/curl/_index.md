---
title: Crea, unisci, dividi e converti diapositive di PowerPoint tramite cURL
description: Esegui la creazione, l'elaborazione, l'unione e la conversione di diapositive di presentazioni PowerPoint e OpenOffice tramite semplici comandi cURL tramite API REST
weight: 40
family: slides
platform: cURL
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Crea app per la creazione di presentazioni e convertitori PPT tramite cURL" h2="Esegui la creazione, l'elaborazione, l'unione e la conversione di diapositive di presentazioni PowerPoint e OpenOffice tramite semplici comandi cURL tramite API REST." logoImageSrc="/headers/aspose_slides-for-curl.svg" pfName="Aspose.Slides" subTitlepfName="Cloud per cURL" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Cloud per cURL" >}}
...
<p>Aspose.Slides Cloud per cURL ti consente di convertire presentazioni e diapositive PowerPoint e OpenOffice in altri formati supportati. Ad esempio, puoi convertire PPT in PDF, BMP, PNG, SVG, TIFF, JPEG, SWF e HTML. Puoi eseguire varie operazioni su diapositive di presentazione, temi di presentazione, note di diapositiva, immagini di diapositive, diapositive master, caratteri personalizzati e varie altre proprietà dei documenti di presentazione di Microsoft PowerPoint e OpenOffice.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="cURL Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>per </em> </small>cURL</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="cURL Cloud per presentazioni"><header>Aspose.Slides</header><footer>Cloud <small> <em>per </em> </small>cURL</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
      È facile iniziare con Aspose.Slides Cloud per cURL poiché non è necessario installare nulla. Crea semplicemente un account su
      <a href="https://dashboard.aspose.cloud/#/apps">
        Aspose per Cloud
      </a>
      e ottieni le informazioni sulla tua richiesta. Una volta ottenuto il SID e la chiave dell'app, sei pronto per provare Aspose.Slides Cloud per cURL su qualsiasi piattaforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides Cloud per cURL consente agli sviluppatori di creare nuove forme per le diapositive di presentazione. Puoi leggere e aggiornare le informazioni sulle proprietà per le forme di diapositiva esistenti. Ti consente inoltre di eseguire il rendering delle forme delle diapositive nei formati di immagine supportati. Aspose.Slides Cloud per cURL ti aiuta anche a lavorare con le note delle diapositive della presentazione.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Perché Aspose.Slides Cloud per cURL?" tabId="success-stories" >}}
