---
title: Dividi Slides OTP in più PPSX tramite cURL
description: Dividi file Slides OTP in diapositive PPSX con API REST e SDK cURL open source
family: slides
platformtag: curl
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividi OTP in più PPSX con cURL" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="OTP in PPSX diviso con cURL" %}}
