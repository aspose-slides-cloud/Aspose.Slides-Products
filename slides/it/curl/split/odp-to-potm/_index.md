---
title: Dividi Slides ODP in più POTM tramite cURL
description: Dividi file Slides ODP in diapositive POTM con API REST e SDK cURL open source
family: slides
platformtag: curl
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividi ODP in più POTM con cURL" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODP in POTM diviso con cURL" %}}
