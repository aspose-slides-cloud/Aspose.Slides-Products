---
title: Dividi Slides ODP in più XPS tramite cURL
description: Dividi file Slides ODP in diapositive XPS con API REST e SDK cURL open source
family: slides
platformtag: curl
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividi ODP in più XPS con cURL" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ODP in XPS diviso con cURL" %}}
