---
title: Converti da Slides POTX a PNG tramite cURL
description: Crea, modifica o converti file Slides POTX in PNG con API REST e SDK cURL open source
family: slides
platformtag: curl
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti POTX in PNG con cURL" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversione da POTX a PNG con cURL" %}}
