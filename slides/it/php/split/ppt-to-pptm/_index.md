---
title: Dividi Slides PPT in più PPTM tramite PHP
description: Dividi file Slides PPT in diapositive PPTM con API REST e SDK PHP open source
family: slides
platformtag: php
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividi PPT in più PPTM con PHP" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPT in PPTM diviso con PHP" %}}
