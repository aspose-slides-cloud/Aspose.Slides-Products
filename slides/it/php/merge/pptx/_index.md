---
title: Unisci più file PPTX tramite PHP
description: Unisci più file Slides PPTX con l'API REST e l'SDK PHP open source
family: slides
platformtag: php
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più file PPTX con PHP" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione di file PPTX con PHP" %}}
