---
title: Unisci più file PPTM tramite PHP
description: Unisci più file Slides PPTM con l'API REST e l'SDK PHP open source
family: slides
platformtag: php
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più file PPTM con PHP" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione di file PPTM con PHP" %}}
