---
title: Unisci più file PPSM tramite Python
description: Unisci più file Slides PPSM con l'API REST e l'SDK Python open source
family: slides
platformtag: python
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Unisci più file PPSM con Python" h2="Leggi, modifica ed esporta i dati di Slides in altri formati con Cloud SDK open source per Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Unione di file PPSM con Python" %}}
