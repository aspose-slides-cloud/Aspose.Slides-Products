---
title: Sostituisci il testo nei file PPSM tramite Python
description: Sostituisci il testo nei file Slides PPSM con l'API REST e l'SD open source Python
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Sostituisci il testo nei file PPSM con Python" h2="Trova e sostituisci le occorrenze di testo nei dati di Slides con Cloud SDK open source per Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Sostituzione del testo nei file PPSM con Python" %}}
