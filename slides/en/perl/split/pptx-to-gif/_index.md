---
title: Split Slides PPTX into multiple GIF via Perl
description: Split Slides PPTX files into GIF slides with REST API & Open Source Perl SDK
family: slides
platformtag: perl
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPTX into multiple GIF with Perl" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTX into GIF Split with Perl" %}}
