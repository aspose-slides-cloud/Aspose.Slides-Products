---
title: Replace text in PPSX files via Perl
description: Replace text in Slides PPSX files with REST API & Open Source Perl SDK
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in PPSX files with Perl" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in PPSX Files with Perl" %}}
