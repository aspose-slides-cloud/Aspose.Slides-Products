---
title: Replace text in presentations via Perl
description: Replace text in Slides files with REST API & Open Source Perl SDK
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in presentations with Perl" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in presentation files with Perl" %}}
...
1. Call one of the text replacement methods, depending where are your presentations, and whether you need to replace text in the entire document or in a single slide
    ...
    - ```replace_presentation_text_online``` to replace all occurrences of given text with another in all slides of a presentation file uploaded in request body.
    - ```replace_slide_text_online``` to replace all occurrences of given text with another in one slide of a presentation file uploaded in request body.
