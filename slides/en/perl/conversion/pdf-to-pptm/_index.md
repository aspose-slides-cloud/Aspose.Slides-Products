---
title: Convert from Slides PDF to PPTM via Perl 
description: Create, Edit or Convert Slides PDF files to PPTM with REST API & Open Source Perl SDK
family: slides
platformtag: perl
feature: conversion
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PDF to PPTM with Perl" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PDF to PPTM Conversion with Perl" %}}
