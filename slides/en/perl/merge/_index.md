---
title: Merge multiple presentations via Perl
description: Merge multiple presentations with REST API & Open Source Perl SDK
family: slides
platformtag: perl
feature: merge
platform: Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple presentations with Perl" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging presentations with Perl" %}}
