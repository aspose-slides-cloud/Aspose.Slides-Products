---
title: Merge multiple PPSM files via Perl
description: Merge multiple Slides PPSM files with REST API & Open Source Perl SDK
family: slides
platformtag: perl
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPSM files with Perl" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPSM Files with Perl" %}}
