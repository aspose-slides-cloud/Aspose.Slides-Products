---
title: Replace text in ODP files via .NET
description: Replace text in Slides ODP files with REST API & Open Source .NET SDK
family: slides
platformtag: net
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in ODP files with .NET" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in ODP Files with .NET" %}}
