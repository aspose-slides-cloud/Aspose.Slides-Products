---
title: Split Slides HTML into multiple PPTM via .NET
description: Split Slides HTML files into PPTM slides with REST API & Open Source .NET SDK
family: slides
platformtag: net
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split HTML into multiple PPTM with .NET" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML into PPTM Split with .NET" %}}
