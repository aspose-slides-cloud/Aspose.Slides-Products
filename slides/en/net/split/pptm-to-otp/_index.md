---
title: Split Slides PPTM into multiple OTP via .NET
description: Split Slides PPTM files into OTP slides with REST API & Open Source .NET SDK
family: slides
platformtag: net
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPTM into multiple OTP with .NET" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM into OTP Split with .NET" %}}
