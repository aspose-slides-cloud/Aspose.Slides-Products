---
title: Split Slides POTX into multiple POTM via .NET
description: Split Slides POTX files into POTM slides with REST API & Open Source .NET SDK
family: slides
platformtag: net
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split POTX into multiple POTM with .NET" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX into POTM Split with .NET" %}}
