---
title: Split Slides PPTX into multiple GIF via .NET
description: Split Slides PPTX files into GIF slides with REST API & Open Source .NET SDK
family: slides
platformtag: net
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPTX into multiple GIF with .NET" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTX into GIF Split with .NET" %}}
