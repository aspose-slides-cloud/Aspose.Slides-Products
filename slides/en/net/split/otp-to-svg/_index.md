---
title: Split Slides OTP into multiple SVG via .NET
description: Split Slides OTP files into SVG slides with REST API & Open Source .NET SDK
family: slides
platformtag: net
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split OTP into multiple SVG with .NET" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="OTP into SVG Split with .NET" %}}
