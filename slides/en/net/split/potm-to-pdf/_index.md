---
title: Split Slides POTM into multiple PDF via .NET
description: Split Slides POTM files into PDF slides with REST API & Open Source .NET SDK
family: slides
platformtag: net
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split POTM into multiple PDF with .NET" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTM into PDF Split with .NET" %}}
