---
title: Merge multiple ODP files via .NET
description: Merge multiple Slides ODP files with REST API & Open Source .NET SDK
family: slides
platformtag: net
feature: merge
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple ODP files with .NET" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging ODP Files with .NET" %}}
