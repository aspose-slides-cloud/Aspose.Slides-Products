---
title: Merge multiple presentations via .NET
description: Merge multiple presentations with REST API & Open Source .NET SDK
family: slides
platformtag: net
feature: merge
platform: .NET
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple presentations with .NET" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging presentations with .NET" %}}
