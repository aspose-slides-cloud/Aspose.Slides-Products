---
title: Merge multiple PPTX files via Python
description: Merge multiple Slides PPTX files with REST API & Open Source Python SDK
family: slides
platformtag: python
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPTX files with Python" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPTX Files with Python" %}}
