---
title: Merge multiple HTML files via Python
description: Merge multiple Slides HTML files with REST API & Open Source Python SDK
family: slides
platformtag: python
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple HTML files with Python" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging HTML Files with Python" %}}
1. Create an account at <a href="https://dashboard.aspose.cloud/">Dashboard</a> to get free API quota & authorization details
1. Initialize ```SlidesApi``` with Client Id and Client Secret
1. Call one of the merge methods, depending where are your input HTML files, where you want to store the merged file, and whether you need to merge parts of files
