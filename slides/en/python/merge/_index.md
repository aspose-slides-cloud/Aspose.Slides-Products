---
title: Merge multiple presentations via Python
description: Merge multiple presentations with REST API & Open Source Python SDK
family: slides
platformtag: python
feature: merge
platform: Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple presentations with Python" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging presentations with Python" %}}
