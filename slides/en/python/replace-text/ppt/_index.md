---
title: Replace text in PPT files via Python
description: Replace text in Slides PPT files with REST API & Open Source Python SDK
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in PPT files with Python" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in PPT Files with Python" %}}
