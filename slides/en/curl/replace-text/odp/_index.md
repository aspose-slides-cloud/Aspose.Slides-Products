---
title: Replace text in ODP files via cURL
description: Replace text in Slides ODP files with REST API & Open Source cURL SDK
family: slides
platformtag: curl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in ODP files with cURL" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in ODP Files with cURL" %}}
