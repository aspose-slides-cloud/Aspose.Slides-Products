---
title: Split Slides HTML into multiple PPTM via cURL
description: Split Slides HTML files into PPTM slides with REST API & Open Source cURL SDK
family: slides
platformtag: curl
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split HTML into multiple PPTM with cURL" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML into PPTM Split with cURL" %}}
