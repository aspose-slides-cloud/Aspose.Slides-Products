---
title: Convert from Slides PDF to OTP via cURL 
description: Create, Edit or Convert Slides PDF files to OTP with REST API & Open Source cURL SDK
family: slides
platformtag: curl
feature: conversion
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PDF to OTP with cURL" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PDF to OTP Conversion with cURL" %}}
