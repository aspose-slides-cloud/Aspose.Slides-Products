---
title: Convert from Slides OTP to MD via cURL 
description: Create, Edit or Convert Slides OTP files to MD with REST API & Open Source cURL SDK
family: slides
platformtag: curl
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert OTP to MD with cURL" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="OTP to MD Conversion with cURL" %}}
