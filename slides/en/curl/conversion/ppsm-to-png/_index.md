---
title: Convert from Slides PPSM to PNG via cURL 
description: Create, Edit or Convert Slides PPSM files to PNG with REST API & Open Source cURL SDK
family: slides
platformtag: curl
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PPSM to PNG with cURL" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSM to PNG Conversion with cURL" %}}
