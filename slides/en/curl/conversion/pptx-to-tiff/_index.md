---
title: Convert from Slides PPTX to TIFF via cURL 
description: Create, Edit or Convert Slides PPTX files to TIFF with REST API & Open Source cURL SDK
family: slides
platformtag: curl
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PPTX to TIFF with cURL" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTX to TIFF Conversion with cURL" %}}
