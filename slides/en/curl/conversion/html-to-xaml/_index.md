---
title: Convert from Slides HTML to XAML via cURL 
description: Create, Edit or Convert Slides HTML files to XAML with REST API & Open Source cURL SDK
family: slides
platformtag: curl
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert HTML to XAML with cURL" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML to XAML Conversion with cURL" %}}
