---
title: Convert from Slides PPTM to JPEG via cURL 
description: Create, Edit or Convert Slides PPTM files to JPEG with REST API & Open Source cURL SDK
family: slides
platformtag: curl
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PPTM to JPEG with cURL" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM to JPEG Conversion with cURL" %}}
