---
title: Merge multiple PDF files via Swift
description: Merge multiple Slides PDF files with REST API & Open Source Swift SDK
family: slides
platformtag: swift
feature: merge
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PDF files with Swift" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PDF Files with Swift" %}}
