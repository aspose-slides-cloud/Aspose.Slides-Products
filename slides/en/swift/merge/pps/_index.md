---
title: Merge multiple PPS files via Swift
description: Merge multiple Slides PPS files with REST API & Open Source Swift SDK
family: slides
platformtag: swift
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPS files with Swift" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPS Files with Swift" %}}
