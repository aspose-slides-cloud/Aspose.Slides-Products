---
title: Merge multiple PPSX files via Swift
description: Merge multiple Slides PPSX files with REST API & Open Source Swift SDK
family: slides
platformtag: swift
feature: merge
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPSX files with Swift" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPSX Files with Swift" %}}
