---
title: Split Slides PPS into multiple PPSX via Swift
description: Split Slides PPS files into PPSX slides with REST API & Open Source Swift SDK
family: slides
platformtag: swift
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPS into multiple PPSX with Swift" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPS into PPSX Split with Swift" %}}
