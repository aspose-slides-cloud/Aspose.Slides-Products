---
title: Split Slides POTM into multiple PPT via Swift
description: Split Slides POTM files into PPT slides with REST API & Open Source Swift SDK
family: slides
platformtag: swift
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split POTM into multiple PPT with Swift" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTM into PPT Split with Swift" %}}
