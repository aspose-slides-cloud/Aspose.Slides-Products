---
title: Split Slides PDF into multiple PDF via Swift
description: Split Slides PDF files into PDF slides with REST API & Open Source Swift SDK
family: slides
platformtag: swift
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PDF into multiple PDF with Swift" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PDF into PDF Split with Swift" %}}
