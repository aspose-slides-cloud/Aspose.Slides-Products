---
title: Split Slides HTML into multiple PPTM via Swift
description: Split Slides HTML files into PPTM slides with REST API & Open Source Swift SDK
family: slides
platformtag: swift
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split HTML into multiple PPTM with Swift" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML into PPTM Split with Swift" %}}
