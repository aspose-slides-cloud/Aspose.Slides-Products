---
title: Merge multiple presentations via PHP
description: Merge multiple presentations with REST API & Open Source PHP SDK
family: slides
platformtag: php
feature: merge
platform: PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple presentations with PHP" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging presentations with PHP" %}}
