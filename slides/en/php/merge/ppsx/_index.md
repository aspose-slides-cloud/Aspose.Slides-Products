---
title: Merge multiple PPSX files via PHP
description: Merge multiple Slides PPSX files with REST API & Open Source PHP SDK
family: slides
platformtag: php
feature: merge
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPSX files with PHP" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPSX Files with PHP" %}}
