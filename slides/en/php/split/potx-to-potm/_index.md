---
title: Split Slides POTX into multiple POTM via PHP
description: Split Slides POTX files into POTM slides with REST API & Open Source PHP SDK
family: slides
platformtag: php
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split POTX into multiple POTM with PHP" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX into POTM Split with PHP" %}}
