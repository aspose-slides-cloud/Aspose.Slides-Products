---
title: Split Slides PPTM into multiple TIFF via PHP
description: Split Slides PPTM files into TIFF slides with REST API & Open Source PHP SDK
family: slides
platformtag: php
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPTM into multiple TIFF with PHP" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM into TIFF Split with PHP" %}}
