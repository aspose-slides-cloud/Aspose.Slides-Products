---
title: Split Slides PPT into multiple ODP via PHP
description: Split Slides PPT files into ODP slides with REST API & Open Source PHP SDK
family: slides
platformtag: php
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPT into multiple ODP with PHP" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPT into ODP Split with PHP" %}}
