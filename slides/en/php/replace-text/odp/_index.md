---
title: Replace text in ODP files via PHP
description: Replace text in Slides ODP files with REST API & Open Source PHP SDK
family: slides
platformtag: php
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in ODP files with PHP" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in ODP Files with PHP" %}}
