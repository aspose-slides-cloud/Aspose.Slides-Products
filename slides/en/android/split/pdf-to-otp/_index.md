---
title: Split Slides PDF into multiple OTP via Android
description: Split Slides PDF files into OTP slides with REST API & Open Source Android SDK
family: slides
platformtag: android
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PDF into multiple OTP with Android" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PDF into OTP Split with Android" %}}
