---
title: Split Slides PPT into multiple PPT via Android
description: Split Slides PPT files into PPT slides with REST API & Open Source Android SDK
family: slides
platformtag: android
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPT into multiple PPT with Android" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPT into PPT Split with Android" %}}
