---
title: Split Slides PPTM into multiple POTX via Android
description: Split Slides PPTM files into POTX slides with REST API & Open Source Android SDK
family: slides
platformtag: android
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPTM into multiple POTX with Android" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM into POTX Split with Android" %}}
