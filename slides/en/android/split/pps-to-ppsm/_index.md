---
title: Split Slides PPS into multiple PPSM via Android
description: Split Slides PPS files into PPSM slides with REST API & Open Source Android SDK
family: slides
platformtag: android
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPS into multiple PPSM with Android" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPS into PPSM Split with Android" %}}
