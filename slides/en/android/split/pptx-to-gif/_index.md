---
title: Split Slides PPTX into multiple GIF via Android
description: Split Slides PPTX files into GIF slides with REST API & Open Source Android SDK
family: slides
platformtag: android
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPTX into multiple GIF with Android" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTX into GIF Split with Android" %}}
