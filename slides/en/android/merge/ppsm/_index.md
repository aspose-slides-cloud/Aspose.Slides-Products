---
title: Merge multiple PPSM files via Android
description: Merge multiple Slides PPSM files with REST API & Open Source Android SDK
family: slides
platformtag: android
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPSM files with Android" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPSM Files with Android" %}}
