---
title: Merge multiple OTP files via Android
description: Merge multiple Slides OTP files with REST API & Open Source Android SDK
family: slides
platformtag: android
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple OTP files with Android" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging OTP Files with Android" %}}
1. Create an account at <a href="https://dashboard.aspose.cloud/">Dashboard</a> to get free API quota & authorization details
1. Initialize ```SlidesApi``` with Client Id and Client Secret
1. Call one of the merge methods, depending where are your input OTP files, where you want to store the merged file, and whether you need to merge parts of files
