---
title: Merge multiple POTM files via Android
description: Merge multiple Slides POTM files with REST API & Open Source Android SDK
family: slides
platformtag: android
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple POTM files with Android" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging POTM Files with Android" %}}
