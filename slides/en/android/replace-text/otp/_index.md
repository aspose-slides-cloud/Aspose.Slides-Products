---
title: Replace text in OTP files via Android
description: Replace text in Slides OTP files with REST API & Open Source Android SDK
family: slides
platformtag: android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in OTP files with Android" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in OTP Files with Android" %}}
