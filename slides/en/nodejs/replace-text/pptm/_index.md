---
title: Replace text in PPTM files via Node.js
description: Replace text in Slides PPTM files with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in PPTM files with Node.js" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in PPTM Files with Node.js" %}}
