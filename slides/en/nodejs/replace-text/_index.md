---
title: Replace text in presentations via Node.js
description: Replace text in Slides files with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in presentations with Node.js" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in presentation files with Node.js" %}}
