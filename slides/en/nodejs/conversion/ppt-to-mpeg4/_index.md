---
title: Convert from Slides PPT to MPEG4 via Node.js 
description: Create, Edit or Convert Slides PPT files to MPEG4 with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PPT to MPEG4 with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPT to MPEG4 Conversion with Node.js" %}}
