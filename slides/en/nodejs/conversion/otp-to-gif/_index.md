---
title: Convert from Slides OTP to GIF via Node.js 
description: Create, Edit or Convert Slides OTP files to GIF with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert OTP to GIF with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="OTP to GIF Conversion with Node.js" %}}
