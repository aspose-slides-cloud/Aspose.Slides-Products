---
title: Convert from Slides PPSX to PPS via Node.js 
description: Create, Edit or Convert Slides PPSX files to PPS with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PPSX to PPS with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSX to PPS Conversion with Node.js" %}}
