---
title: Split Slides PPTM into multiple TIFF via Node.js
description: Split Slides PPTM files into TIFF slides with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPTM into multiple TIFF with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM into TIFF Split with Node.js" %}}
