---
title: Split Slides OTP into multiple SVG via Node.js
description: Split Slides OTP files into SVG slides with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split OTP into multiple SVG with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="OTP into SVG Split with Node.js" %}}
