---
title: Split Slides PPSX into multiple JPEG via Node.js
description: Split Slides PPSX files into JPEG slides with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPSX into multiple JPEG with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSX into JPEG Split with Node.js" %}}
