---
title: Split Slides PPS into multiple POTX via Node.js
description: Split Slides PPS files into POTX slides with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPS into multiple POTX with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPS into POTX Split with Node.js" %}}
