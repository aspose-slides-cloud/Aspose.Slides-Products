...
description: Merge multiple Slides PPS files with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: merge
informat: PPS
...
{{% blocks/products/pf/agp/feature-section-col title="Merging PPS Files with Node.js" %}}
