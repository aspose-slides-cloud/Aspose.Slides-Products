---
title: Merge multiple PPT files via Node.js
description: Merge multiple Slides PPT files with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPT files with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPT Files with Node.js" %}}
