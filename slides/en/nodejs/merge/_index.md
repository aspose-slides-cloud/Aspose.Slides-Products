---
title: Merge multiple presentations via Node.js
description: Merge multiple presentations with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: merge
platform: Node.js
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple presentations with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging presentations with Node.js" %}}
