---
title: Merge multiple HTML files via Node.js
description: Merge multiple Slides HTML files with REST API & Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple HTML files with Node.js" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging HTML Files with Node.js" %}}
