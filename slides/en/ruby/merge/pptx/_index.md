---
title: Merge multiple PPTX files via Ruby
description: Merge multiple Slides PPTX files with REST API & Open Source Ruby SDK
family: slides
platformtag: ruby
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPTX files with Ruby" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPTX Files with Ruby" %}}
