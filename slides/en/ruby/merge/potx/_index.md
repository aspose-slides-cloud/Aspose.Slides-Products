---
title: Merge multiple POTX files via Ruby
description: Merge multiple Slides POTX files with REST API & Open Source Ruby SDK
family: slides
platformtag: ruby
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple POTX files with Ruby" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging POTX Files with Ruby" %}}
