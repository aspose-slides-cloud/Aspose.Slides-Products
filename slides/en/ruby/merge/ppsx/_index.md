...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPSX files with Ruby" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPSX Files with Ruby" %}}
