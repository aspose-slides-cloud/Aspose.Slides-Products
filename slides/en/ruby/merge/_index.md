---
title: Merge multiple presentations via Ruby
description: Merge multiple presentations with REST API & Open Source Ruby SDK
family: slides
platformtag: ruby
feature: merge
platform: Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple presentations with Ruby" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging presentations with Ruby" %}}
