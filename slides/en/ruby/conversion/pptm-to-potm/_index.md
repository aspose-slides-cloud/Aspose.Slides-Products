---
title: Convert from Slides PPTM to POTM via Ruby 
description: Create, Edit or Convert Slides PPTM files to POTM with REST API & Open Source Ruby SDK
family: slides
platformtag: ruby
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PPTM to POTM with Ruby" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM to POTM Conversion with Ruby" %}}
