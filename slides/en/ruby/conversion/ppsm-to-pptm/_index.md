---
title: Convert from Slides PPSM to PPTM via Ruby 
description: Create, Edit or Convert Slides PPSM files to PPTM with REST API & Open Source Ruby SDK
family: slides
platformtag: ruby
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PPSM to PPTM with Ruby" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSM to PPTM Conversion with Ruby" %}}
