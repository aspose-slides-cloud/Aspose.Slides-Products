---
title: Split Slides PPTM into multiple PPSM via Ruby
description: Split Slides PPTM files into PPSM slides with REST API & Open Source Ruby SDK
family: slides
platformtag: ruby
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPTM into multiple PPSM with Ruby" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM into PPSM Split with Ruby" %}}
