---
title: Split Slides PDF into multiple POTM via Ruby
description: Split Slides PDF files into POTM slides with REST API & Open Source Ruby SDK
family: slides
platformtag: ruby
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PDF into multiple POTM with Ruby" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PDF into POTM Split with Ruby" %}}
