---
title: Merge multiple PPT files via C++
description: Merge multiple Slides PPT files with REST API & Open Source C++ SDK
family: slides
platformtag: cpp
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple PPT files with C++" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging PPT Files with C++" %}}
