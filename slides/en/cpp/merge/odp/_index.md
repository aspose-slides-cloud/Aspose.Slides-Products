---
title: Merge multiple ODP files via C++
description: Merge multiple Slides ODP files with REST API & Open Source C++ SDK
family: slides
platformtag: cpp
feature: merge
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple ODP files with C++" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for C++">}}
