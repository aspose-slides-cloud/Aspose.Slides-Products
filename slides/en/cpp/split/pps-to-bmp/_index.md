---
title: Split Slides PPS into multiple BMP via C++
description: Split Slides PPS files into BMP slides with REST API & Open Source C++ SDK
family: slides
platformtag: cpp
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPS into multiple BMP with C++" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPS into BMP Split with C++" %}}
