---
title: Split Slides PPSX into multiple JPEG via C++
description: Split Slides PPSX files into JPEG slides with REST API & Open Source C++ SDK
family: slides
platformtag: cpp
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split PPSX into multiple JPEG with C++" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSX into JPEG Split with C++" %}}
