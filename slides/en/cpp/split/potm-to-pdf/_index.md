---
title: Split Slides POTM into multiple PDF via C++
description: Split Slides POTM files into PDF slides with REST API & Open Source C++ SDK
family: slides
platformtag: cpp
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split POTM into multiple PDF with C++" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTM into PDF Split with C++" %}}
