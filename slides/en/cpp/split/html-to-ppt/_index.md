---
title: Split Slides HTML into multiple PPT via C++
description: Split Slides HTML files into PPT slides with REST API & Open Source C++ SDK
family: slides
platformtag: cpp
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Split HTML into multiple PPT with C++" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML into PPT Split with C++" %}}
