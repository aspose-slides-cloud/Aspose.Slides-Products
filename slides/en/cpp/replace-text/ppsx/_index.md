---
title: Replace text in PPSX files via C++
description: Replace text in Slides PPSX files with REST API & Open Source C++ SDK
family: slides
platformtag: cpp
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in PPSX files with C++" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in PPSX Files with C++" %}}
