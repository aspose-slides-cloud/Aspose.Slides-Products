---
title: Replace text in PPS files via C++
description: Replace text in Slides PPS files with REST API & Open Source C++ SDK
family: slides
platformtag: cpp
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in PPS files with C++" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in PPS Files with C++" %}}
