---
title: Merge multiple POTM files via Java
description: Merge multiple Slides POTM files with REST API & Open Source Java SDK
family: slides
platformtag: java
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Merge multiple POTM files with Java" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Merging POTM Files with Java" %}}
