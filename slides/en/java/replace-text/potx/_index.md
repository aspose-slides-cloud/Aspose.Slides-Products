---
title: Replace text in POTX files via Java
description: Replace text in Slides POTX files with REST API & Open Source Java SDK
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Replace text in POTX files with Java" h2="Find & Replace occurrences of text in Slides data with open source Cloud SDK for Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Replacing Text in POTX Files with Java" %}}
