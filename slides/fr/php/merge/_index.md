---
title: Fusionner plusieurs présentations via PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs présentations avec PHP" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusionner des présentations avec PHP" %}}
