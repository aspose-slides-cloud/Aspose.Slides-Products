---
title: Construire un visualiseur et un convertisseur de diapositives PPT PPTX via PHP REST SDK
description: Récupérez des présentations PowerPoint et OpenOffice à partir du stockage cloud pour afficher, fusionner, diviser et convertir des diapositives dans le cloud
weight: 100
family: slides
platform: PHP
---
...
{{< blocks/products/pf/i18n/upper-banner h1="PHP Cloud SDK pour traiter les diapositives de présentation" h2="Récupérez des présentations PowerPoint et OpenOffice à partir du stockage cloud pour afficher, fusionner, diviser et convertir des diapositives dans le cloud." logoImageSrc="/headers/aspose_slides-for-php.svg" pfName="Aspose.Slides" subTitlepfName="SDK Cloud pour PHP" downloadUrl="" >}}
...
<p>En utilisant Aspose.Slides Cloud SDK pour PHP, vos programmes PHP cloud pourraient créer de nouvelles présentations ou accéder à des présentations existantes situées dans le stockage cloud. Via notre SDK PHP REST, vous pouvez travailler avec l'ensemble de la présentation, modifier des diapositives individuelles, cloner la diapositive principale, mettre à jour la séquence interactive de la présentation PowerPoint et spécifier les polices personnalisées à utiliser dans la présentation.</p>
<p>Aspose.Slides Cloud SDK pour PHP aide votre code PHP à extraire des formes, des images et des notes à partir de diapositives de présentation. Vous pouvez également convertir PPTX, PPT, ODP et OTP aux formats SWF, HTML, BMP, PNG, TIFF, JPEG, SVG.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="SDK PHP pour les présentations"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Il est facile de démarrer avec Aspose.Slides Cloud PHP SDK car vous n'avez besoin de rien à installer. Créez simplement un compte sur
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 et obtenez les informations de votre application. Une fois que vous avez l'App SID &amp; clé, vous êtes prêt à essayer le SDK PHP Aspose.Slides Cloud sur n'importe quelle plate-forme.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Slides Cloud SDK pour PHP ?" tabId="success-stories" >}}
