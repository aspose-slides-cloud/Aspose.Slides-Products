---
title: Diviser Slides POTX en plusieurs HTML5 via PHP
description: Divisez les fichiers Slides POTX en diapositives HTML5 avec l'API REST et le SDK Open Source PHP
family: slides
platformtag: php
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser POTX en plusieurs HTML5 avec PHP" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation POTX en HTML5 avec PHP" %}}
