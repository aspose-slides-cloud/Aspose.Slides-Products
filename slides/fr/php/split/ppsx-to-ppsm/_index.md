---
title: Diviser Slides PPSX en plusieurs PPSM via PHP
description: Divisez les fichiers Slides PPSX en diapositives PPSM avec l'API REST et le SDK Open Source PHP
family: slides
platformtag: php
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPSX en plusieurs PPSM avec PHP" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPSX en PPSM avec PHP" %}}
