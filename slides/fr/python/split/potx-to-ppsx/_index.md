---
title: Diviser Slides POTX en plusieurs PPSX via Python
description: Divisez les fichiers Slides POTX en diapositives PPSX avec l'API REST et le SDK Open Source Python
family: slides
platformtag: python
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser POTX en plusieurs PPSX avec Python" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation POTX en PPSX avec Python" %}}
