---
title: Diviser Slides PPTM en plusieurs POTX via Python
description: Divisez les fichiers Slides PPTM en diapositives POTX avec l'API REST et le SDK Open Source Python
family: slides
platformtag: python
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPTM en plusieurs POTX avec Python" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPTM en POTX avec Python" %}}
