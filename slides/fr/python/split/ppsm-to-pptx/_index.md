---
title: Diviser Slides PPSM en plusieurs PPTX via Python
description: Divisez les fichiers Slides PPSM en diapositives PPTX avec l'API REST et le SDK Open Source Python
family: slides
platformtag: python
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPSM en plusieurs PPTX avec Python" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPSM en PPTX avec Python" %}}
