---
title: Générateur de diapositives PowerPoint et OpenOffice via Python Cloud SDK
description: Autonomisez vos applications Python basées sur le cloud pour créer, copier, fusionner, diviser, télécharger et convertir des diapositives de présentation PowerPoint et OpenOffice
weight: 110
family: slides
platform: Python
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Python REST SDK pour créer et convertir des présentations" h2="Donnez à vos applications Python basées sur le cloud les moyens de créer, copier, fusionner, diviser, télécharger et convertir des diapositives de présentation PowerPoint et OpenOffice." logoImageSrc="/headers/aspose_slides-for-python.svg" pfName="Aspose.Slides" subTitlepfName="SDK Cloud pour Python" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="SDK Cloud pour Python" >}}
...
<p>Aspose.Slides Cloud SDK pour Python est construit sur l'API REST Aspose.Slides et est proposé sous une licence MIT. Aspose.Slides Cloud SDK pour Python peut être facilement intégré à vos applications Python et leur permettre de récupérer, traiter et convertir PowerPoint ainsi que des diapositives de présentation OpenOffice dans le cloud, sans aucune installation tierce.</p>
<p>En utilisant Aspose.Slides Cloud SDK pour Python, vos programmes Python pourront télécharger une diapositive individuelle à partir d'une présentation, obtenir des informations d'espace réservé à partir d'une diapositive, copier, déplacer ou supprimer une diapositive. Vous pouvez également obtenir le jeu de polices, le jeu de format, le jeu de couleurs ou le thème d'une diapositive à l'aide du SDK Python. Une prise en charge est également disponible pour le clonage des informations de la diapositive principale à partir d'une présentation hébergée sur le cloud.</p>
<p>Aspose.Slides Cloud SDK pour Python permet également à vos applications Python de fonctionner avec des images de diapositives, des formes, des notes, des occurrences de texte et d'autres attributs de document. Vous pouvez facilement utiliser Python SDK pour convertir PPT, PPTX, ODP, OTP en PDF, XPS, SWF, HTML ou de nombreux formats d'image (BMP, JPEG, TIFF, SVG, PNG).</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-python.png" alt="Python Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-python.png" alt="SDK Python pour les présentations"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fonctionnalités avancées de manipulation de présentations
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Il est facile de démarrer avec Aspose.Slides Cloud Python SDK car vous n'avez besoin de rien à installer. Créez simplement un compte sur
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 et obtenez les informations de votre application. Une fois que vous avez l'App SID et clé, vous êtes prêt à essayer le SDK Python Aspose.Slides Cloud sur n'importe quelle plate-forme.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Python" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Slides Cloud SDK pour Python ?" tabId="success-stories" >}}
