---
title: Diviser Slides POTX en plusieurs HTML5 via cURL
description: Divisez les fichiers Slides POTX en diapositives HTML5 avec l'API REST et le SDK Open Source cURL
family: slides
platformtag: curl
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser POTX en plusieurs HTML5 avec cURL" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation POTX en HTML5 avec cURL" %}}
