---
title: Convertir de Slides PPTX en POTM via cURL
description: Créez, modifiez ou convertissez des fichiers Slides PPTX en POTM avec l'API REST et le SDK cURL Open Source
family: slides
platformtag: curl
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPTX en POTM avec cURL" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion PPTX en POTM avec cURL" %}}
