---
title: Convertir de Slides PPTM en BMP via cURL
description: Créez, modifiez ou convertissez des fichiers Slides PPTM en BMP avec l'API REST et le SDK cURL Open Source
family: slides
platformtag: curl
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPTM en BMP avec cURL" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion PPTM en BMP avec cURL" %}}
