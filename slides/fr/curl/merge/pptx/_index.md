---
title: Fusionner plusieurs fichiers PPTX via cURL
description: Fusionnez plusieurs fichiers Slides PPTX avec l'API REST et le SDK Open Source cURL
family: slides
platformtag: curl
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers PPTX avec cURL" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers PPTX avec cURL" %}}
