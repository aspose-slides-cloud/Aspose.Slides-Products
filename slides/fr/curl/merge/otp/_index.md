---
title: Fusionner plusieurs fichiers OTP via cURL
description: Fusionnez plusieurs fichiers Slides OTP avec l'API REST et le SDK Open Source cURL
family: slides
platformtag: curl
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers OTP avec cURL" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers OTP avec cURL" %}}
