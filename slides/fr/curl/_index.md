---
title: Créer, fusionner, diviser et convertir des diapositives PowerPoint via cURL
description: Effectuer la création, le traitement, la fusion et la conversion de diapositives de présentation PowerPoint et OpenOffice par de simples commandes cURL via l'API REST
weight: 40
family: slides
platform: cURL
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Créez des applications de création et de conversion de présentations PPT via cURL" h2="Perform PowerPoint & OpenOffice presentation slides creation, processing, merging & conversion by simple cURL commands via REST API." logoImageSrc="/headers/aspose_slides-for-curl.svg" pfName="Aspose.Slides" subTitlepfName="Cloud pour cURL" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Cloud pour cURL" >}}
...
<p>Aspose.Slides Cloud for cURL vous permet de convertir des présentations et des diapositives PowerPoint et OpenOffice vers d'autres formats pris en charge. Par exemple, vous pouvez convertir PPT en PDF, BMP, PNG, SVG, TIFF, JPEG, SWF et HTML. Vous pouvez effectuer diverses opérations sur les diapositives de présentation, les thèmes de présentation, les notes de diapositive, les images de diapositive, les diapositives principales, les polices personnalisées et diverses autres propriétés des documents de présentation Microsoft PowerPoint et OpenOffice.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="cURL Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>cURL</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="Cloud cURL pour les présentations"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>cURL</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Il est facile de démarrer avec Aspose.Slides Cloud cURL SDK car vous n'avez besoin de rien à installer. Créez simplement un compte sur
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 et obtenez les informations de votre application. Une fois que vous avez l'App SID &amp; clé, vous êtes prêt à essayer le SDK cURL Aspose.Slides Cloud sur n'importe quelle plate-forme.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Slides Cloud SDK pour cURL ?" tabId="success-stories" >}}
