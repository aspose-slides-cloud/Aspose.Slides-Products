---
title: Remplacer le texte dans les fichiers PPSX via Java
description: Remplacez le texte dans les fichiers Slides PPSX par l'API REST et le SDK Java Open Source
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Remplacer le texte dans les fichiers PPSX avec Java" h2="Rechercher et remplacer les occurrences de texte dans les données Slides avec le SDK Cloud open source pour Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Remplacement du texte dans les fichiers PPSX par Java" %}}
