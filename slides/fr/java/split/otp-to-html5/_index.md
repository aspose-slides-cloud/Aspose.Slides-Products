---
title: Diviser Slides OTP en plusieurs HTML5 via Java
description: Divisez les fichiers Slides OTP en diapositives HTML5 avec l'API REST et le SDK Open Source Java
family: slides
platformtag: java
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser OTP en plusieurs HTML5 avec Java" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation OTP en HTML5 avec Java" %}}
