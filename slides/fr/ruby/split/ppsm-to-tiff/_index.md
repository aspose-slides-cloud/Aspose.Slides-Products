---
title: Diviser Slides PPSM en plusieurs TIFF via Ruby
description: Divisez les fichiers Slides PPSM en diapositives TIFF avec l'API REST et le SDK Open Source Ruby
family: slides
platformtag: ruby
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPSM en plusieurs TIFF avec Ruby" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPSM en TIFF avec Ruby" %}}
