---
title: Diviser Slides OTP en plusieurs POTM via Ruby
description: Divisez les fichiers Slides OTP en diapositives POTM avec l'API REST et le SDK Open Source Ruby
family: slides
platformtag: ruby
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser OTP en plusieurs POTM avec Ruby" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation OTP en POTM avec Ruby" %}}
