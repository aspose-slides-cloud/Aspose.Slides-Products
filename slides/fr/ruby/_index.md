---
title: Créer, éditer et convertir des présentations PPT, PPTX ou ODP via Ruby SDK
description: Ajoutez la création et la manipulation de fichiers PowerPoint et OpenOffice dans vos applications Ruby pour convertir, diviser, joindre, comparer et rendre des présentations PPT et PPTX via les API REST
weight: 120
family: slides
platform: Ruby
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Ruby SDK pour créer et traiter des diapositives PPT dans le cloud" h2="Ajoutez la création et la manipulation de fichiers PowerPoint et OpenOffice dans vos applications Ruby pour convertir, diviser, joindre, comparer et rendre des présentations PPT et PPTX via les API REST." logoImageSrc="/headers/aspose_slides-for-ruby.svg" pfName="Aspose.Slides" subTitlepfName="SDK Cloud pour Ruby" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud SDK pour Ruby inclut la prise en charge de nombreuses fonctionnalités avancées et de base telles que la génération et la modification de présentations, la fusion et la division de fichiers de présentation, l'exportation de présentations PowerPoint et OpenOffice, l'ajout de nouvelles diapositives, la génération de présentations à partir d'une base de données, l'ajout de diapositives de mise en page aux présentations, Ajoutez des images aux présentations et bien plus encore.</p>
<p>Vous pouvez convertir vos présentations en plusieurs formats de fichiers populaires avec seulement quelques commandes dans vos propres applications Ruby. Le SDK prend en charge la conversion en douceur dans de nombreux formats de fichiers tels que PPT, POT, PPS, PPTX, POTX, PPSX, PPTM, PPSM, POTM, ODP, OTP, TIFF, PDF, XPS, JPEG, PNG, GIF, BMP, SVG, SWF, HTML, et bien d'autres.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-ruby.png" alt="Ruby Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>Ruby</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-ruby.png" alt="SDK Ruby pour les présentations"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>Ruby</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Il est facile de démarrer avec Aspose.Slides Cloud Ruby SDK car vous n'avez besoin de rien à installer. Créez simplement un compte sur
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 et obtenez les informations de votre application. Une fois que vous avez l'App SID et clé, vous êtes prêt à essayer le SDK Ruby Aspose.Slides Cloud sur n'importe quelle plate-forme.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Conversion de fichiers PowerPoint en PDF via Ruby
    </h2>
    <p>
     Aspose.Slides Cloud SDK pour Ruby fournit des fonctionnalités qui permettent aux développeurs de logiciels de convertir par programmation des présentations PowerPoint en formats de fichiers PDF avec seulement quelques commandes dans leurs propres applications. Le format de document portable (PDF) est l'un des plus utilisés &amp; formats de fichiers populaires pour de nombreuses raisons telles que la réduction de la taille des fichiers, la sécurité fiable, l'utilisation universelle et plus encore. L'avantage du PDF est qu'il peut être utilisé indépendamment du matériel, du système d'exploitation et du logiciel d'application.
    </p>
    <h2 class="h2title">
     Gérer les diapositives de la présentation
    </h2>
    <p>
     Aspose.Slides Cloud SDK pour Ruby permet aux programmeurs de gérer les diapositives de vos présentations de nombreuses manières dans leurs applications Ruby. Plusieurs fonctionnalités importantes telles que l'insertion de nouvelles diapositives, la modification et l'amp; copie de diapositives, moment de diapositive vers une nouvelle position, suppression de diapositives, gestion de l'arrière-plan des diapositives, ajout de commentaires de diapositive, etc. Le SDK fournit également des fonctionnalités pour exporter vos diapositives vers des images et d'autres formats de fichiers pris en charge.
    </p>
    <h2 class="h2title">
     Travailler avec des images dans des présentations PowerPoint
    </h2>
    <p>
     Aspose.Slides Cloud SDK pour Ruby permet aux développeurs de logiciels de travailler avec des images dans leurs propres applications Ruby. Vous pouvez facilement ajouter et modifier des images dans les diapositives de votre présentation avec quelques commandes Ruby. Il prend également en charge des fonctionnalités telles que l'extraction d'images d'une présentation PPT, l'obtention d'informations sur les images, l'extraction d'images dans un format particulier et bien d'autres.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Fractionner et fusionner des présentations PowerPoint
    </h2>
    <p>
     Aspose.Slides Cloud SDK pour Ruby offre la possibilité de diviser une présentation PowerPoint et d'exporter la division résultante dans différents formats. Le SDK vous permet également de fusionner plusieurs fichiers de présentation à l'aide de l'API Aspose.Slides for Cloud dans vos applications.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Slides Cloud SDK pour Ruby ?" tabId="success-stories" >}}
