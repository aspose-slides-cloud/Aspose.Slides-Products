---
title: Convertir de Slides PDF en PPS via Ruby
description: Créez, modifiez ou convertissez des fichiers Slides PDF en PPS avec l'API REST et le SDK Ruby Open Source
family: slides
platformtag: ruby
feature: conversion
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PDF en PPS avec Ruby" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion PDF en PPS avec Ruby" %}}
