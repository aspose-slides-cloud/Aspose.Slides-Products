---
title: Convertir de Slides OTP en SWF via Ruby
description: Créez, modifiez ou convertissez des fichiers Slides OTP en SWF avec l'API REST et le SDK Ruby Open Source
family: slides
platformtag: ruby
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir OTP en SWF avec Ruby" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion OTP en SWF avec Ruby" %}}
