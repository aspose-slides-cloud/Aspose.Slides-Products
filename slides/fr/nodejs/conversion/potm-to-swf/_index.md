---
title: Convertir de Slides POTM en SWF via Node.js
description: Créez, modifiez ou convertissez des fichiers Slides POTM en SWF avec l'API REST et le SDK Node.js Open Source
family: slides
platformtag: nodejs
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir POTM en SWF avec Node.js" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion POTM en SWF avec Node.js" %}}
