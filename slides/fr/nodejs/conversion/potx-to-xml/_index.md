---
title: Convertir de Slides POTX en XML via Node.js
description: Créez, modifiez ou convertissez des fichiers Slides POTX en XML avec l'API REST et le SDK Node.js Open Source
family: slides
platformtag: nodejs
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir POTX en XML avec Node.js" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion POTX en XML avec Node.js" %}}
