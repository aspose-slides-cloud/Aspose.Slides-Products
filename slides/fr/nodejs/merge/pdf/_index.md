---
title: Fusionner plusieurs fichiers PDF via Node.js
description: Fusionnez plusieurs fichiers Slides PDF avec l'API REST et le SDK Open Source Node.js
family: slides
platformtag: nodejs
feature: merge
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers PDF avec Node.js" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers PDF avec Node.js" %}}
