---
title: Fusionner plusieurs fichiers PPTM via Node.js
description: Fusionnez plusieurs fichiers Slides PPTM avec l'API REST et le SDK Open Source Node.js
family: slides
platformtag: nodejs
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers PPTM avec Node.js" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers PPTM avec Node.js" %}}
