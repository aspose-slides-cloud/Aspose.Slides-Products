---
title: Remplacer le texte dans les fichiers POTX via Node.js
description: Remplacez le texte dans les fichiers Slides POTX par l'API REST et le SDK Node.js Open Source
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Remplacer le texte dans les fichiers POTX avec Node.js" h2="Rechercher et remplacer les occurrences de texte dans les données Slides avec le SDK Cloud open source pour Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Remplacement du texte dans les fichiers POTX par Node.js" %}}
...
1. Appelez l'une des méthodes de remplacement de texte, selon l'emplacement de vos fichiers POTX et si vous devez remplacer le texte dans l'ensemble du document ou dans une seule diapositive
