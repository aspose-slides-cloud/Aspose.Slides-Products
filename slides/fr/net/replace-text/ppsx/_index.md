---
title: Remplacer le texte dans les fichiers PPSX via .NET
description: Remplacez le texte dans les fichiers Slides PPSX par l'API REST et le SDK .NET Open Source
family: slides
platformtag: net
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Remplacer le texte dans les fichiers PPSX avec .NET" h2="Rechercher et remplacer les occurrences de texte dans les données Slides avec le SDK Cloud open source pour .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Remplacement du texte dans les fichiers PPSX par .NET" %}}
...
{{< blocks/products/pf/cloud-app app="replaceText" language="net" inputFormat="ppsx" >}}
