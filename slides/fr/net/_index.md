---
title: Créer un créateur et un visualiseur de présentation avec C# REST SDK
description: C# Cloud SDK pour vous aider à créer et traiter des présentations PowerPoint et OpenOffice dans le cloud, sans installer de logiciel
weight: 70
family: slides
platform: .NET
---
...
{{< blocks/products/pf/i18n/upper-banner h1="C# SDK pour afficher, traiter et convertir des diapositives dans le cloud" h2="C# Cloud SDK to help you create & process PowerPoint & OpenOffice presentations in the cloud, without installing any software." logoImageSrc="/headers/aspose_slides-for-net.svg" pfName="Aspose.Slides" subTitlepfName="SDK Cloud pour .NET" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="SDK Cloud pour .NET" >}}
...
<p>Aspose.Slides Cloud SDK pour .NET est utilisé pour intégrer de manière transparente les capacités de traitement PPT, PPTX, ODP, OTP dans vos applications basées sur le cloud créées à l'aide de C #, ASP.NET ou d'autres langages pris en charge par .NET. Aspose.Slides Cloud SDK pour .NET est un wrapper autour de l'API REST Aspose.Slides et est proposé sous une licence MIT.</p>
<p>Aspose.Slides Cloud SDK pour .NET améliore votre code C # pour créer des présentations PowerPoint, fusionner des diapositives sélectionnées, diviser des présentations, ainsi que convertir des documents de présentation PowerPoint et OpenOffice en PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, HTML et SWF.</p>
<p>Aspose.Slides Cloud SDK pour .NET permet également à votre application .NET basée sur le cloud de travailler avec des animations de diapositives de présentation, de lire et de cloner des informations sur la diapositive principale, d'extraire et de télécharger des notes de diapositive, d'extraire l'image de présentation dans un format particulier, d'extraire des formes d'une diapositive , ainsi que d'effectuer diverses autres opérations à l'aide de vos programmes C# via notre Aspose.Slides Cloud SDK pour .NET.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt=".NET Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt="SDK .NET pour les présentations"><header>Aspose.Slides</header><footer>Cloud <small> <em>pour</em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Il est facile de démarrer avec Aspose.Slides Cloud .NET SDK car vous n'avez besoin de rien à installer. Créez simplement un compte sur
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 et obtenez les informations de votre application. Une fois que vous avez l'App SID &amp; clé, vous êtes prêt à essayer le SDK .NET Aspose.Slides Cloud sur n'importe quelle plate-forme.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-slides-cloud/aspose-slides-cloud-net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Slides Cloud SDK pour .NET ?" tabId="success-stories" >}}
