---
title: Fusionner plusieurs fichiers PPS via .NET
description: Fusionnez plusieurs fichiers Slides PPS avec l'API REST et le SDK Open Source .NET
family: slides
platformtag: net
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers PPS avec .NET" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers PPS avec .NET" %}}
