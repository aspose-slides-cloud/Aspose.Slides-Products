---
title: Fusionner plusieurs fichiers PDF via .NET
description: Fusionnez plusieurs fichiers Slides PDF avec l'API REST et le SDK Open Source .NET
family: slides
platformtag: net
feature: merge
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers PDF avec .NET" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers PDF avec .NET" %}}
