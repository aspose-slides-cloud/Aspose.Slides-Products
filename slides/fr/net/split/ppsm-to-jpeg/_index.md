---
title: Diviser Slides PPSM en plusieurs JPEG via .NET
description: Divisez les fichiers Slides PPSM en diapositives JPEG avec l'API REST et le SDK Open Source .NET
family: slides
platformtag: net
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPSM en plusieurs JPEG avec .NET" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPSM en JPEG avec .NET" %}}
