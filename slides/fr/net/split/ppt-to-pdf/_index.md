---
title: Diviser Slides PPT en plusieurs PDF via .NET
description: Divisez les fichiers Slides PPT en diapositives PDF avec l'API REST et le SDK Open Source .NET
family: slides
platformtag: net
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPT en plusieurs PDF avec .NET" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPT en PDF avec .NET" %}}
