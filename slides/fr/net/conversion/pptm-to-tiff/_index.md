---
title: Convertir de Slides PPTM en TIFF via .NET
description: Créez, modifiez ou convertissez des fichiers Slides PPTM en TIFF avec l'API REST et le SDK .NET Open Source
family: slides
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPTM en TIFF avec .NET" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion PPTM en TIFF avec .NET" %}}
