---
title: Convertir de Slides OTP en PNG via .NET
description: Créez, modifiez ou convertissez des fichiers Slides OTP en PNG avec l'API REST et le SDK .NET Open Source
family: slides
platformtag: net
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir OTP en PNG avec .NET" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion OTP en PNG avec .NET" %}}
