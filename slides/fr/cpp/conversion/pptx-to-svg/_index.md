---
title: Convertir de Slides PPTX en SVG via C++
description: Créez, modifiez ou convertissez des fichiers Slides PPTX en SVG avec l'API REST et le SDK C++ Open Source
family: slides
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPTX en SVG avec C++" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion PPTX en SVG avec C++" %}}
