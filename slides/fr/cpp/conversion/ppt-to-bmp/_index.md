---
title: Convertir de Slides PPT en BMP via C++
description: Créez, modifiez ou convertissez des fichiers Slides PPT en BMP avec l'API REST et le SDK C++ Open Source
family: slides
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPT en BMP avec C++" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion PPT en BMP avec C++" %}}
