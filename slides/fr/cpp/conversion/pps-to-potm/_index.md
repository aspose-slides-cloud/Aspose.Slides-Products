---
title: Convertir de Slides PPS en POTM via C++
description: Créez, modifiez ou convertissez des fichiers Slides PPS en POTM avec l'API REST et le SDK C++ Open Source
family: slides
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPS en POTM avec C++" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion PPS en POTM avec C++" %}}
