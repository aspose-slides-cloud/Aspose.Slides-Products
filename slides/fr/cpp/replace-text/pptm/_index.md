---
title: Remplacer le texte dans les fichiers PPTM via C++
description: Remplacez le texte dans les fichiers Slides PPTM par l'API REST et le SDK C++ Open Source
family: slides
platformtag: cpp
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Remplacer le texte dans les fichiers PPTM avec C++" h2="Rechercher et remplacer les occurrences de texte dans les données Slides avec le SDK Cloud open source pour C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Remplacement du texte dans les fichiers PPTM par C++" %}}
