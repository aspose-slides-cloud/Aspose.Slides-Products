---
title: Diviser les présentations via C++
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser les présentations en diapositives avec C++" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fractionnement de présentation avec C++" %}}
