---
title: Diviser Slides PPSX en plusieurs PPTX via C++
description: Divisez les fichiers Slides PPSX en diapositives PPTX avec l'API REST et le SDK Open Source C++
family: slides
platformtag: cpp
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPSX en plusieurs PPTX avec C++" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPSX en PPTX avec C++" %}}
