---
title: Diviser Slides PPTM en plusieurs OTP via C++
description: Divisez les fichiers Slides PPTM en diapositives OTP avec l'API REST et le SDK Open Source C++
family: slides
platformtag: cpp
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPTM en plusieurs OTP avec C++" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPTM en OTP avec C++" %}}
