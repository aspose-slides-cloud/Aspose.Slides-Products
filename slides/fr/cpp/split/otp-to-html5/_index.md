---
title: Diviser Slides OTP en plusieurs HTML5 via C++
description: Divisez les fichiers Slides OTP en diapositives HTML5 avec l'API REST et le SDK Open Source C++
family: slides
platformtag: cpp
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser OTP en plusieurs HTML5 avec C++" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation OTP en HTML5 avec C++" %}}
