---
title: Remplacer le texte dans les présentations via Go
description: Remplacez le texte dans les fichiers Slides par l'API REST et le SDK Go Open Source
family: slides
platformtag: go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Remplacer le texte dans les présentations avec Go" h2="Rechercher et remplacer les occurrences de texte dans les données Slides avec le SDK Cloud open source pour Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Remplacement du texte dans les présentations par Go" %}}
