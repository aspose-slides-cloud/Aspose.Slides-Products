---
title: Diviser Slides OTP en plusieurs HTML5 via Go
description: Divisez les fichiers Slides OTP en diapositives HTML5 avec l'API REST et le SDK Open Source Go
family: slides
platformtag: go
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser OTP en plusieurs HTML5 avec Go" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation OTP en HTML5 avec Go" %}}
