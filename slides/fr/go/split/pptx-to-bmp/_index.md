---
title: Diviser Slides PPTX en plusieurs BMP via Go
description: Divisez les fichiers Slides PPTX en diapositives BMP avec l'API REST et le SDK Open Source Go
family: slides
platformtag: go
feature: split
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPTX en plusieurs BMP avec Go" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPTX en BMP avec Go" %}}
