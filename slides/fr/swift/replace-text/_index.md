---
title: Remplacer le texte dans les présentations via Swift
description: Remplacez le texte dans les fichiers Slides par l'API REST et le SDK Swift Open Source
family: slides
platformtag: swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Remplacer le texte dans les présentations avec Swift" h2="Rechercher et remplacer les occurrences de texte dans les données Slides avec le SDK Cloud open source pour Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Remplacement du texte dans les présentations par Swift" %}}
...
1. Appelez l'une des méthodes de remplacement de texte, selon l'emplacement de vos présentations et si vous devez remplacer le texte dans l'ensemble du document ou dans une seule diapositive.
