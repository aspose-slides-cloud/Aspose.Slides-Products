---
title: Fusionner plusieurs fichiers HTML via Swift
description: Fusionnez plusieurs fichiers Slides HTML avec l'API REST et le SDK Open Source Swift
family: slides
platformtag: swift
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers HTML avec Swift" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers HTML avec Swift" %}}
