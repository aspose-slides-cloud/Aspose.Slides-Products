---
title: Fusionner plusieurs fichiers PPSX via Swift
description: Fusionnez plusieurs fichiers Slides PPSX avec l'API REST et le SDK Open Source Swift
family: slides
platformtag: swift
feature: merge
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers PPSX avec Swift" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers PPSX avec Swift" %}}
