---
title: Fusionner plusieurs fichiers ODP via Swift
description: Fusionnez plusieurs fichiers Slides ODP avec l'API REST et le SDK Open Source Swift
family: slides
platformtag: swift
feature: merge
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers ODP avec Swift" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers ODP avec Swift" %}}
