...
description: Créez, modifiez ou convertissez des fichiers Slides PPTX en JPEG avec l'API REST et le SDK Swift Open Source
family: slides
platformtag: swift
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPTX en JPEG avec Swift" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion PPTX en JPEG avec Swift" %}}
