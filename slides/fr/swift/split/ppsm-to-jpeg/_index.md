---
title: Diviser Slides PPSM en plusieurs JPEG via Swift
description: Divisez les fichiers Slides PPSM en diapositives JPEG avec l'API REST et le SDK Open Source Swift
family: slides
platformtag: swift
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPSM en plusieurs JPEG avec Swift" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPSM en JPEG avec Swift" %}}
