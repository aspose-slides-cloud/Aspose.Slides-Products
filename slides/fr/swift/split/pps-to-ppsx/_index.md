---
title: Diviser Slides PPS en plusieurs PPSX via Swift
description: Divisez les fichiers Slides PPS en diapositives PPSX avec l'API REST et le SDK Open Source Swift
family: slides
platformtag: swift
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPS en plusieurs PPSX avec Swift" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPS en PPSX avec Swift" %}}
