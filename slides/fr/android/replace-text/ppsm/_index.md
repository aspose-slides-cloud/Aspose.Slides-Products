---
title: Remplacer le texte dans les fichiers PPSM via Android
description: Remplacez le texte dans les fichiers Slides PPSM par l'API REST et le SDK Android Open Source
family: slides
platformtag: android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Remplacer le texte dans les fichiers PPSM avec Android" h2="Rechercher et remplacer les occurrences de texte dans les données Slides avec le SDK Cloud open source pour Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Remplacement du texte dans les fichiers PPSM par Android" %}}
...
1. Appelez l'une des méthodes de remplacement de texte, selon l'emplacement de vos fichiers PPSM et si vous devez remplacer le texte dans l'ensemble du document ou dans une seule diapositive
...
{{< blocks/products/pf/cloud-app app="replaceText" language="java" inputFormat="ppsm" >}}
