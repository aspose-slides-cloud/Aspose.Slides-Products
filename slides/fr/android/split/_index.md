---
title: Diviser les présentations via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser les présentations en diapositives avec Android" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fractionnement de présentation avec Android" %}}
...
1. Appelez l'une des méthodes de fractionnement, en fonction de l'emplacement de votre fichier d'entrée et de l'emplacement où vous souhaitez stocker les fichiers résultants
    ...
    - ```splitOnline``` pour diviser un fichier local et télécharger le résultat sous forme d'archive ZIP. Chaque diapositive de la présentation d'entrée est téléchargée dans un fichier séparé dans l'archive ZIP.
    - ```splitAndSaveOnline``` pour diviser un fichier local et enregistrer le résultat dans le stockage. Chaque diapositive de la présentation d'entrée est enregistrée dans un fichier séparé dans le dossier de stockage spécifié (ou dans le dossier racine par défaut).
