---
title: Fusionner plusieurs fichiers HTML via Android
description: Fusionnez plusieurs fichiers Slides HTML avec l'API REST et le SDK Open Source Android
family: slides
platformtag: android
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs fichiers HTML avec Android" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusion de fichiers HTML avec Android" %}}
