---
title: Fusionner plusieurs présentations via Android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Fusionner plusieurs présentations avec Android" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusionner des présentations avec Android" %}}
