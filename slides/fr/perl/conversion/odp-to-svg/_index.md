---
title: Convertir de Slides ODP en SVG via Perl
description: Créez, modifiez ou convertissez des fichiers Slides ODP en SVG avec l'API REST et le SDK Perl Open Source
family: slides
platformtag: perl
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir ODP en SVG avec Perl" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion ODP en SVG avec Perl" %}}
