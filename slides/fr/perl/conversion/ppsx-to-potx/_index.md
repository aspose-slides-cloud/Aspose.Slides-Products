---
title: Convertir de Slides PPSX en POTX via Perl
description: Créez, modifiez ou convertissez des fichiers Slides PPSX en POTX avec l'API REST et le SDK Perl Open Source
family: slides
platformtag: perl
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPSX en POTX avec Perl" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion PPSX en POTX avec Perl" %}}
