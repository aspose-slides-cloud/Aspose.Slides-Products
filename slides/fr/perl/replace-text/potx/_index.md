---
title: Remplacer le texte dans les fichiers POTX via Perl
description: Remplacez le texte dans les fichiers Slides POTX par l'API REST et le SDK Perl Open Source
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Remplacer le texte dans les fichiers POTX avec Perl" h2="Rechercher et remplacer les occurrences de texte dans les données Slides avec le SDK Cloud open source pour Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Remplacement du texte dans les fichiers POTX par Perl" %}}
