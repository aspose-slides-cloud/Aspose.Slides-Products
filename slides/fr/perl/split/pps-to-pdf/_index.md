---
title: Diviser Slides PPS en plusieurs PDF via Perl
description: Divisez les fichiers Slides PPS en diapositives PDF avec l'API REST et le SDK Open Source Perl
family: slides
platformtag: perl
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPS en plusieurs PDF avec Perl" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPS en PDF avec Perl" %}}
