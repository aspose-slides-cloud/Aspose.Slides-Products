---
title: Diviser Slides PPTM en plusieurs XAML via Perl
description: Divisez les fichiers Slides PPTM en diapositives XAML avec l'API REST et le SDK Open Source Perl
family: slides
platformtag: perl
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Diviser PPTM en plusieurs XAML avec Perl" h2="Lisez, modifiez et exportez des données Slides vers d'autres formats avec le SDK Cloud open source pour Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Séparation PPTM en XAML avec Perl" %}}
