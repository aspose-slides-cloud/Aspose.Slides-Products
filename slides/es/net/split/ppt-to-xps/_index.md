---
title: Dividir Slides PPT en múltiples XPS a través de .NET
description: Dividir archivos de Slides PPT en diapositivas XPS con REST API y .NET SDK de código abierto
family: slides
platformtag: net
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPT en múltiples XPS con .NET" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir PPT en XPS con .NET" %}}
