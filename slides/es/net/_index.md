---
title: Creador y visor de presentaciones con C# REST SDK
description: C# Cloud SDK para ayudarlo a crear y procesar presentaciones de PowerPoint y OpenOffice en la nube, sin instalar ningún software
weight: 70
family: slides
platform: .NET
---
...
{{< blocks/products/pf/i18n/upper-banner h1="C# SDK para ver, procesar y convertir diapositivas en la nube" h2="C# Cloud SDK para ayudarlo a crear y procesar presentaciones de PowerPoint y OpenOffice en la nube, sin instalar ningún software." logoImageSrc="/headers/aspose_slides-for-net.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK para .NET" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud SDK para .NET se utiliza para integrar a la perfección las capacidades de procesamiento de PPT, PPTX, ODP y OTP en sus aplicaciones basadas en la nube creadas con C#, ASP.NET u otros lenguajes compatibles con .NET. Aspose.Slides Cloud SDK para .NET es un contenedor de la API REST de Aspose.Slides y se ofrece bajo una licencia MIT.</p>
<p>Aspose.Slides Cloud SDK para .NET mejora su código C# para crear presentaciones de PowerPoint, fusionar diapositivas seleccionadas, dividir presentaciones y convertir documentos de presentación de PowerPoint y OpenOffice a PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, HTML y SWF.</p>
<p>Aspose.Slides Cloud SDK para .NET también permite que su aplicación .NET basada en la nube funcione con animaciones de diapositivas de presentación, lea y clone información de diapositivas maestras, extraiga y descargue notas de diapositivas, extraiga imágenes de presentación a un formato particular, extraiga formas de una diapositiva , así como realizar varias otras operaciones usando sus programas C# a través de nuestro SDK Aspose.Slides Cloud para .NET.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt=".NET Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-net.png" alt="SDK de .NET para presentaciones"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>.NET</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	 Es fácil comenzar con Aspose.Slides Cloud .NET SDK ya que no necesita instalar nada. Simplemente cree una cuenta en
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 y obtenga la información de su aplicación. Una vez que tenga el SID y la clave de la aplicación, estará listo para probar Aspose.Slides Cloud .NET SDK en cualquier plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides Cloud SDK para .NET permite a los desarrolladores crear nuevas formas para diapositivas de presentación. Puede leer y actualizar la información de propiedades de las formas de diapositivas existentes. Nuestro SDK de nube de procesamiento de diapositivas de presentación le permite representar las formas de las diapositivas en formatos de imagen compatibles. Aspose.Slides Cloud SDK para .NET también lo ayuda a trabajar con notas de diapositivas de presentación.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-.NET" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Slides Cloud SDK para .NET?" tabId="success-stories" >}}
