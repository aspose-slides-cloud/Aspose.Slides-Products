---
title: Combinar múltiples archivos PDF a través de .NET
description: Combine varios archivos Slides PDF con REST API y Open Source .NET SDK
family: slides
platformtag: net
feature: merge
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos PDF con .NET" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos PDF con .NET" %}}
