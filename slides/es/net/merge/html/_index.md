---
title: Combinar múltiples archivos HTML a través de .NET
description: Combine varios archivos Slides HTML con REST API y Open Source .NET SDK
family: slides
platformtag: net
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos HTML con .NET" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos HTML con .NET" %}}
