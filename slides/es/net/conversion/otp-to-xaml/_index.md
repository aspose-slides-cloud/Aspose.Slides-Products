---
title: Convertir de Slides OTP a XAML a través de .NET
description: cree, edite o convierta archivos Slides OTP a XAML con REST API y .NET SDK de código abierto
family: slides
platformtag: net
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir OTP a XAML con .NET" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de OTP a XAML con .NET" %}}
