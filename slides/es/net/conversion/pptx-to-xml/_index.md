---
title: Convertir de Slides PPTX a XML a través de .NET
description: cree, edite o convierta archivos Slides PPTX a XML con REST API y .NET SDK de código abierto
family: slides
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPTX a XML con .NET" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PPTX a XML con .NET" %}}
