---
title: Convertir de Slides PPSM a JPEG a través de .NET
description: cree, edite o convierta archivos Slides PPSM a JPEG con REST API y .NET SDK de código abierto
family: slides
platformtag: net
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPSM a JPEG con .NET" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PPSM a JPEG con .NET" %}}
