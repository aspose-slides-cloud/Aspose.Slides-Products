---
title: Dividir Slides ODP en múltiples POTX a través de Python
description: Dividir archivos de Slides ODP en diapositivas POTX con REST API y Python SDK de código abierto
family: slides
platformtag: python
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir ODP en múltiples POTX con Python" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir ODP en POTX con Python" %}}
