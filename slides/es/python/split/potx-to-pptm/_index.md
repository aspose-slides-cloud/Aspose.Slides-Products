---
title: Dividir Slides POTX en múltiples PPTM a través de Python
description: Dividir archivos de Slides POTX en diapositivas PPTM con REST API y Python SDK de código abierto
family: slides
platformtag: python
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir POTX en múltiples PPTM con Python" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir POTX en PPTM con Python" %}}
