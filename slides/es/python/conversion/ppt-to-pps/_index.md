---
title: Convertir de Slides PPT a PPS a través de Python
description: cree, edite o convierta archivos Slides PPT a PPS con REST API y Python SDK de código abierto
family: slides
platformtag: python
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPT a PPS con Python" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PPT a PPS con Python" %}}
...
1. Llame a uno de los métodos de conversión, dependiendo de dónde esté su archivo PPT de entrada y dónde desee almacenar el archivo PPS resultante.
