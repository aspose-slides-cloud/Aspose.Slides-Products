---
title: Convertir de Slides PPSM a PDF a través de Python
description: cree, edite o convierta archivos Slides PPSM a PDF con REST API y Python SDK de código abierto
family: slides
platformtag: python
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPSM a PDF con Python" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PPSM a PDF con Python" %}}
...
1. Llame a uno de los métodos de conversión, dependiendo de dónde esté su archivo PPSM de entrada y dónde desee almacenar el archivo PDF resultante.
