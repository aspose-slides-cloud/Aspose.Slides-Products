---
title: Combinar múltiples archivos HTML a través de Python
description: Combine varios archivos Slides HTML con REST API y Open Source Python SDK
family: slides
platformtag: python
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos HTML con Python" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos HTML con Python" %}}
...
1. Llame a uno de los métodos de combinación, dependiendo de dónde se encuentran sus archivos HTML de entrada, dónde desea almacenar el archivo combinado y si necesita combinar partes de los archivos
