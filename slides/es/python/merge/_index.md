---
title: Combinar múltiples presentaciones a través de Python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples presentaciones con Python" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de presentaciones a través de Python" %}}
...
1. Llame a uno de los métodos de combinación, dependiendo de dónde estén sus archivos de entrada, dónde desee almacenar el archivo combinado y si necesita combinar partes de los archivos
