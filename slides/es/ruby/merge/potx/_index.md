---
title: Combinar múltiples archivos POTX a través de Ruby
description: Combine varios archivos Slides POTX con REST API y Open Source Ruby SDK
family: slides
platformtag: ruby
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos POTX con Ruby" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos POTX con Ruby" %}}
