---
title: Reemplazar texto en archivos ODP a través de Ruby
description: Reemplace texto en archivos Slides ODP con API REST y SDK Ruby de código abierto
family: slides
platformtag: ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Reemplazar texto en archivos ODP con Ruby" h2="Busque y reemplace apariciones de texto en datos de Slides con Cloud SDK de código abierto para Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Reemplazo de texto en archivos ODP con Ruby" %}}
