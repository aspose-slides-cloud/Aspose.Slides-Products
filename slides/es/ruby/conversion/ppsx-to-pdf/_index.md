---
title: Convertir de Slides PPSX a PDF a través de Ruby
description: cree, edite o convierta archivos Slides PPSX a PDF con REST API y Ruby SDK de código abierto
family: slides
platformtag: ruby
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPSX a PDF con Ruby" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PPSX a PDF con Ruby" %}}
