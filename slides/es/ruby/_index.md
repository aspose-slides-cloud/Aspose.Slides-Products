---
title: Cree, edite y convierta presentaciones PPT, PPTX u ODP a través de Ruby SDK
description: Agregue la creación y manipulación de archivos de PowerPoint y OpenOffice en sus aplicaciones de Ruby para convertir, dividir, unir, comparar y renderizar presentaciones PPT y PPTX a través de API REST
weight: 120
family: slides
platform: Ruby
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Ruby SDK para crear y procesar diapositivas PPT en la nube" h2="Agregue la creación y manipulación de archivos de PowerPoint y OpenOffice a sus aplicaciones de Ruby para convertir, dividir, unir, comparar y renderizar presentaciones PPT y PPTX a través de API REST." logoImageSrc="/headers/aspose_slides-for-ruby.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK para Ruby" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud SDK para Ruby permite a los programadores de computadoras generar, modificar, renderizar y convertir presentaciones de PowerPoint y OpenOffice sin usar Microsoft PowerPoint. El SDK brinda soporte para la mayoría de los formatos de archivo de Microsoft PowerPoint, como POT, PPT, PPS, POTX, PPTX, PPSX y ODP, y los exporta a formatos populares.</p>
<p>Aspose.Slides Cloud SDK para Ruby incluye soporte para muchas características avanzadas y básicas, como generar y modificar presentaciones, fusionar y dividir archivos de presentación, exportar presentaciones de PowerPoint y OpenOffice, agregar nuevas diapositivas, generar presentaciones desde una base de datos, agregar diapositivas de diseño a presentaciones, Agregue imágenes a las presentaciones y mucho más.</p>
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-ruby.png" alt="Ruby Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Ruby</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-ruby.png" alt="SDK de Ruby para presentaciones"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Ruby</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	 Es fácil comenzar con Aspose.Slides Cloud Ruby SDK ya que no necesita instalar nada. Simplemente cree una cuenta en
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 y obtenga la información de su aplicación. Una vez que tenga el SID y la clave de la aplicación, estará listo para probar Aspose.Slides Cloud Ruby SDK en cualquier plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Conversión de archivos de PowerPoint a PDF a través de Ruby
    </h2>
    <p>
     Aspose.Slides Cloud SDK para Ruby proporciona una funcionalidad que permite a los desarrolladores de software convertir mediante programación presentaciones de PowerPoint a formatos de archivo PDF con solo unos pocos comandos dentro de sus propias aplicaciones. El Formato de Documento Portátil (PDF) es uno de los más utilizados &amp; formatos de archivo populares por numerosas razones, como Disminuye el tamaño del archivo, seguridad confiable, uso universal y más. La gran idea sobre el PDF es que se puede usar independientemente del hardware, el sistema operativo y el software de la aplicación.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Administrar las diapositivas de la presentación
    </h2>
    <p>
     Aspose.Slides Cloud SDK para Ruby permite a los programadores administrar las diapositivas de sus presentaciones de muchas maneras dentro de sus aplicaciones Ruby. Varias funciones importantes, como insertar nuevas diapositivas, modificar &amp; copiar diapositivas, momento de la diapositiva a una nueva posición, eliminación de diapositivas, administrar el fondo de las diapositivas, agregar comentarios de diapositivas y mucho más. El SDK también proporciona funcionalidad para exportar sus diapositivas a imágenes y otros formatos de archivo compatibles.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Trabajar con imágenes en presentaciones de PowerPoint
    </h2>
    <p>
		Aspose.Slides Cloud SDK para Ruby permite a los desarrolladores de software trabajar con imágenes dentro de sus propias aplicaciones de Ruby. Puede agregar y modificar fácilmente imágenes dentro de las diapositivas de su presentación con un par de comandos de Ruby. También admite funciones como extraer imágenes de una presentación PPT, obtener información de imágenes, extraer imágenes en un formato particular y muchas más.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Dividir y fusionar presentaciones de PowerPoint
    </h2>
    <p>
		Aspose.Slides Cloud SDK para Ruby proporciona la capacidad de dividir una presentación de PowerPoint y exportar la división resultante en varios formatos. El SDK también le permite fusionar varios archivos de presentación utilizando Aspose.Slides for Cloud API en sus aplicaciones.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Ruby" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Slides Cloud SDK para Ruby?" tabId="success-stories" >}}
