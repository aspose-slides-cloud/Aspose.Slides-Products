---
title: Combinar múltiples archivos POTX a través de Node.js
description: Combine varios archivos Slides POTX con REST API y Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos POTX con Node.js" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos POTX con Node.js" %}}
...
1. Llame a uno de los métodos de combinación, dependiendo de dónde se encuentran sus archivos POTX de entrada, dónde desea almacenar el archivo combinado y si necesita combinar partes de los archivos
