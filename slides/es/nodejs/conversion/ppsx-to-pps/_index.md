---
title: Convertir de Slides PPSX a PPS a través de Node.js
description: cree, edite o convierta archivos Slides PPSX a PPS con REST API y Node.js SDK de código abierto
family: slides
platformtag: nodejs
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPSX a PPS con Node.js" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PPSX a PPS con Node.js" %}}
