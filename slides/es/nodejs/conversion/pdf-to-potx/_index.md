---
title: Convertir de Slides PDF a POTX a través de Node.js
description: cree, edite o convierta archivos Slides PDF a POTX con REST API y Node.js SDK de código abierto
family: slides
platformtag: nodejs
feature: conversion
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PDF a POTX con Node.js" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PDF a POTX con Node.js" %}}
