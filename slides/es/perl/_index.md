---
title: Cloud SDK para Perl | Cree presentaciones de conversión PPT, PPTX, ODP y OTP
description: Desarrolle aplicaciones Perl basadas en la nube para crear, editar, administrar diapositivas, fusionar y dividir presentaciones de PowerPoint y OpenOffice en la nube a través de API REST
weight: 90
family: slides
platform: Perl
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Cree, edite y convierta archivos PPT a través de Perl SDK" h2="Desarrolle aplicaciones Perl basadas en la nube para crear, editar, administrar diapositivas, fusionar y dividir presentaciones de PowerPoint y OpenOffice en la nube a través de API REST." logoImageSrc="/headers/aspose_slides-for-perl.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK para Perl" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud SDK para Perl brinda a los programadores de software el poder de generar aplicaciones basadas en la nube para trabajar con presentaciones de PowerPoint y OpenOffice en la nube. Permite crear, editar, manipular y convertir archivos PPT, PPTX, ODP, OTP dentro de sus aplicaciones basadas en la nube. El SDK permite que las aplicaciones de Perl creen nuevas presentaciones o modifiquen las presentaciones existentes, modifiquen diapositivas individuales, clonen diapositivas maestras, actualicen secuencias interactivas de presentaciones de PowerPoint y especifiquen fuentes personalizadas para usar en la presentación.</p>
<p>Aspose.Slides Cloud SDK para Perl admite varias funciones avanzadas, como leer información de MasterSlide de una presentación de PowerPoint, fusionar y dividir presentaciones, convertir archivos de presentación de PowerPoint y OpenOffice a PDF, TIFF, SVG, HTML, XPS, JPEG, PNG, BMP, SWF, y varios otros formatos de archivo.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-perl.png" alt="Perl Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Perl</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-perl.png" alt="SDK de Perl para presentaciones"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Perl</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	 Es fácil comenzar con Aspose.Slides Cloud Perl SDK ya que no necesita instalar nada. Simplemente cree una cuenta en
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 y obtenga la información de su aplicación. Una vez que tenga el SID y la clave de la aplicación, estará listo para probar Aspose.Slides Cloud Perl SDK en cualquier plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides Cloud SDK para Perl permite a los desarrolladores realizar operaciones de procesamiento de diapositivas de presentación básicas a avanzadas. Puede leer la información de las diapositivas de la presentación. Crear nuevas diapositivas. Copie, modifique o elimine diapositivas existentes. Convierta diapositivas de presentación de formatos de PowerPoint a otros formatos compatibles a través de Cloud SDK. También puede manipular el fondo de la diapositiva aplicando un nuevo fondo, leyendo y eliminando el fondo existente para cualquier diapositiva. Aspose.Slides Cloud SDK para Perl le permite reordenar la posición de las diapositivas dentro de la presentación. También puede copiar una diapositiva de la presentación actual o de otra. También se pueden recuperar los comentarios de las diapositivas de la presentación.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Exportación de presentaciones de PowerPoint a otros formatos de archivo
    </h2>
    <p>
     Aspose.Slides Cloud SDK for Perl es totalmente compatible con la exportación de presentaciones de PowerPoint a varios otros formatos dentro de sus propias aplicaciones Perl. Los programadores pueden cargar y convertir documentos de PowerPoint en numerosos formatos de archivo como PPT, POT, PPS, PPTX, POTX, PPSX, PPTM, PPSM, POTM, ODP, OTP, TIFF, PDF, XPS, JPEG, PNG, GIF, BMP, SVG, SWF y HTML. También admite la extracción de contenidos como texto e imágenes de los documentos de PowerPoint.
    </p>
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Perl" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Slides Cloud SDK para Perl?" tabId="success-stories" >}}
