---
title: Dividir Slides POTX en múltiples PPTM a través de Perl
description: Dividir archivos de Slides POTX en diapositivas PPTM con REST API y Perl SDK de código abierto
family: slides
platformtag: perl
feature: split
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir POTX en múltiples PPTM con Perl" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir POTX en PPTM con Perl" %}}
