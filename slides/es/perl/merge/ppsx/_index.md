---
title: Combinar múltiples archivos PPSX a través de Perl
description: Combine varios archivos Slides PPSX con REST API y Open Source Perl SDK
family: slides
platformtag: perl
feature: merge
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos PPSX con Perl" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos PPSX con Perl" %}}
