---
title: Combinar múltiples archivos OTP a través de Perl
description: Combine varios archivos Slides OTP con REST API y Open Source Perl SDK
family: slides
platformtag: perl
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos OTP con Perl" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos OTP con Perl" %}}
