---
title: Reemplazar texto en archivos PPSM a través de Perl
description: Reemplace texto en archivos Slides PPSM con API REST y SDK Perl de código abierto
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Reemplazar texto en archivos PPSM con Perl" h2="Busque y reemplace apariciones de texto en datos de Slides con Cloud SDK de código abierto para Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Reemplazo de texto en archivos PPSM con Perl" %}}
