---
title: Cree, combine, divida y convierta diapositivas de PowerPoint a través de cURL
description: Realice la creación, el procesamiento, la combinación y la conversión de diapositivas de presentaciones de PowerPoint y OpenOffice mediante simples comandos cURL a través de la API REST
weight: 40
family: slides
platform: cURL
---
...
{{< blocks/products/pf/i18n/upper-banner h1="Cree aplicaciones PPT Presentation Maker & Converter a través de cURL" h2="Realice la creación, el procesamiento, la combinación y la conversión de diapositivas de presentaciones de PowerPoint y OpenOffice mediante simples comandos cURL a través de la API REST" logoImageSrc="/headers/aspose_slides-for-curl.svg" pfName="Aspose.Slides" subTitlepfName="Cloud para cURL" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud for cURL le permite convertir presentaciones y diapositivas de PowerPoint y OpenOffice a otros formatos compatibles. Por ejemplo, puede convertir PPT a PDF, BMP, PNG, SVG, TIFF, JPEG, SWF y HTML. Puede realizar varias operaciones en diapositivas de presentación, temas de presentación, notas de diapositivas, imágenes de diapositivas, diapositivas maestras, fuentes personalizadas y varias otras propiedades de los documentos de presentación de Microsoft PowerPoint y OpenOffice.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-curl.png" alt="Cloud de cURL para presentaciones"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>cURL</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	 Es fácil comenzar con Aspose.Slides Cloud para cURL ya que no necesita instalar nada. Simplemente cree una cuenta en
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 y obtenga la información de su aplicación. Una vez que tenga el SID y la clave de la aplicación, estará listo para probar Aspose.Slides Cloud para cURL en cualquier plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Slides Cloud for cURL permite a los desarrolladores crear nuevas formas para las diapositivas de presentación. Puede leer y actualizar la información de propiedades de las formas de diapositivas existentes. También le permite representar formas de diapositivas en formatos de imagen compatibles. Aspose.Slides Cloud for cURL también lo ayuda a trabajar con notas de diapositivas de presentación.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Slides Cloud para cURL?" tabId="success-stories" >}}
