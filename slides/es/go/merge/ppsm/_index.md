---
title: Combinar múltiples archivos PPSM a través de Go
description: Combine varios archivos Slides PPSM con REST API y Open Source Go SDK
family: slides
platformtag: go
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos PPSM con Go" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos PPSM con Go" %}}
