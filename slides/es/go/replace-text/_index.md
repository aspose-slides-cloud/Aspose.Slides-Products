---
title: Reemplazar texto en presentaciones a través de Go
description: Reemplace texto en archivos Slides con API REST y SDK Go de código abierto
family: slides
platformtag: go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Reemplazar texto en presentaciones con Go" h2="Busque y reemplace apariciones de texto en datos de Slides con Cloud SDK de código abierto para Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Reemplazo de texto en presentaciones con Go" %}}
