---
title: Convertir de Slides PPTM a MD a través de Go
description: cree, edite o convierta archivos Slides PPTM a MD con REST API y Go SDK de código abierto
family: slides
platformtag: go
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPTM a MD con Go" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PPTM a MD con Go" %}}
