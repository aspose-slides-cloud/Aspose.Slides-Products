---
title: Convertir de Slides POTM a JPEG a través de Go
description: cree, edite o convierta archivos Slides POTM a JPEG con REST API y Go SDK de código abierto
family: slides
platformtag: go
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir POTM a JPEG con Go" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de POTM a JPEG con Go" %}}
