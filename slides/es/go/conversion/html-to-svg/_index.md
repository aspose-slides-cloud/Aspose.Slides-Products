---
title: Convertir de Slides HTML a SVG a través de Go
description: cree, edite o convierta archivos Slides HTML a SVG con REST API y Go SDK de código abierto
family: slides
platformtag: go
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir HTML a SVG con Go" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de HTML a SVG con Go" %}}
