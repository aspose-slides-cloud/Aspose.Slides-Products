---
title: Dividir Slides ODP en múltiples PPTM a través de Go
description: Dividir archivos de Slides ODP en diapositivas PPTM con REST API y Go SDK de código abierto
family: slides
platformtag: go
feature: split
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir ODP en múltiples PPTM con Go" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir ODP en PPTM con Go" %}}
