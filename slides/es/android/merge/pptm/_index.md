---
title: Combinar múltiples archivos PPTM a través de Android
description: Combine varios archivos Slides PPTM con REST API y Open Source Android SDK
family: slides
platformtag: android
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos PPTM con Android" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos PPTM con Android" %}}
