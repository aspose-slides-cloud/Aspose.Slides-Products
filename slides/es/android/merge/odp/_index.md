---
title: Combinar múltiples archivos ODP a través de Android
description: Combine varios archivos Slides ODP con REST API y Open Source Android SDK
family: slides
platformtag: android
feature: merge
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos ODP con Android" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos ODP con Android" %}}
...
1. Llame a uno de los métodos de combinación, dependiendo de dónde se encuentran sus archivos ODP de entrada, dónde desea almacenar el archivo combinado y si necesita combinar partes de los archivos
