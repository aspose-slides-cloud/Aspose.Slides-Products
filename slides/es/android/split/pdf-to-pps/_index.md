---
title: Dividir Slides PDF en múltiples PPS a través de Android
description: Dividir archivos de Slides PDF en diapositivas PPS con REST API y Android SDK de código abierto
family: slides
platformtag: android
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PDF en múltiples PPS con Android" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir PDF en PPS con Android" %}}
