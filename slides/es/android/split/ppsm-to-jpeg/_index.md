---
title: Dividir Slides PPSM en múltiples JPEG a través de Android
description: Dividir archivos de Slides PPSM en diapositivas JPEG con REST API y Android SDK de código abierto
family: slides
platformtag: android
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPSM en múltiples JPEG con Android" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir PPSM en JPEG con Android" %}}
