---
title: Dividir Slides PPS en múltiples HTML5 a través de Android
description: Dividir archivos de Slides PPS en diapositivas HTML5 con REST API y Android SDK de código abierto
family: slides
platformtag: android
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPS en múltiples HTML5 con Android" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir PPS en HTML5 con Android" %}}
