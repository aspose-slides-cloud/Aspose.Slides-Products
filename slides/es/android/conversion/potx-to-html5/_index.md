---
title: Convertir de Slides POTX a HTML5 a través de Android
description: cree, edite o convierta archivos Slides POTX a HTML5 con REST API y Android SDK de código abierto
family: slides
platformtag: android
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir POTX a HTML5 con Android" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de POTX a HTML5 con Android" %}}
