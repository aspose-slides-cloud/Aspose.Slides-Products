---
title: Convertir de Slides PPSM a POTX a través de Android
description: cree, edite o convierta archivos Slides PPSM a POTX con REST API y Android SDK de código abierto
family: slides
platformtag: android
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPSM a POTX con Android" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PPSM a POTX con Android" %}}
...
1. Llame a uno de los métodos de conversión, dependiendo de dónde esté su archivo PPSM de entrada y dónde desee almacenar el archivo POTX resultante.
