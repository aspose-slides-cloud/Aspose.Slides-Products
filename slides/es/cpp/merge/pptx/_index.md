---
title: Combinar múltiples archivos PPTX a través de C++
description: Combine varios archivos Slides PPTX con REST API y Open Source C++ SDK
family: slides
platformtag: cpp
feature: merge
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos PPTX con C++" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para C++">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos PPTX con C++" %}}
