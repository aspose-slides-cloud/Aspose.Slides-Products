---
title: Dividir Slides PPS en múltiples POTM a través de Swift
description: Dividir archivos de Slides PPS en diapositivas POTM con REST API y Swift SDK de código abierto
family: slides
platformtag: swift
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPS en múltiples POTM con Swift" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir PPS en POTM con Swift" %}}
