---
title: Combinar múltiples archivos POTM a través de Swift
description: Combine varios archivos Slides POTM con REST API y Open Source Swift SDK
family: slides
platformtag: swift
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos POTM con Swift" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos POTM con Swift" %}}
