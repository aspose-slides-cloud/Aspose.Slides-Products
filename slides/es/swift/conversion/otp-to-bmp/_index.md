---
title: Convertir de Slides OTP a BMP a través de Swift
description: cree, edite o convierta archivos Slides OTP a BMP con REST API y Swift SDK de código abierto
family: slides
platformtag: swift
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir OTP a BMP con Swift" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de OTP a BMP con Swift" %}}
