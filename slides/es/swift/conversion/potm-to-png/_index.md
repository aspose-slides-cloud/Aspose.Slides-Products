---
title: Convertir de Slides POTM a PNG a través de Swift
description: cree, edite o convierta archivos Slides POTM a PNG con REST API y Swift SDK de código abierto
family: slides
platformtag: swift
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir POTM a PNG con Swift" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de POTM a PNG con Swift" %}}
