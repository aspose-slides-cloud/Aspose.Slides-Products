---
title: Combinar múltiples archivos OTP a través de PHP
description: Combine varios archivos Slides OTP con REST API y Open Source PHP SDK
family: slides
platformtag: php
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos OTP con PHP" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos OTP con PHP" %}}
