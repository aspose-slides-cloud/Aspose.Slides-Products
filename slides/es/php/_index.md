---
title: Cree un visor y convertidor de diapositivas PPT PPTX a través de PHP REST SDK
description: Obtenga presentaciones de PowerPoint y OpenOffice desde el almacenamiento en la nube para ver, combinar, dividir y convertir diapositivas en la nube
weight: 100
family: slides
platform: PHP
---
...
{{< blocks/products/pf/i18n/upper-banner h1="PHP Cloud SDK para procesar diapositivas de presentación" h2="Obtenga presentaciones de PowerPoint y OpenOffice del almacenamiento en la nube para ver, combinar, dividir y convertir diapositivas en la nube." logoImageSrc="/headers/aspose_slides-for-php.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK para PHP" downloadUrl="" >}}
...
<p>Aspose.Slides Cloud SDK para PHP lo ayuda a crear aplicaciones PHP basadas en la nube que pueden crear diapositivas PPT y presentaciones de PowerPoint sin instalar ningún software. Aspose.Slides Cloud SDK para PHP también es compatible con los formatos de presentación de OpenOffice, ODP y OTP. Aspose.Slides Cloud SDK para PHP se basa en la API REST de Aspose.Slides y se ofrece bajo una licencia MIT.</p>
<p>Usando Aspose.Slides Cloud SDK para PHP, sus programas PHP en la nube podrían crear nuevas presentaciones o acceder a presentaciones existentes ubicadas en el almacenamiento en la nube. A través de nuestro PHP REST SDK, puede trabajar con toda la presentación, modificar diapositivas individuales, clonar diapositivas maestras, actualizar la secuencia interactiva de la presentación de PowerPoint y especificar fuentes personalizadas para usar en la presentación.</p>
<p>Aspose.Slides Cloud SDK para PHP ayuda a su código PHP a extraer formas, imágenes y notas de las diapositivas de la presentación. También puede convertir PPTX, PPT, ODP y OTP a formatos SWF, HTML, BMP, PNG, TIFF, JPEG, SVG.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="SDK de PHP para presentaciones"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>PHP</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	 Es fácil comenzar con Aspose.Slides Cloud PHP SDK ya que no necesita instalar nada. Simplemente cree una cuenta en
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 y obtenga la información de su aplicación. Una vez que tenga el SID y la clave de la aplicación, estará listo para probar Aspose.Slides Cloud PHP SDK en cualquier plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides Cloud SDK para PHP permite a los desarrolladores crear nuevas formas para diapositivas de presentación. Puede leer y actualizar la información de propiedades de las formas de diapositivas existentes. Nuestro SDK de nube de procesamiento de diapositivas de presentación le permite representar las formas de las diapositivas en formatos de imagen compatibles. Aspose.Slides Cloud SDK para PHP también lo ayuda a trabajar con notas de diapositivas de presentación.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-PHP" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Slides Cloud SDK para PHP?" tabId="success-stories" >}}
