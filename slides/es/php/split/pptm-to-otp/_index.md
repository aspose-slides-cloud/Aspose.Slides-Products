---
title: Dividir Slides PPTM en múltiples OTP a través de PHP
description: Dividir archivos de Slides PPTM en diapositivas OTP con REST API y PHP SDK de código abierto
family: slides
platformtag: php
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPTM en múltiples OTP con PHP" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir PPTM en OTP con PHP" %}}
