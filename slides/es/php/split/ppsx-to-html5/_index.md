---
title: Dividir Slides PPSX en múltiples HTML5 a través de PHP
description: Dividir archivos de Slides PPSX en diapositivas HTML5 con REST API y PHP SDK de código abierto
family: slides
platformtag: php
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPSX en múltiples HTML5 con PHP" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir PPSX en HTML5 con PHP" %}}
