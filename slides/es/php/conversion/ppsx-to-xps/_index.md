---
title: Convertir de Slides PPSX a XPS a través de PHP
description: cree, edite o convierta archivos Slides PPSX a XPS con REST API y PHP SDK de código abierto
family: slides
platformtag: php
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PPSX a XPS con PHP" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Conversión de PPSX a XPS con PHP" %}}
