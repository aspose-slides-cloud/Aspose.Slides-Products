---
title: Combinar múltiples archivos POTX a través de Java
description: Combine varios archivos Slides POTX con REST API y Open Source Java SDK
family: slides
platformtag: java
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Combinar múltiples archivos POTX con Java" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Fusión de archivos POTX con Java" %}}
