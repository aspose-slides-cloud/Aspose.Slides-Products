---
title: Dividir Slides PPTM en múltiples POTX a través de Java
description: Dividir archivos de Slides PPTM en diapositivas POTX con REST API y Java SDK de código abierto
family: slides
platformtag: java
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Dividir PPTM en múltiples POTX con Java" h2="Lea, edite y exporte datos de Slides a otros formatos con Cloud SDK de código abierto para Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dividir PPTM en POTX con Java" %}}
