---
title: Reemplazar texto en archivos POTX a través de Java
description: Reemplace texto en archivos Slides POTX con API REST y SDK Java de código abierto
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Reemplazar texto en archivos POTX con Java" h2="Busque y reemplace apariciones de texto en datos de Slides con Cloud SDK de código abierto para Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Reemplazo de texto en archivos POTX con Java" %}}
