---
title: Cree un visor y convertidor de PPT basado en la nube a través de Java SDK
description: Desarrolle aplicaciones Java basadas en la nube para acceder a presentaciones de PowerPoint y OpenOffice almacenadas en la nube para visualización, procesamiento y conversión
weight: 60
family: slides
platform: Java
---
...
{{< blocks/products/pf/i18n/upper-banner h1="API REST de Java para procesar presentaciones PPT" h2="Desarrolle aplicaciones Java basadas en la nube para acceder a presentaciones de PowerPoint y OpenOffice almacenadas en la nube para visualización, procesamiento y conversión." logoImageSrc="/headers/aspose_slides-for-java.svg" pfName="Aspose.Slides" subTitlepfName="Cloud SDK para Java" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="Cloud SDK para Java" >}}
...
<p>Aspose.Slides Cloud SDK para Java ayuda a los programadores a crear soluciones basadas en la nube para crear, ver, procesar y convertir presentaciones de PowerPoint y OpenOffice en la nube. Aspose.Slides Cloud SDK para Java funciona como una interfaz para la API REST subyacente de Aspose.Slides y se ofrece bajo una licencia MIT.</p>
<p>Con Aspose.Slides Cloud SDK para Java, puede crear rápidamente aplicaciones de creación de presentaciones, visor de diapositivas y conversión de presentaciones basadas en la nube en Java. Puede trabajar con diapositivas maestras, temas de presentación, notas de diapositivas y fuentes personalizadas.</p>
<p>Aspose.Slides Cloud SDK para Java también permite que su código Java procese imágenes, formas y animaciones en diapositivas de PowerPoint. Con nuestro Java Cloud SDK, puede convertir formatos de archivo PPT, PPTX, ODP y OTP a PDF, XPS, SVG, BMP, TIFF, JPEG, PNG, HTML y SWF.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-java.png" alt="Java Slides Cloud"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Java</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-java.png" alt="SDK de Java para presentaciones"><header>Aspose.Slides</header><footer>Cloud <small> <em>para </em> </small>Java</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	 Es fácil comenzar con Aspose.Slides Cloud Java SDK ya que no necesita instalar nada. Simplemente cree una cuenta en
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose Cloud
     </a>
	 y obtenga la información de su aplicación. Una vez que tenga el SID y la clave de la aplicación, estará listo para probar Aspose.Slides Cloud Java SDK en cualquier plataforma.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Slides Cloud SDK para Java permite a los desarrolladores crear nuevas formas para diapositivas de presentación. Puede leer y actualizar la información de propiedades de las formas de diapositivas existentes. Nuestro SDK de nube de procesamiento de diapositivas de presentación le permite representar las formas de las diapositivas en formatos de imagen compatibles. Aspose.Slides Cloud SDK para Java también lo ayuda a trabajar con notas de diapositivas de presentación.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Código fuente" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-Java" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="¿Por qué Aspose.Slides Cloud SDK para Java?" tabId="success-stories" >}}
