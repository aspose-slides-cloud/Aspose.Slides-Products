---
title: Java를 통해 PPSX 파일의 텍스트 바꾸기
description: Slides PPSX 파일의 텍스트를 REST API 및 오픈 소스 Java SDK로 교체
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSX 파일의 텍스트를 Java로 바꾸기" h2="Java용 오픈소스 Cloud SDK를 사용하여 Slides 데이터에서 텍스트 찾기 및 바꾸기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSX 파일의 텍스트를 Java로 바꾸기" %}}
