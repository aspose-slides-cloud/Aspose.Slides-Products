---
title: Java를 통해 여러 POTM 파일 병합
description: REST API 및 오픈 소스 Java SDK를 사용하여 여러 Slides POTM 파일 병합
family: slides
platformtag: java
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Java로 여러 POTM 파일 병합" h2="Java용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTM 파일을 Java와 병합" %}}
