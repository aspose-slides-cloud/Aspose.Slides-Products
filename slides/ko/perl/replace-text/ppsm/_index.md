---
title: Perl를 통해 PPSM 파일의 텍스트 바꾸기
description: Slides PPSM 파일의 텍스트를 REST API 및 오픈 소스 Perl SDK로 교체
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPSM 파일의 텍스트를 Perl로 바꾸기" h2="Perl용 오픈소스 Cloud SDK를 사용하여 Slides 데이터에서 텍스트 찾기 및 바꾸기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSM 파일의 텍스트를 Perl로 바꾸기" %}}
