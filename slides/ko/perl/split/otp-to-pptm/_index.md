---
title: Perl를 통해 Slides OTP를 여러 PPTM로 분할
description: REST API 및 오픈 소스 Perl SDK를 사용하여 Slides OTP 파일을 PPTM 슬라이드로 분할
family: slides
platformtag: perl
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Perl를 사용하여 OTP를 여러 PPTM로 분할" h2="Perl용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Perl로 OTP를 PPTM로 분할" %}}
