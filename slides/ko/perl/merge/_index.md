---
title: Perl를 통해 여러 프레젠테이션 병합
description: REST API 및 오픈 소스 Perl SDK로 여러 프레젠테이션 병합
family: slides
platformtag: perl
feature: merge
platform: Perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Perl로 여러 프레젠테이션 병합" h2="Perl용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="프레젠테이션을 Perl와 병합" %}}
