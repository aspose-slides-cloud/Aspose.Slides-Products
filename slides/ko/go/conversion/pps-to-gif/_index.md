---
title: Go를 통해 Slides PPS에서 GIF로 변환
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Go를 사용하여 PPS를 GIF로 변환" h2="Go용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Go로 PPS를 GIF로 변환" %}}
