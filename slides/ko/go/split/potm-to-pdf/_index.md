---
title: Go를 통해 Slides POTM를 여러 PDF로 분할
description: REST API 및 오픈 소스 Go SDK를 사용하여 Slides POTM 파일을 PDF 슬라이드로 분할
family: slides
platformtag: go
feature: split
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Go를 사용하여 POTM를 여러 PDF로 분할" h2="Go용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Go로 POTM를 PDF로 분할" %}}
