---
title: Aspose.Slides Android용 Cloud SDK
description: REST API를 통해 Microsoft PowerPoint 및 OpenOffice 프레젠테이션과 슬라이드를 생성하거나 변환할 수 있는 클라우드 기반 Android 애플리케이션 만들기
weight: 20
family: slides
platform: Android
---
...
{{< blocks/products/pf/i18n/upper-banner h1="PPT, PPTX 프레젠테이션을 변환하는 Android Cloud SDK" h2="REST API를 통해 Microsoft PowerPoint 및 OpenOffice 프레젠테이션과 슬라이드를 생성하거나 변환할 수 있는 클라우드 기반 Android 애플리케이션을 만드세요." logoImageSrc="/headers/aspose_slides-for-android.svg" pfName="Aspose.Slides" subTitlepfName="Cloud Android SDK" downloadUrl="" >}}
...
<p>Cloud SDK는 프레젠테이션 만들기 및 편집, 지원되는 다른 파일 형식으로 프레젠테이션 내보내기, 프레젠테이션 병합 및 분할, 슬라이드 추가 및 관리, 프레젠테이션에 슬라이드 레이아웃 추가, 프레젠테이션에 이미지 삽입 등과 같은 수많은 프레젠테이션 관련 기능을 완벽하게 지원합니다. PPT, POT, PPS, PPTX, POTX, PPSX, PPTM, PPSM, POTM, ODP, OTP, TIFF, PDF, XPS, JPEG, PNG, GIF, BMP, SVG, SWF, HTML 등.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/left-->
<div class="d1-col d1-right"><header>개요</header>
<ul>
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-android.png" alt="Android Slides Cloud"><header>Aspose.Slides</header><footer>Android<small><em>용</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-android.png" alt="프레젠테이션용 Android SDK"><header>Aspose.Slides</header><footer>Android<small><em>용</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	  설치할 필요가 없으므로 Aspose.Slides Cloud Android SDK를 쉽게 시작할 수 있습니다. <a href="https://dashboard.aspose.cloud/#/apps">Aspose for Cloud</a>에서 계정을 생성하고 애플리케이션 정보를 얻으십시오. 앱 SID 및 키가 있으면 Aspose.Slides Cloud Android SDK를 모든 플랫폼에서 사용해 볼 수 있습니다.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     PowerPoint 프레젠테이션을 다른 파일 형식으로 변환
    </h2>
    <p>
     Aspose.Slides Cloud Android SDK는 소프트웨어 개발자에게 PowerPoint 프레젠테이션 파일을 자신의 Android 애플리케이션 내에서 지원되는 여러 다른 파일 형식으로 변환할 수 있는 기능을 제공합니다. SDK는 TIFF, PDF, PPTX, XPS, PPT 등과 같은 형식으로의 변환을 지원합니다. PowerPoint 문서에서 텍스트 및 이미지와 같은 콘텐츠를 추출할 수 있습니다.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Android에서 PowerPoint 프레젠테이션 슬라이드 작업
    </h2>
    <p>
     Aspose.Slides Cloud Android SDK는 컴퓨터 프로그래머에게 자신의 Android 애플리케이션 내에서 프레젠테이션 슬라이드로 작업할 수 있는 기능을 제공합니다. SDK는 또한 새 슬라이드 추가, 슬라이드 복사, 슬라이드 주석 관리, 슬라이드를 새 위치로 이동, 슬라이드 삭제, 슬라이드 배경 관리 등과 같은 몇 가지 중요한 기능을 완벽하게 지원합니다. 또한 슬라이드를 이미지 파일 형식 및 기타 여러 파일 형식으로 내보낼 수도 있습니다.
    </p>
    <h2 class="h2title">
     프레젠테이션에서 도형 작업
    </h2>
    <p>
     Aspose.Slides Cloud Android SDK를 사용하면 소프트웨어 개발자가 자신의 애플리케이션 내에서 도형으로 작업할 수 있습니다. Android SDK는 슬라이드에서 도형 추출, 슬라이드에서 특정 도형 가져오기, 그룹 도형에 도형 개체 추가, 그룹 도형에서 도형 개체 삭제, 타사 저장소, 스마트 아트 모양 관리 등으로 작업합니다.
    </p>
    <h2 class="h2title">
     프레젠테이션 테마 작업
    </h2>
    <p>
     Aspose.Slides Cloud Android SDK를 사용하면 소프트웨어 개발자가 자신의 Android 애플리케이션 내에서 프레젠테이션 테마를 작업할 수 있습니다. 개발자는 PowerPoint 프레젠테이션에서 슬라이드의 FontScheme 및 FormatScheme을 가져올 수 있습니다. ColorScheme 정보를 읽거나 PowerPoint 프레젠테이션의 슬라이드 테마를 쉽게 가져올 수 있습니다.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Android용 Aspose.Slides Cloud SDK가 필요한 이유는 무엇입니까?" tabId="success-stories" >}}
