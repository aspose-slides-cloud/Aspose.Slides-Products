---
title: Android를 통해 여러 HTML 파일 병합
description: REST API 및 오픈 소스 Android SDK를 사용하여 여러 Slides HTML 파일 병합
family: slides
platformtag: android
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Android로 여러 HTML 파일 병합" h2="Android용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="HTML 파일을 Android와 병합" %}}
