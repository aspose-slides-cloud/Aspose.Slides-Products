---
title: Swift를 통해 PPTM 파일의 텍스트 바꾸기
description: Slides PPTM 파일의 텍스트를 REST API 및 오픈 소스 Swift SDK로 교체
family: slides
platformtag: swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPTM 파일의 텍스트를 Swift로 바꾸기" h2="Swift용 오픈소스 Cloud SDK를 사용하여 Slides 데이터에서 텍스트 찾기 및 바꾸기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTM 파일의 텍스트를 Swift로 바꾸기" %}}
