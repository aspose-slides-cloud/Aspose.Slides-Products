---
title: Swift를 통해 Slides PPT를 여러 PPSX로 분할
description: REST API 및 오픈 소스 Swift SDK를 사용하여 Slides PPT 파일을 PPSX 슬라이드로 분할
family: slides
platformtag: swift
feature: split
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Swift를 사용하여 PPT를 여러 PPSX로 분할" h2="Swift용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Swift로 PPT를 PPSX로 분할" %}}
