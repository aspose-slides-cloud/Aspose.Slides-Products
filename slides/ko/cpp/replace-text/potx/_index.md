---
title: C++를 통해 POTX 파일의 텍스트 바꾸기
description: Slides POTX 파일의 텍스트를 REST API 및 오픈 소스 C++ SDK로 교체
family: slides
platformtag: cpp
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="POTX 파일의 텍스트를 C++로 바꾸기" h2="C++용 오픈소스 Cloud SDK를 사용하여 Slides 데이터에서 텍스트 찾기 및 바꾸기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX 파일의 텍스트를 C++로 바꾸기" %}}
