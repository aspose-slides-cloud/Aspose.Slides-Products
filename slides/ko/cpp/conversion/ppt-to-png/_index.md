---
title: C++를 통해 Slides PPT에서 PNG로 변환
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C++를 사용하여 PPT를 PNG로 변환" h2="C++용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C++로 PPT를 PNG로 변환" %}}
