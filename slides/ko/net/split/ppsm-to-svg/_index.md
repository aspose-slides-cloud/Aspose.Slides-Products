---
title: .NET를 통해 Slides PPSM를 여러 SVG로 분할
description: REST API 및 오픈 소스 .NET SDK를 사용하여 Slides PPSM 파일을 SVG 슬라이드로 분할
family: slides
platformtag: net
feature: split
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1=".NET를 사용하여 PPSM를 여러 SVG로 분할" h2=".NET용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET로 PPSM를 SVG로 분할" %}}
