---
title: .NET를 통해 여러 PPT 파일 병합
description: REST API 및 오픈 소스 .NET SDK를 사용하여 여러 Slides PPT 파일 병합
family: slides
platformtag: net
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1=".NET로 여러 PPT 파일 병합" h2=".NET용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPT 파일을 .NET와 병합" %}}
