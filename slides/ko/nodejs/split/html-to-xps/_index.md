---
title: Node.js를 통해 Slides HTML를 여러 XPS로 분할
description: REST API 및 오픈 소스 Node.js SDK를 사용하여 Slides HTML 파일을 XPS 슬라이드로 분할
family: slides
platformtag: nodejs
feature: split
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Node.js를 사용하여 HTML를 여러 XPS로 분할" h2="Node.js용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Node.js로 HTML를 XPS로 분할" %}}
