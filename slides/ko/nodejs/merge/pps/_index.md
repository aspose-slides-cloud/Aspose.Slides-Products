---
title: Node.js를 통해 여러 PPS 파일 병합
description: REST API 및 오픈 소스 Node.js SDK를 사용하여 여러 Slides PPS 파일 병합
family: slides
platformtag: nodejs
feature: merge
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Node.js로 여러 PPS 파일 병합" h2="Node.js용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPS 파일을 Node.js와 병합" %}}
