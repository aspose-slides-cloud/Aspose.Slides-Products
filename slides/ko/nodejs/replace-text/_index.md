---
title: Node.js를 통해 프레젠테이션의 텍스트 바꾸기
description: Slides 파일의 텍스트를 REST API 및 오픈 소스 Node.js SDK로 교체
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="프레젠테이션의 텍스트를 Node.js 바꾸기" h2="Node.js용 오픈소스 Cloud SDK를 사용하여 Slides 데이터에서 텍스트 찾기 및 바꾸기">}}
