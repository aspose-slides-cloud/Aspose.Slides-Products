---
title: cURL를 통해 PPT 파일의 텍스트 바꾸기
description: Slides PPT 파일의 텍스트를 REST API 및 오픈 소스 cURL SDK로 교체
family: slides
platformtag: curl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PPT 파일의 텍스트를 cURL로 바꾸기" h2="cURL용 오픈소스 Cloud SDK를 사용하여 Slides 데이터에서 텍스트 찾기 및 바꾸기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPT 파일의 텍스트를 cURL로 바꾸기" %}}
