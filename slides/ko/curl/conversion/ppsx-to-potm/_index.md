---
title: cURL를 통해 Slides PPSX에서 POTM로 변환
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL를 사용하여 PPSX를 POTM로 변환" h2="cURL용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL로 PPSX를 POTM로 변환" %}}
