---
title: cURL를 통해 Slides ODP에서 MPEG4로 변환
description: REST API 및 오픈 소스 cURL SDK를 사용하여 Slides ODP 파일을 PDF로 생성, 편집 또는 변환
family: slides
platformtag: curl
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="cURL를 사용하여 ODP를 MPEG4로 변환" h2="cURL용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="cURL로 ODP를 MPEG4로 변환" %}}
