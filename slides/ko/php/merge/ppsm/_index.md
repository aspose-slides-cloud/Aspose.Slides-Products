---
title: PHP를 통해 여러 PPSM 파일 병합
description: REST API 및 오픈 소스 PHP SDK를 사용하여 여러 Slides PPSM 파일 병합
family: slides
platformtag: php
feature: merge
informat: PPSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PHP로 여러 PPSM 파일 병합" h2="PHP용 오픈소스 Cloud SDK를 사용하여 Slides 데이터를 읽고 편집하고 다른 형식으로 내보내기">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPSM 파일을 PHP와 병합" %}}
