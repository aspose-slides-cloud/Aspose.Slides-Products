---
title: PHP REST SDK를 통해 PPT PPTX 슬라이드 뷰어 및 변환기 구축
description: 클라우드 스토리지에서 PowerPoint 및 OpenOffice 프레젠테이션을 가져와 클라우드에서 슬라이드를 보고, 병합, 분할 및 변환
weight: 100
family: slides
platform: PHP
---
...
{{< blocks/products/pf/i18n/upper-banner h1="프레젠테이션 슬라이드를 처리하는 PHP 클라우드 SDK" h2="클라우드 스토리지에서 PowerPoint 및 OpenOffice 프레젠테이션을 가져와 클라우드에서 슬라이드를 보고, 병합, 분할 및 변환합니다." logoImageSrc="/headers/aspose_slides-for-php.svg" pfName="Aspose.Slides" subTitlepfName="PHP용 Cloud SDK" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Slides" subTitlepfName="PHP용 Cloud SDK" >}}
...
<p>PHP용 Aspose.Slides Cloud SDK를 사용하면 소프트웨어를 설치하지 않고도 PPT 슬라이드와 PowerPoint 프레젠테이션을 만들 수 있는 클라우드 기반 PHP 애플리케이션을 만들 수 있습니다. PHP용 Aspose.Slides Cloud SDK는 OpenOffice 프레젠테이션 형식, ODP 및 OTP도 지원합니다. PHP용 Aspose.Slides Cloud SDK는 Aspose.Slides REST API를 기반으로 하며 MIT 라이선스에 따라 제공됩니다.</p>
<p>PHP용 Aspose.Slides Cloud SDK를 사용하면 클라우드 PHP 프로그램에서 새 프레젠테이션을 만들거나 클라우드 저장소에 있는 기존 프레젠테이션에 액세스할 수 있습니다. PHP REST SDK를 통해 전체 프레젠테이션으로 작업하고, 개별 슬라이드를 수정하고, 마스터 슬라이드를 복제하고, PowerPoint 프레젠테이션의 대화형 시퀀스를 업데이트하고, 프레젠테이션에 사용할 사용자 지정 글꼴을 지정할 수 있습니다.</p>
<p>PHP용 Aspose.Slides Cloud SDK는 프레젠테이션 슬라이드에서 모양, 이미지 및 메모를 추출하기 위해 PHP 코드를 지원합니다. PPTX, PPT, ODP 및 OTP를 SWF, HTML, BMP, PNG, TIFF, JPEG, SVG 형식으로 변환할 수도 있습니다.</p>
{{< /blocks/products/pf/i18n/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="PHP Slides Cloud"><header>Aspose.Slides</header><footer>PHP<small><em>용</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_slides-for-php.png" alt="프레젠테이션용 PHP SDK"><header>Aspose.Slides</header><footer>PHP<small><em>용</em></small> Cloud</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
	  설치할 필요가 없으므로 Aspose.Slides Cloud PHP SDK를 쉽게 시작할 수 있습니다. <a href="https://dashboard.aspose.cloud/#/apps">Aspose for Cloud</a>에서 계정을 생성하고 애플리케이션 정보를 얻으십시오. 앱 SID 및 키가 있으면 Aspose.Slides Cloud PHP SDK를 모든 플랫폼에서 사용해 볼 수 있습니다.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     PHP Aspose.Slides Cloud SDK를 사용하면 개발자는 기본에서 고급 프레젠테이션 슬라이드 처리 작업을 수행할 수 있습니다. 프레젠테이션 슬라이드 정보를 읽을 수 있습니다. 새 슬라이드를 만듭니다. 기존 슬라이드를 복사, 수정 또는 삭제합니다. Cloud SDK를 통해 프레젠테이션 슬라이드를 PowerPoint 형식에서 지원되는 다른 형식으로 변환하세요. 새 배경을 적용하여 슬라이드 배경을 조작하고 슬라이드의 기존 배경을 읽고 제거할 수도 있습니다. PHP용 Aspose.Slides Cloud SDK를 사용하면 프레젠테이션 내에서 슬라이드 위치를 재정렬할 수 있습니다. 현재 또는 다른 프레젠테이션에서 슬라이드를 복사할 수도 있습니다. 프레젠테이션 슬라이드 설명도 검색할 수 있습니다.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     PHP용 Aspose.Slides Cloud SDK를 사용하면 개발자가 프레젠테이션 슬라이드를 위한 새로운 모양을 만들 수 있습니다. 기존 슬라이드 도형의 속성 정보를 읽고 업데이트할 수 있습니다. Cloud SDK를 처리하는 프레젠테이션 슬라이드를 사용하면 슬라이드 모양을 지원되는 이미지 형식으로 렌더링할 수 있습니다. PHP용 Aspose.Slides Cloud SDK도 프레젠테이션 슬라이드 노트 작업을 도와줍니다.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="소스 코드" href="https://github.com/aspose-slides-cloud/Aspose.Slides-Cloud-SDK-for-PHP" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="PHP용 Aspose.Slides Cloud SDK가 필요한 이유는 무엇입니까?" tabId="success-stories" >}}
