---
title: Convert from Slides POTX to HTML5 via NodeJS 
description: Create, Edit or Convert Slides files with REST API & Open Source NodeJS SDK
url: /nodejs/conversion/potx-to-html5/
family: slides
platformtag: nodejs
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert POTX to HTML5 with NodeJS" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX to HTML5 Conversion with NodeJS" %}}
