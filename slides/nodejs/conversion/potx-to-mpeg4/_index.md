---
title: Convert from Slides POTX to MPEG4 via NodeJS 
description: Create, Edit or Convert Slides files with REST API & Open Source NodeJS SDK
url: /nodejs/conversion/potx-to-mpeg4/
family: slides
platformtag: nodejs
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert POTX to MPEG4 with NodeJS" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTX to MPEG4 Conversion with NodeJS" %}}
