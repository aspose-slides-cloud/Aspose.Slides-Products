---
title: Convert from Slides PPTX to MPEG4 via NodeJS 
description: Create, Edit or Convert Slides files with REST API & Open Source NodeJS SDK
url: /nodejs/conversion/pptx-to-mpeg4/
family: slides
platformtag: nodejs
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert PPTX to MPEG4 with NodeJS" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PPTX to MPEG4 Conversion with NodeJS" %}}
