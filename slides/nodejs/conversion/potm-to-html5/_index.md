---
title: Convert from Slides POTM to HTML5 via NodeJS 
description: Create, Edit or Convert Slides files with REST API & Open Source NodeJS SDK
url: /nodejs/conversion/potm-to-html5/
family: slides
platformtag: nodejs
feature: conversion
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert POTM to HTML5 with NodeJS" h2="Read, Edit & Export Slides data to other formats with open source Cloud SDK for NodeJS">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="POTM to HTML5 Conversion with NodeJS" %}}
