---
title: Konwersja z Slides HTML na PPSM za pomocą Go
description: Twórz, edytuj lub konwertuj pliki Slides HTML do formatu PPSM za pomocą interfejsu API REST i pakietu SDK Go o otwartym kodzie źródłowym
family: slides
platformtag: go
feature: conversion
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj HTML na PPSM za pomocą Go" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja HTML do PPSM za pomocą Go" %}}
