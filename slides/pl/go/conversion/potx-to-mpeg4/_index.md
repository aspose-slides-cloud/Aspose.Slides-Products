---
title: Konwersja z Slides POTX na MPEG4 za pomocą Go
description: Twórz, edytuj lub konwertuj pliki Slides POTX do formatu MPEG4 za pomocą interfejsu API REST i pakietu SDK Go o otwartym kodzie źródłowym
family: slides
platformtag: go
feature: conversion
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj POTX na MPEG4 za pomocą Go" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja POTX do MPEG4 za pomocą Go" %}}
