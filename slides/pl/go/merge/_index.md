---
title: Scal wiele prezentacji za pomocą Go
description: Połącz wiele prezentacji za pomocą REST API i Open Source Go SDK
family: slides
platformtag: go
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Scal wiele prezentacji za pomocą {{platform}" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie prezentacji z Go" %}}
