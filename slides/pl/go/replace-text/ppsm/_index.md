---
title: Zastępowanie tekstu w plikach PPSM poprzez Go
description: Zamień tekst w plikach Slides PPSM przy użyciu interfejsu API REST i pakietu SDK Go typu open source
family: slides
platformtag: go
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Zastępowanie tekstu w plikach PPSM przez Go" h2="Znajdź i zamień wystąpienia tekstu w danych Slides za pomocą pakietu SDK Cloud SDK o otwartym kodzie źródłowym dla Go">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Zastępowanie tekstu w plikach PPSM przez Go" %}}
