---
title: Konwersja prezentacji poprzez PHP
description: Twórz, edytuj lub konwertuj pliki Padaca za pomocą interfejsu API REST i pakietu PHP SDK o otwartym kodzie źródłowym
family: slides
platformtag: php
feature: conversion
platform: PHP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj prezentacje za pomocą PHP" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja prezentacji za pomocą PHP" %}}
