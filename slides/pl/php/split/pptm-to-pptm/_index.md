---
title: Podziel Slides PPTM na wiele plików PPTM za pomocą PHP
description: Podziel pliki Slides PPTM na slajdy PPTM za pomocą interfejsu API REST i pakietu PHP SDK o otwartym kodzie źródłowym
family: slides
platformtag: php
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Podziel PPTM na wiele plików PPTM za pomocą PHP" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dzielenie PPTM na PPTM za pomocą PHP" %}}
