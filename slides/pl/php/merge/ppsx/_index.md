---
title: Scal wiele plików PPSX za pomocą PHP
description: Połącz wiele plików Slides PPSX za pomocą interfejsu API REST i pakietu PHP SDK o otwartym kodzie źródłowym
family: slides
platformtag: php
feature: merge
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików PPSX z PHP" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla PHP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików PPSX za pomocą PHP" %}}
