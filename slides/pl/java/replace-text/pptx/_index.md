---
title: Zastępowanie tekstu w plikach PPTX poprzez Java
description: Zamień tekst w plikach Slides PPTX przy użyciu interfejsu API REST i pakietu SDK Java typu open source
family: slides
platformtag: java
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Zastępowanie tekstu w plikach PPTX przez Java" h2="Znajdź i zamień wystąpienia tekstu w danych Slides za pomocą pakietu SDK Cloud SDK o otwartym kodzie źródłowym dla Java">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Zastępowanie tekstu w plikach PPTX przez Java" %}}
