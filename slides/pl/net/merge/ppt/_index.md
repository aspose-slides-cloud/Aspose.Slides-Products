---
title: Scal wiele plików PPT za pomocą .NET
description: Połącz wiele plików Slides PPT za pomocą interfejsu API REST i pakietu .NET SDK o otwartym kodzie źródłowym
family: slides
platformtag: net
feature: merge
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików PPT z .NET" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla .NET">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików PPT za pomocą .NET" %}}
