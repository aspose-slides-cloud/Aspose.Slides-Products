---
title: Scal wiele plików ODP za pomocą Python
description: Połącz wiele plików Slides ODP za pomocą interfejsu API REST i pakietu Python SDK o otwartym kodzie źródłowym
family: slides
platformtag: python
feature: merge
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików ODP z Python" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików ODP za pomocą Python" %}}
