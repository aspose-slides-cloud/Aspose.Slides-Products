---
title: Podziel Slides PPSX na wiele plików JPEG za pomocą Python
description: Podziel pliki Slides PPSX na slajdy JPEG za pomocą interfejsu API REST i pakietu Python SDK o otwartym kodzie źródłowym
family: slides
platformtag: python
feature: split
informat: PPSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Podziel PPSX na wiele plików JPEG za pomocą Python" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dzielenie PPSX na JPEG za pomocą Python" %}}
...
1. Wywołaj jedną z metod podziału, w zależności od tego, gdzie znajduje się wejściowy plik PPSX i gdzie chcesz przechowywać wynikowe pliki JPEG
    ...
    - ```split_online```, aby podzielić plik lokalny i pobrać wynik jako archiwum ZIP. Każdy slajd wejściowego PPSX jest pobierany jako oddzielny plik JPEG w archiwum ZIP.
    - ```split_and_save_online```, aby podzielić plik lokalny i zapisać wynik w magazynie. Każdy slajd wejściowego PPSX jest zapisywany jako oddzielny plik JPEG w określonym folderze przechowywania (lub domyślnie w folderze głównym).
