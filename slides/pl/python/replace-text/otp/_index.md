---
title: Zastępowanie tekstu w plikach OTP poprzez Python
description: Zamień tekst w plikach Slides OTP przy użyciu interfejsu API REST i pakietu SDK Python typu open source
family: slides
platformtag: python
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Zastępowanie tekstu w plikach OTP przez Python" h2="Znajdź i zamień wystąpienia tekstu w danych Slides za pomocą pakietu SDK Cloud SDK o otwartym kodzie źródłowym dla Python">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Zastępowanie tekstu w plikach OTP przez Python" %}}
