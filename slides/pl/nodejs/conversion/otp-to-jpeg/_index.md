---
title: Konwersja z Slides OTP na JPEG za pomocą Node.js
description: Twórz, edytuj lub konwertuj pliki Slides OTP do formatu JPEG za pomocą interfejsu API REST i pakietu SDK Node.js o otwartym kodzie źródłowym
family: slides
platformtag: nodejs
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj OTP na JPEG za pomocą Node.js" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja OTP do JPEG za pomocą Node.js" %}}
