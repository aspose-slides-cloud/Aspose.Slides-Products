---
title: Scal wiele plików POTM za pomocą Node.js
description: Połącz wiele plików Slides POTM za pomocą interfejsu API REST i pakietu Node.js SDK o otwartym kodzie źródłowym
family: slides
platformtag: nodejs
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików POTM z Node.js" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików POTM za pomocą Node.js" %}}
...
1. Wywołaj jedną z metod scalania, w zależności od tego, gdzie znajdują się wejściowe pliki POTM, gdzie chcesz przechowywać scalony plik i czy chcesz scalić części plików
