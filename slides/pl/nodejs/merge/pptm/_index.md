---
title: Scal wiele plików PPTM za pomocą Node.js
description: Połącz wiele plików Slides PPTM za pomocą interfejsu API REST i pakietu Node.js SDK o otwartym kodzie źródłowym
family: slides
platformtag: nodejs
feature: merge
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików PPTM z Node.js" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików PPTM za pomocą Node.js" %}}
