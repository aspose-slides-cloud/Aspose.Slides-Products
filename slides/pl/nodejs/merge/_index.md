---
title: Scal wiele prezentacji za pomocą Node.js
description: Połącz wiele prezentacji za pomocą REST API i Open Source Node.js SDK
family: slides
platformtag: nodejs
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Scal wiele prezentacji za pomocą {{platform}" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie prezentacji z Node.js" %}}
...
1. Wywołaj jedną z metod scalania, w zależności od tego, gdzie znajdują się pliki wejściowe, gdzie chcesz przechowywać scalony plik i czy musisz scalić części plików
