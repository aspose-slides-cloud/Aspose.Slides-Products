---
title: Zastępowanie tekstu w plikach PPT poprzez Node.js
description: Zamień tekst w plikach Slides PPT przy użyciu interfejsu API REST i pakietu SDK Node.js typu open source
family: slides
platformtag: nodejs
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Zastępowanie tekstu w plikach PPT przez Node.js" h2="Znajdź i zamień wystąpienia tekstu w danych Slides za pomocą pakietu SDK Cloud SDK o otwartym kodzie źródłowym dla Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Zastępowanie tekstu w plikach PPT przez Node.js" %}}
...
1. Wywołaj jedną z metod zamiany tekstu, w zależności od tego, gdzie znajdują się Twoje pliki PPT i czy chcesz zastąpić tekst w całym dokumencie, czy na pojedynczym slajdzie
...
{{< blocks/products/pf/cloud-app app="replaceText" language="nodejs" inputFormat="ppt" >}}
