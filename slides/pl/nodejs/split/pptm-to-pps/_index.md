---
title: Podziel Slides PPTM na wiele plików PPS za pomocą Node.js
description: Podziel pliki Slides PPTM na slajdy PPS za pomocą interfejsu API REST i pakietu Node.js SDK o otwartym kodzie źródłowym
family: slides
platformtag: nodejs
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Podziel PPTM na wiele plików PPS za pomocą Node.js" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dzielenie PPTM na PPS za pomocą Node.js" %}}
