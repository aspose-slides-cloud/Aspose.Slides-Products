---
title: Podziel Slides PPS na wiele plików XAML za pomocą Node.js
description: Podziel pliki Slides PPS na slajdy XAML za pomocą interfejsu API REST i pakietu Node.js SDK o otwartym kodzie źródłowym
family: slides
platformtag: nodejs
feature: split
informat: PPS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Podziel PPS na wiele plików XAML za pomocą Node.js" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dzielenie PPS na XAML za pomocą Node.js" %}}
