---
title: Podziel Slides PDF na wiele plików ODP za pomocą Node.js
description: Podziel pliki Slides PDF na slajdy ODP za pomocą interfejsu API REST i pakietu Node.js SDK o otwartym kodzie źródłowym
family: slides
platformtag: nodejs
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Podziel PDF na wiele plików ODP za pomocą Node.js" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Node.js">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dzielenie PDF na ODP za pomocą Node.js" %}}
