---
title: Konwersja z Slides ODP na POTX za pomocą cURL
description: Twórz, edytuj lub konwertuj pliki Slides ODP do formatu POTX za pomocą interfejsu API REST i pakietu SDK cURL o otwartym kodzie źródłowym
family: slides
platformtag: curl
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj ODP na POTX za pomocą cURL" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja ODP do POTX za pomocą cURL" %}}
