---
title: Scal wiele plików POTX za pomocą cURL
description: Połącz wiele plików Slides POTX za pomocą interfejsu API REST i pakietu cURL SDK o otwartym kodzie źródłowym
family: slides
platformtag: curl
feature: merge
informat: POTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików POTX z cURL" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików POTX za pomocą cURL" %}}
