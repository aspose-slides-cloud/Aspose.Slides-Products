---
title: Scal wiele plików POTM za pomocą cURL
description: Połącz wiele plików Slides POTM za pomocą interfejsu API REST i pakietu cURL SDK o otwartym kodzie źródłowym
family: slides
platformtag: curl
feature: merge
informat: POTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików POTM z cURL" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla cURL">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików POTM za pomocą cURL" %}}
