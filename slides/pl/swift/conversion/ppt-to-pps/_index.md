---
title: Konwersja z Slides PPT na PPS za pomocą Swift
description: Twórz, edytuj lub konwertuj pliki Slides PPT do formatu PPS za pomocą interfejsu API REST i pakietu SDK Swift o otwartym kodzie źródłowym
family: slides
platformtag: swift
feature: conversion
informat: PPT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj PPT na PPS za pomocą Swift" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja PPT do PPS za pomocą Swift" %}}
