---
title: Konwersja z Slides ODP na PPTM za pomocą Swift
description: Twórz, edytuj lub konwertuj pliki Slides ODP do formatu PPTM za pomocą interfejsu API REST i pakietu SDK Swift o otwartym kodzie źródłowym
family: slides
platformtag: swift
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj ODP na PPTM za pomocą Swift" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja ODP do PPTM za pomocą Swift" %}}
