---
title: Scal wiele plików OTP za pomocą Swift
description: Połącz wiele plików Slides OTP za pomocą interfejsu API REST i pakietu Swift SDK o otwartym kodzie źródłowym
family: slides
platformtag: swift
feature: merge
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików OTP z Swift" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików OTP za pomocą Swift" %}}
