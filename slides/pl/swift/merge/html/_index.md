---
title: Scal wiele plików HTML za pomocą Swift
description: Połącz wiele plików Slides HTML za pomocą interfejsu API REST i pakietu Swift SDK o otwartym kodzie źródłowym
family: slides
platformtag: swift
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików HTML z Swift" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików HTML za pomocą Swift" %}}
...
1. Wywołaj jedną z metod scalania, w zależności od tego, gdzie znajdują się wejściowe pliki HTML, gdzie chcesz przechowywać scalony plik i czy chcesz scalić części plików
