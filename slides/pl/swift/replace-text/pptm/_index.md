---
title: Zastępowanie tekstu w plikach PPTM poprzez Swift
description: Zamień tekst w plikach Slides PPTM przy użyciu interfejsu API REST i pakietu SDK Swift typu open source
family: slides
platformtag: swift
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Zastępowanie tekstu w plikach PPTM przez Swift" h2="Znajdź i zamień wystąpienia tekstu w danych Slides za pomocą pakietu SDK Cloud SDK o otwartym kodzie źródłowym dla Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Zastępowanie tekstu w plikach PPTM przez Swift" %}}
