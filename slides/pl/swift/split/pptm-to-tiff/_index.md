---
title: Podziel Slides PPTM na wiele plików TIFF za pomocą Swift
description: Podziel pliki Slides PPTM na slajdy TIFF za pomocą interfejsu API REST i pakietu Swift SDK o otwartym kodzie źródłowym
family: slides
platformtag: swift
feature: split
informat: PPTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Podziel PPTM na wiele plików TIFF za pomocą Swift" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Swift">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dzielenie PPTM na TIFF za pomocą Swift" %}}
