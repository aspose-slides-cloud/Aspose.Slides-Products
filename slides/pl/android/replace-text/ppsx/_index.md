---
title: Zastępowanie tekstu w plikach PPSX poprzez Android
description: Zamień tekst w plikach Slides PPSX przy użyciu interfejsu API REST i pakietu SDK Android typu open source
family: slides
platformtag: android
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Zastępowanie tekstu w plikach PPSX przez Android" h2="Znajdź i zamień wystąpienia tekstu w danych Slides za pomocą pakietu SDK Cloud SDK o otwartym kodzie źródłowym dla Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Zastępowanie tekstu w plikach PPSX przez Android" %}}
