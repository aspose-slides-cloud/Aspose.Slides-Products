---
title: Konwersja z Slides ODP na SVG za pomocą Android
description: Twórz, edytuj lub konwertuj pliki Slides ODP do formatu SVG za pomocą interfejsu API REST i pakietu SDK Android o otwartym kodzie źródłowym
family: slides
platformtag: android
feature: conversion
informat: ODP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj ODP na SVG za pomocą Android" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja ODP do SVG za pomocą Android" %}}
