---
title: Scal wiele plików HTML za pomocą Android
description: Połącz wiele plików Slides HTML za pomocą interfejsu API REST i pakietu Android SDK o otwartym kodzie źródłowym
family: slides
platformtag: android
feature: merge
informat: HTML
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików HTML z Android" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Android">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików HTML za pomocą Android" %}}
