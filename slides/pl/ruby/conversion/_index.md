---
title: Konwersja prezentacji poprzez Ruby
description: Twórz, edytuj lub konwertuj pliki Padaca za pomocą interfejsu API REST i pakietu Ruby SDK o otwartym kodzie źródłowym
family: slides
platformtag: ruby
feature: conversion
platform: Ruby
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj prezentacje za pomocą Ruby" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja prezentacji za pomocą Ruby" %}}
