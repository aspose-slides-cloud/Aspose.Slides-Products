---
title: Konwersja z Slides OTP na XML za pomocą Ruby
description: Twórz, edytuj lub konwertuj pliki Slides OTP do formatu XML za pomocą interfejsu API REST i pakietu SDK Ruby o otwartym kodzie źródłowym
family: slides
platformtag: ruby
feature: conversion
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj OTP na XML za pomocą Ruby" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Konwersja OTP do XML za pomocą Ruby" %}}
