---
title: Scal wiele plików PDF za pomocą Ruby
description: Połącz wiele plików Slides PDF za pomocą interfejsu API REST i pakietu Ruby SDK o otwartym kodzie źródłowym
family: slides
platformtag: ruby
feature: merge
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Połącz wiele plików PDF z Ruby" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Ruby">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Łączenie plików PDF za pomocą Ruby" %}}
