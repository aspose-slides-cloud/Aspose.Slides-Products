---
title: Zastępowanie tekstu w plikach ODP poprzez Perl
description: Zamień tekst w plikach Slides ODP przy użyciu interfejsu API REST i pakietu SDK Perl typu open source
family: slides
platformtag: perl
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Zastępowanie tekstu w plikach ODP przez Perl" h2="Znajdź i zamień wystąpienia tekstu w danych Slides za pomocą pakietu SDK Cloud SDK o otwartym kodzie źródłowym dla Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Zastępowanie tekstu w plikach ODP przez Perl" %}}
