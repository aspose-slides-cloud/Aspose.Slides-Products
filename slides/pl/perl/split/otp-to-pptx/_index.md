---
title: Podziel Slides OTP na wiele plików PPTX za pomocą Perl
description: Podziel pliki Slides OTP na slajdy PPTX za pomocą interfejsu API REST i pakietu Perl SDK o otwartym kodzie źródłowym
family: slides
platformtag: perl
feature: split
informat: OTP
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Podziel OTP na wiele plików PPTX za pomocą Perl" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dzielenie OTP na PPTX za pomocą Perl" %}}
