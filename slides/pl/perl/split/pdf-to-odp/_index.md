---
title: Podziel Slides PDF na wiele plików ODP za pomocą Perl
description: Podziel pliki Slides PDF na slajdy ODP za pomocą interfejsu API REST i pakietu Perl SDK o otwartym kodzie źródłowym
family: slides
platformtag: perl
feature: split
informat: PDF
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Podziel PDF na wiele plików ODP za pomocą Perl" h2="Czytaj, edytuj i eksportuj dane Slides do innych formatów za pomocą pakietu Cloud SDK o otwartym kodzie źródłowym dla Perl">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Dzielenie PDF na ODP za pomocą Perl" %}}
